<content-field>
  <div class="mt-draggable mb-2" draggable="true" aria-grabbed="false" id="content-field-block-{ id }">
    ...
    <div class="col-auto">
      <svg title="{ trans('Edit') }" role="img" class="mt-icon"><use xlink:href="{ StaticURI }images/sprite.svg#ic_edit" /></svg><a data-toggle="collapse" href="#field-options-{ id }" aria-expanded="false" aria-controls="field-options-{ id }">{ trans('Edit') }</a>
    </div>
    <div class="col-auto">
  ...
  <div data-is={ type } id="field-options-{ id }" class="collapse"></div>
</content-field>
