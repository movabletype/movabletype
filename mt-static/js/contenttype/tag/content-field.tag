<content-field id="content-field-block-{ id }">
  <div class="mt-collapse__container">
    ...
    <div class="col-auto">
      ...
      <a data-toggle="collapse" href="#field-options-{ id }" aria-expanded="{ isShow == 'show' }" aria-controls="field-options-{ id }"><svg title="{ trans('Edit') }" role="img" class="mt-icon--secondary"><use xlink:href="{ StaticURI }images/sprite.svg#ic_collapse" /></svg></a>
    </div>
  </div>
