riot.tag2('content-field', '<div class="mt-collapse__container"> <div class="col-auto"><ss title="{trans(\'Move\')}" class="mt-icon" href="{StaticURI}/images/sprite.svg#ic_move"></ss></div> <div class="col"><ss title="{trans(\'ContentField\')}" class="mt-icon--secondary" href="{StaticURI}images/sprite.svg#ic_contentstype"></ss>{label} ({typeLabel})</div> <div class="col-auto"> <a href="javascript:void(0)" onclick="{deleteField}" class="d-inline-block"><ss title="{trans(\'Delete\')}" class="mt-icon--secondary" href="{StaticURI}images/sprite.svg#ic_trash"></ss></a> <a data-toggle="collapse" href="#field-options-{id}" aria-expanded="{isShow == \'show\' ? \'true\' : \'false\'}" aria-controls="field-options-{id}" class="d-inline-block"><ss title="{trans(\'Edit\')}" class="mt-icon--secondary" href="{StaticURI}images/sprite.svg#ic_collapse"></ss></a> </div> </div> <div data-is="{type}" class="collapse mt-collapse__content {isShow}" id="{\'field-options-\' + id}" fieldid="{id}" options="{this.options}" isnew="{isNew}"></div>', '', 'id="content-field-block-{id}"', function(opts) {
