riot.tag2('content-field', '<div class="mt-collapse__container"> <div class="col-auto"><svg title="{trans(\'Move\')}" role="img" class="mt-icon"><use xlink:href="{StaticURI}/images/sprite.svg#ic_move"></use></svg></div> <div class="col"><svg title="{trans(\'ContentField\')}" role="img" class="mt-icon--secondary"><use xlink:href="{StaticURI}images/sprite.svg#ic_contentstype"></use></svg>{label} ({typeLabel})</div> <div class="col-auto"> <a href="javascript:void(0)" onclick="{deleteField}"><svg title="{trans(\'Delete\')}" role="img" class="mt-icon--secondary"><use xlink:href="{StaticURI}images/sprite.svg#ic_trash"></use></svg></a> <a data-toggle="collapse" href="#field-options-{id}" aria-expanded="{isShow == \'show\' ? \'true\' : \'false\'}" aria-controls="field-options-{id}"><svg title="{trans(\'Edit\')}" role="img" class="mt-icon--secondary"><use xlink:href="{StaticURI}images/sprite.svg#ic_collapse"></use></svg></a> </div> </div> <div data-is="{type}" class="collapse mt-collapse__content {isShow}" id="{\'field-options-\' + id}" fieldid="{id}" options="{this.options}" isnew="{isNew}"></div>', '', 'id="content-field-block-{id}"', function(opts) {
