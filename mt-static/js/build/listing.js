...
function createReactiveStoreData(store) {
  return {
...
var root_1$e = add_locations(from_html(`<div class="alert alert-warning"></div>`), DisplayOptionsColumns[FILENAME], [[21, 2]]);
var root_4$8 = add_locations(from_html(`<li class="list-inline-item"><div class="form-check"><input/> <label class="form-check-label form-label"> </label></div></li>`), DisplayOptionsColumns[FILENAME], [[52, 10, [[57, 12, [[60, 14], [69, 14]]]]]]);
var root_3$b = add_locations(from_html(`<li class="list-inline-item"><div class="form-check"><input type="checkbox" class="form-check-input"/> <label class="form-check-label form-label"><!></label></div></li> <!>`, 1), DisplayOptionsColumns[FILENAME], [[29, 8, [[34, 10, [[37, 12], [45, 12]]]]]]);
var root_2$9 = add_locations(from_html(`<div class="field-content"><ul id="disp_cols" class="list-inline m-0"></ul></div>`), DisplayOptionsColumns[FILENAME], [[25, 2, [[26, 4]]]]);
var root$o = add_locations(from_html(`<div class="field-header"><label class="form-label"></label></div> <!>`, 1), DisplayOptionsColumns[FILENAME], [[16, 0, [[18, 2]]]]);
...
function DisplayOptionsColumns($$anchor, $$props) {
	...
	const $reactiveStore = () => (
		validate_store(reactiveStore),
		store_get(reactiveStore, '$reactiveStore', $$stores)
	);

	const [$$stores, $$cleanup] = setup_stores();
	const { store, reactiveStore } = getContext("listStore");
...

	{
		...
		var alternate = ($$anchor) => {
			...
			add_svelte_meta(
				() => each(ul, 5, () => $reactiveStore().columns, index, ($$anchor, column) => {
						...
						() => each(node_2, 17, () => get$1(column).sub_fields, index, ($$anchor, subField) => {
							...
							attribute_effect(
								...
								($0) => ({
									...
									disabled: !get$1(column).checked || $reactiveStore().isLoading,
									checked: $0,
					...
					template_effect(
						($0) => {
							...
							set_checked(input, $0);
							input.disabled = $reactiveStore().isLoading;
...
function DisplayOptionsLimit($$anchor, $$props) {
	...
	const [$$stores, $$cleanup] = setup_stores();
	const { reactiveStore } = getContext("listStore");
	let limit = tag(user_derived(() => $reactiveStore().limit || 0), 'limit');
...
var root_1$d = add_locations(from_html(`<div class="actions-bar actions-bar-bottom"><a href="javascript:void(0);" id="reset-display-options"></a></div>`), DisplayOptionsDetail[FILENAME], [[24, 6, [[26, 8]]]]);
var root$m = add_locations(from_html(`<div id="display-options-detail" class="collapse"><div class="card card-block p-3"><fieldset class="form-group"><div data-is="display-options-limit" id="per_page-field"><!></div></fieldset> <fieldset class="form-group"><div data-is="display-options-columns" id="display_columns-field"><!></div></fieldset> <!></div></div>`), DisplayOptionsDetail[FILENAME], [[11, 0, [[12, 2, [[13, 4, [[14, 6]]], [18, 4, [[19, 6]]]]]]]]);

function DisplayOptionsDetail($$anchor, $$props) {
	check_target(new.target);
	push($$props, true);

	const { store } = getContext("listStore");
...
var root$i = add_locations(from_html(`<div data-is="list-actions-for-pc" class="d-none d-md-block"><!></div> <div data-is="list-actions-for-mobile" class="d-md-none"><!></div>`, 1), ListActions[FILENAME], [[120, 0], [129, 0]]);
...
function ListCount($$anchor, $$props) {
	...
	const [$$stores, $$cleanup] = setup_stores();
	const { reactiveStore } = getContext("listStore");
	let count = tag(user_derived(() => $reactiveStore().count || 0), 'count');
	let limit = tag(user_derived(() => $reactiveStore().limit || 0), 'limit');
	let page = tag(user_derived(() => $reactiveStore().page || 0), 'page');
...
function ListFilterItemField($$anchor, $$props) {
	...
	const setValues = () => {
		...
		for (let key in $$props.item.args) {
			if (strict_equals(typeof $$props.item.args[key], "string", false) && strict_equals(typeof $$props.item.args[key], "number", false)) {
				continue;
			}

			const selector = "." + $$props.item.type + "-" + key;
			const elements = $$props.parentDiv.querySelectorAll(selector);

			Array.prototype.slice.call(elements).forEach(function (element) {
				if (strict_equals(element.tagName, "INPUT") || strict_equals(element.tagName, "SELECT")) {
					element.value = $$props.item.args[key];
				} else {
					element.textContent = $$props.item.args[key];
				}
			});
		}
	};
	...
	const initializeDateOption = () => {
		...
		jQuery($$props.parentDiv).find(".filter-date").each(function (_index, element) {
		...
		jQuery($$props.parentDiv).find("input.date").datepicker({
			dateFormat: "yy-mm-dd",
			dayNamesMin: $$props.localeCalendarHeader,
	...
	const initializeOptionWithBlank = () => {
		...
		jQuery($$props.parentDiv).find(".filter-blank").each(function (_index, element) {
			const node = jQuery(element);
...
var root_5$3 = add_locations(from_html(`<a href="javascript:void(0);" class="d-inline-block"><!></a>`), ListFilterItem[FILENAME], [[103, 16]]);
var root_6$2 = add_locations(from_html(`<a href="javascript:void(0);"><!></a>`), ListFilterItem[FILENAME], [[117, 16]]);
var root_3$8 = add_locations(from_html(`<div><div class="item-content form-inline"><!> <!> <!></div></div>`), ListFilterItem[FILENAME], [[85, 10, [[89, 12]]]]);
var root_1$9 = add_locations(from_html(`<div></div>`), ListFilterItem[FILENAME], [[82, 4]]);
var root_9 = add_locations(from_html(`<a href="javascript:void(0);" class="d-inline-block"><!></a>`), ListFilterItem[FILENAME], [[147, 10]]);
var root_7$2 = add_locations(from_html(`<div data-mt-list-item-content-index="0"><div class="item-content form-inline"><!> <!></div></div>`), ListFilterItem[FILENAME], [[132, 4, [[136, 6]]]]);
var root$f = add_locations(from_html(`<div class="filteritem"><button class="close btn-close" aria-label="Close"><span aria-hidden="true">&times;</span></button> <!> <!></div>`), ListFilterItem[FILENAME], [[77, 0, [[78, 2, [[79, 4]]]]]]);

function ListFilterItem($$anchor, $$props) {
	check_target(new.target);
	push($$props, true);

	let fieldParentDivs = tag_proxy(proxy([]), 'fieldParentDivs');

	let filterTypeHash = tag(
		user_derived(() => $$props.filterTypes.reduce(
			(hash, filterType) => {
	...
	const addFilterItemContent = (e) => {
		...
		let item = $$props.currentFilter.items[itemIndex];
		...
		$$props.listFilterTopAddFilterItemContent(itemIndex.toString(), contentIndex.toString());
	};
	...
	const removeFilterItem = (e) => {
		...
		$$props.listFilterTopRemoveFilterItem(itemIndex.toString());
	};
	...
	const removeFilterItemContent = (e) => {
		...
		$$props.listFilterTopRemoveFilterItemContent(itemIndex.toString(), contentIndex.toString());
	};
...

	{
		var consequent_3 = ($$anchor) => {
			...
			add_svelte_meta(
				() => each(div_1, 21, () => $$props.item.args.items, index, ($$anchor, loopItem, index) => {
					var fragment = comment();
					var node_1 = first_child(fragment);

					{
						var consequent_2 = ($$anchor) => {
							...
							add_svelte_meta(
								() => key(node_2, () => $$props.currentFilter || fieldParentDivs[index], ($$anchor) => {
									add_svelte_meta(
										() => ListFilterItemField($$anchor, {
											get field() {
												return get$1(filterTypeHash)[get$1(loopItem).type].field;
											},
...

							{
								...
								add_svelte_meta(
									() => if_block(node_3, ($$render) => {
										if (!get$1(filterTypeHash)[get$1(loopItem).type].singleton) $$render(consequent);
									}),
									'if',
									ListFilterItem,
									101,
...

							{
								...
								add_svelte_meta(
									() => if_block(node_5, ($$render) => {
										if (!get$1(filterTypeHash)[get$1(loopItem).type].singleton && $$props.item.args.items.length > 1) $$render(consequent_1);
									}),
									'if',
									ListFilterItem,
									115,
							...
							reset(div_3);
							validate_binding('bind:this={fieldParentDivs[index]}', [], () => fieldParentDivs, () => index, 91, 14);
							bind_this(div_3, ($$value, index) => fieldParentDivs[index] = $$value, (index) => fieldParentDivs?.[index], () => [index]);
							reset(div_2);
							template_effect(() => set_class(div_2, 1, "filtertype type-" + get$1(loopItem).type));
							append($$anchor, div_2);
						};

						add_svelte_meta(
							() => if_block(node_1, ($$render) => {
								if (get$1(filterTypeHash)[get$1(loopItem).type]) $$render(consequent_2);
							}),
							'if',
							ListFilterItem,
							84,
		...
		add_svelte_meta(
			() => if_block(node, ($$render) => {
				if (strict_equals($$props.item.type, "pack")) $$render(consequent_3);
			}),
			'if',
			ListFilterItem,
			81,
...

	{
		var consequent_5 = ($$anchor) => {
			...
			add_svelte_meta(
				() => key(node_8, () => $$props.currentFilter || fieldParentDivs[0], ($$anchor) => {
					add_svelte_meta(
						() => ListFilterItemField($$anchor, {
							get field() {
								return get$1(filterTypeHash)[$$props.item.type].field;
							},
...

			{
				...
				add_svelte_meta(
					() => if_block(node_9, ($$render) => {
						if (!get$1(filterTypeHash)[$$props.item.type].singleton) $$render(consequent_4);
					}),
					'if',
					ListFilterItem,
					145,
			...
			validate_binding('bind:this={fieldParentDivs[0]}', [], () => fieldParentDivs, () => 0);
			bind_this(div_5, ($$value) => fieldParentDivs[0] = $$value, () => fieldParentDivs?.[0]);
			template_effect(() => set_class(div_4, 1, "filtertype type-" + $$props.item.type));
			append($$anchor, div_4);
		};

		add_svelte_meta(
			() => if_block(node_7, ($$render) => {
				if (strict_equals($$props.item.type, "type", false) && get$1(filterTypeHash)[$$props.item.type]) $$render(consequent_5);
			}),
			'if',
			ListFilterItem,
			131,
...
function ListFilterSaveModal($$anchor, $$props) {
	...
	let modal;
	let filterName;
	let saveAs = tag(state(undefined), 'saveAs');

	const closeModal = () => {
		var _a;

		/* @ts-expect-error : bootstrap is not defined */
		strict_equals(_a = bootstrap.Modal.getInstance(modal), null) || strict_equals(_a, void 0) ? void 0 : _a.hide();
	};
	...
	const saveFilter = () => {
		...
		$$props.listFilterTopGetItemValues();
		store_mutate(reactiveStore, untrack($reactiveStore).currentFilter.label = filterName.value, untrack($reactiveStore));

		if (get$1(saveAs)) {
			store_mutate(reactiveStore, untrack($reactiveStore).currentFilter.id = "", untrack($reactiveStore));
		}
	...
	h6.textContent = window.trans("Filter Label");
	...
	bind_this(input, ($$value) => filterName = $$value, () => filterName);
...
var root_1$8 = add_locations(from_html(`<button class="btn btn-default"></button>`), ListFilterButtons[FILENAME], [[56, 2]]);
var root$d = add_locations(from_html(`<button class="btn btn-primary"></button> <button class="btn btn-default"></button> <!> <!>`, 1), ListFilterButtons[FILENAME], [[40, 0], [47, 0]]);
...
function ListFilterButtons($$anchor, $$props) {
	...
	const applyFilter = () => {
		if (!$$props.listFilterTopValidateFilterDetails()) {
			return false;
		}
		...
		store.trigger("apply_filter", $$props.currentFilter, noFilterId);
	};
	...
	const saveFilter = () => {
		...
		if ($$props.listFilterTopIsUserFilter()) {
			$$props.listFilterTopGetItemValues();
			store.trigger("save_filter", $$props.currentFilter);
		} else {
			const filterLabel = store.getNewFilterLabel($$props.objectLabel);

			saveModal.openModal({ filterLabel });
		}
	};
	...
	const saveAsFilter = () => {
		...
		saveModal.openModal({ filterLabel: $$props.currentFilter.label, saveAs: true });
	};
	...
	button.textContent = window.trans("Apply");

	var button_1 = sibling(button, 2);

	button_1.__click = saveFilter;
	button_1.textContent = window.trans("Save");
...

	{
		var consequent = ($$anchor) => {
			...
			button_2.textContent = window.trans("Save As");
			append($$anchor, button_2);
		};

		add_svelte_meta(
			() => if_block(node, ($$render) => {
				if ($$props.currentFilter.id && $$props.currentFilter.items.length > 0) $$render(consequent);
			}),
			'if',
			ListFilterButtons,
			55,
	...
	template_effect(
		($0) => {
			button.disabled = strict_equals($$props.currentFilter.items.length, 0);
			button_1.disabled = $0;
		},
		[
			() => strict_equals($$props.currentFilter.items.length, 0) || strict_equals($$props.currentFilter.can_save?.toString(), "0")
		]
	);
...
var root_3$6 = add_locations(from_html(`<a href="#"> </a> <div class="float-end d-none d-md-block"><a href="#"></a> <a href="#" class="d-inline-block"><!></a></div>`, 1), ListFilterSelectModal[FILENAME], [[90, 20], [93, 20, [[95, 22], [99, 22]]]]);
var root_4$5 = add_locations(from_html(`<div class="form-inline"><div class="form-group form-group-sm"><input/> <button class="btn btn-default form-control"></button> <button class="btn btn-default form-control"></button></div></div>`), ListFilterSelectModal[FILENAME], [[109, 20, [[110, 22, [[111, 24], [117, 24], [124, 24]]]]]]);
var root_2$5 = add_locations(from_html(`<li class="filter line"><!> <!></li>`), ListFilterSelectModal[FILENAME], [[83, 16]]);
var root_7$1 = add_locations(from_html(`<li class="filter line"><a href="#"> </a></li>`), ListFilterSelectModal[FILENAME], [[162, 18, [[168, 20]]]]);
var root_5$2 = add_locations(from_html(`<div class="filter-list-block"><h6 class="filter-list-label"></h6> <ul id="built-in-filters" class="list-unstyled"></ul></div>`), ListFilterSelectModal[FILENAME], [[155, 10, [[156, 12], [159, 12]]]]);
			...
			[
				...
				[
					[
						...
						[
							[70, 6, [[71, 8], [72, 8, [[73, 11]]]]],

							[
								76,
								6,
								[[77, 8, [[78, 10], [79, 10, [[136, 12, [[138, 14]]]]]]]]
							]
						]
					]
				]
...
function ListFilterSelectModal($$anchor, $$props) {
	...
	add_svelte_meta(
		() => each(node, 1, () => $reactiveStore().filters, index, ($$anchor, filter) => {
...

	{
		var consequent_4 = ($$anchor) => {
			...
			add_svelte_meta(
				() => each(ul_1, 5, () => $reactiveStore().filters, index, ($$anchor, filter) => {
		...
		add_svelte_meta(
			() => if_block(node_6, ($$render) => {
				if (store.hasSystemFilter()) $$render(consequent_4);
			}),
			'if',
			ListFilterSelectModal,
			154,
...
var root_1$7 = add_locations(from_html(`<a href="#" id="allpass-filter"></a>`), ListFilterHeader[FILENAME], [[37, 10]]);
	...
	[
		...
		[
			[
				14,
				2,
				[[15, 4, [[16, 6], [19, 6, [[21, 8, [[27, 10]]]]], [34, 6]]]]
			],
...
var root$9 = add_locations(from_html(`<div data-is="list-filter-header" class="card-header"><!></div> <div id="list-filter-collapse" class="collapse"><div data-is="list-filter-detail" id="filter-detail" class="card-block p-3"><!></div></div>`, 1), ListFilter[FILENAME], [[174, 0], [183, 0, [[184, 2]]]]);
...
function ListFilter($$anchor, $$props) {
	...
	const [$$stores, $$cleanup] = setup_stores();
	const { store, reactiveStore } = getContext("listStore");
	let currentFilter = tag(state(proxy($reactiveStore().currentFilter)), 'currentFilter');
	...
	store.on("refresh_current_filter", () => {
		set(currentFilter, $reactiveStore().currentFilter, true);
	});
	...
	const addFilterItem = (filterType) => {
		...
		$reactiveStore().currentFilter.items.push({ type: filterType, args: { items: [] } });
		update();
	};
	...
	const addFilterItemContent = (itemIndex, contentIndex) => {
		...
		if (strict_equals($reactiveStore().currentFilter.items[itemIndex].type, "pack", false)) {
			const items = [$reactiveStore().currentFilter.items[itemIndex]];

			store_mutate(reactiveStore, untrack($reactiveStore).currentFilter.items[itemIndex] = { type: "pack", args: { op: "and", items } }, untrack($reactiveStore));
		}

		const type = $reactiveStore().currentFilter.items[itemIndex].args.items[0].type;

		$reactiveStore().currentFilter.items[itemIndex].args.items.splice(contentIndex + 1, 0, { type, args: {} });
		update();
	};
	...
	const createNewFilter = (filterLabel) => {
		store_mutate(
			reactiveStore,
			untrack($reactiveStore).currentFilter = {
				can_delete: 0,
				can_save: 1,
				can_edit: 0,
				id: "",
	...
	const getItemValues = () => {
		...
		store_mutate(reactiveStore, untrack($reactiveStore).currentFilter.items = vals, untrack($reactiveStore));
		update();
	};

	let isAllpassFilter = tag(user_derived(() => strict_equals(get$1(currentFilter).id, $reactiveStore().allpassFilter.id)), 'isAllpassFilter');
	...
	const removeFilterItemContent = (itemIndex, contentIndex) => {
		$reactiveStore().currentFilter.items[itemIndex].args.items.splice(contentIndex, 1);
		update();
	};
...
var root_1$6 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[26, 4, [[28, 6]]]]);
var root_2$4 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[40, 4, [[42, 6]]]]);
var root_3$5 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[54, 4, [[56, 6]]]]);
var root_4$4 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[68, 4, [[70, 6]]]]);
var root_5$1 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[90, 4, [[92, 6]]]]);
var root_6$1 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[104, 4, [[106, 6]]]]);
var root_7 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[118, 4, [[120, 6]]]]);
var root_8 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForMobile[FILENAME], [[132, 4, [[134, 6]]]]);
...
function ListPaginationForMobile($$anchor, $$props) {
...

	{
		var consequent = ($$anchor) => {
			...
			a_1.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [32, 17]);
			};
		...
		add_svelte_meta(
			() => if_block(node_1, ($$render) => {
				if ($$props.page - 4 >= 1 && $reactiveStore().pageMax - $$props.page < 1) $$render(consequent);
			}),
			'if',
			ListPaginationForMobile,
			25,
...

	{
		var consequent_1 = ($$anchor) => {
			...
			a_2.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [46, 17]);
			};
		...
		add_svelte_meta(
			() => if_block(node_2, ($$render) => {
				if ($$props.page - 3 >= 1 && $reactiveStore().pageMax - $$props.page < 2) $$render(consequent_1);
			}),
			'if',
			ListPaginationForMobile,
			39,
...

	{
		var consequent_2 = ($$anchor) => {
			...
			a_3.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [60, 17]);
			};
...

	{
		var consequent_3 = ($$anchor) => {
			...
			a_4.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [74, 17]);
			};
...

	{
		var consequent_4 = ($$anchor) => {
			...
			a_6.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [96, 17]);
			};
		...
		add_svelte_meta(
			() => if_block(node_5, ($$render) => {
				if ($$props.page + 1 <= $reactiveStore().pageMax) $$render(consequent_4);
			}),
			'if',
			ListPaginationForMobile,
			89,
...

	{
		var consequent_5 = ($$anchor) => {
			...
			a_7.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [110, 17]);
			};
		...
		add_svelte_meta(
			() => if_block(node_6, ($$render) => {
				if ($$props.page + 2 <= $reactiveStore().pageMax) $$render(consequent_5);
			}),
			'if',
			ListPaginationForMobile,
			103,
...

	{
		var consequent_6 = ($$anchor) => {
			...
			a_8.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [124, 17]);
			};
		...
		add_svelte_meta(
			() => if_block(node_7, ($$render) => {
				if ($$props.page + 3 <= $reactiveStore().pageMax && $$props.page <= 2) $$render(consequent_6);
			}),
			'if',
			ListPaginationForMobile,
			117,
...

	{
		var consequent_7 = ($$anchor) => {
			...
			a_9.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForMobile, [138, 17]);
			};
		...
		add_svelte_meta(
			() => if_block(node_8, ($$render) => {
				if ($$props.page + 4 <= $reactiveStore().pageMax && $$props.page <= 1) $$render(consequent_7);
			}),
			'if',
			ListPaginationForMobile,
			131,
...
var root_1$5 = add_locations(from_html(`<li class="page-item first-last"><a href="javascript:void(0);" class="page-link">1</a></li>`), ListPaginationForPc[FILENAME], [[21, 4, [[23, 6]]]]);
var root_2$3 = add_locations(from_html(`<li class="page-item" aria-hidden="true">...</li>`), ListPaginationForPc[FILENAME], [[35, 4]]);
var root_3$4 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForPc[FILENAME], [[39, 4, [[41, 6]]]]);
var root_4$3 = add_locations(from_html(`<li><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForPc[FILENAME], [[61, 4, [[66, 6]]]]);
var root_5 = add_locations(from_html(`<li class="page-item" aria-hidden="true">...</li>`), ListPaginationForPc[FILENAME], [[78, 4]]);
var root_6 = add_locations(from_html(`<li class="page-item first-last"><a href="javascript:void(0);" class="page-link"> </a></li>`), ListPaginationForPc[FILENAME], [[82, 4, [[84, 6]]]]);
...
function ListPaginationForPc($$anchor, $$props) {
...

	{
		var consequent = ($$anchor) => {
			...
			a_1.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForPc, [27, 17]);
			};
			append($$anchor, li_1);
		};
...

	{
		var consequent_2 = ($$anchor) => {
			...
			a_2.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForPc, [45, 17]);
			};
...

	{
		var consequent_3 = ($$anchor) => {
			...
			a_4.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForPc, [70, 17]);
			};
			...
			template_effect(() => {
				classes_1 = set_class(li_5, 1, 'page-item', null, classes_1, {
					'first-last': strict_equals($$props.page + 1, $reactiveStore().pageMax)
				});
		...
		add_svelte_meta(
			() => if_block(node_3, ($$render) => {
				if ($$props.page + 1 <= $reactiveStore().pageMax) $$render(consequent_3);
			}),
			'if',
			ListPaginationForPc,
			60,
...

	{
		...
		add_svelte_meta(
			() => if_block(node_4, ($$render) => {
				if ($$props.page + 3 <= $reactiveStore().pageMax) $$render(consequent_4);
			}),
			'if',
			ListPaginationForPc,
			77,
...

	{
		var consequent_5 = ($$anchor) => {
			...
			a_5.__click = function (...$$args) {
				apply(() => $$props.movePage, this, $$args, ListPaginationForPc, [88, 17]);
			};

			var text_3 = child(a_5);

			template_effect(() => {
				set_attribute(a_5, 'data-page', $reactiveStore().pageMax);
				set_text(text_3, $reactiveStore().pageMax);
			});
...
var root$6 = add_locations(from_html(`<div><nav><!> <!></nav></div>`), ListPagination[FILENAME], [[45, 0, [[46, 2]]]]);
...
function ListPagination($$anchor, $$props) {
	...
	const [$$stores, $$cleanup] = setup_stores();
	const { store, reactiveStore } = getContext("listStore");
	let isTooNarrowWidth = tag(state(false), 'isTooNarrowWidth');
	let page = tag(user_derived(() => $reactiveStore().page || 0), 'page');
	let previousDisabledProp = tag(user_derived(() => get$1(page) <= 1 ? { disabled: "disabled" } : {}), 'previousDisabledProp');
	let nextDisabledProp = tag(user_derived(() => get$1(page) >= $reactiveStore().pageMax ? { disabled: "disabled" } : {}), 'nextDisabledProp');
	...
	const checkTooNarrowWidth = () => {
		set(isTooNarrowWidth, $reactiveStore().pageMax >= 5 && window.innerWidth < 400, true);
	};
	...
	add_svelte_meta(
		() => ListPaginationForPc(node, {
			...
			get previousDisabledProp() {
				return get$1(previousDisabledProp);
			}
		}),
		'component',
		ListPagination,
	...
	template_effect(() => {
		classes = set_class(div, 1, 'col-auto mx-auto', null, classes, { 'w-100': get$1(isTooNarrowWidth) });
		set_attribute(nav, 'aria-label', store.listClient.objectType + " list");
	});
...
var root_2$2 = add_locations(from_html(`<div class="form-check"><input type="checkbox" name="id" class="form-check-input"/> <span class="custom-control-indicator"></span> <label class="form-check-label"><span class="visually-hidden"></span></label></div>`), ListTableRow[FILENAME], [[38, 6, [[41, 8], [49, 8], [50, 8, [[51, 11]]]]]]);
var root_1$4 = add_locations(from_html(`<td><!></td>`), ListTableRow[FILENAME], [[33, 2]]);
var root_4$2 = add_locations(from_html(`<td data-is="list-table-column"><!></td>`), ListTableRow[FILENAME], [[60, 4]]);
...
function ListTableRow($$anchor, $$props) {
	...
	const classes = (index) => {
		...
		if (store.hasMobileColumn()) {
			if (strict_equals(store.getMobileColumnIndex().toString(), index)) {
				classes = "d-md-none";
			} else {
...
var root_1$3 = add_locations(from_html(`<tr><td> </td></tr>`), ListTableBody[FILENAME], [[48, 2, [[49, 4]]]]);
var root_2$1 = add_locations(from_html(`<tr style="background-color: #ffffff;"><td><a href="javascript:void(0);"> </a></td></tr>`), ListTableBody[FILENAME], [[56, 2, [[57, 4, [[59, 6]]]]]]);
var root_3$3 = add_locations(from_html(`<tr class="success"><td> </td></tr>`), ListTableBody[FILENAME], [[70, 2, [[71, 4]]]]);
var root_4$1 = add_locations(from_html(`<tr><!></tr>`), ListTableBody[FILENAME], [[82, 2]]);
...
function ListTableBody($$anchor, $$props) {
...

	{
		var consequent = ($$anchor) => {
			...
			template_effect(
				($0) => {
					set_attribute(td, 'colspan', $reactiveStore().columns.length + 1);
					set_text(text, $0);
				},
				[
		...
		add_svelte_meta(
			() => if_block(node, ($$render) => {
				if (!$reactiveStore().objects || strict_equals($reactiveStore().objects.length, 0)) $$render(consequent);
			}),
			'if',
			ListTableBody,
			47,
...

	{
		var consequent_1 = ($$anchor) => {
			...
			template_effect(
				($0) => {
					set_attribute(td_1, 'colspan', $reactiveStore().columns.length + 1);
					set_text(text_1, $0);
				},
				[
					() => window.trans("Select all [_1] items", ($reactiveStore().count ?? 0).toString())
				]
			);
		...
		add_svelte_meta(
			() => if_block(node_1, ($$render) => {
				if ($reactiveStore().pageMax > 1 && $reactiveStore().checkedAllRowsOnPage && !$reactiveStore().checkedAllRows) $$render(consequent_1);
			}),
			'if',
			ListTableBody,
			55,
...

	{
		var consequent_2 = ($$anchor) => {
			...
			template_effect(
				($0) => {
					set_attribute(td_2, 'colspan', $reactiveStore().columns.length + 1);
					set_text(text_2, $0);
				},
				[
					() => window.trans("All [_1] items are selected", ($reactiveStore().count ?? 0).toString())
				]
			);
		...
		add_svelte_meta(
			() => if_block(node_2, ($$render) => {
				if ($reactiveStore().pageMax > 1 && $reactiveStore().checkedAllRows) $$render(consequent_2);
			}),
			'if',
			ListTableBody,
			69,
	...
	add_svelte_meta(
		() => each(node_3, 1, () => $reactiveStore().objects, index, ($$anchor, obj, index) => {
			var tr_3 = root_4$1();
...
var root_2 = add_locations(from_html(`<th class="mt-table__control"><div class="form-check"><input type="checkbox" class="form-check-input" id="select-all"/> <label class="form-check-label" for="select-all"><span class="visually-hidden"></span></label></div></th>`), ListTableHeaderForMobile[FILENAME], [[9, 6, [[10, 8, [[13, 10], [20, 10, [[21, 12]]]]]]]]);
var root_3$2 = add_locations(from_html(`<span></span>`), ListTableHeaderForMobile[FILENAME], [[32, 8]]);
var root_1$2 = add_locations(from_html(`<tr class="d-md-none"><!><th scope="col"><!> <span class="float-end"> </span></th></tr>`), ListTableHeaderForMobile[FILENAME], [[7, 2, [[28, 4, [[36, 6]]]]]]);
...
function ListTableHeaderForMobile($$anchor, $$props) {
...

	{
		var consequent_2 = ($$anchor) => {
...

			{
				var consequent = ($$anchor) => {
					...
					input.__change = function (...$$args) {
						apply(() => $$props.toggleAllRowsOnPage, this, $$args, ListTableHeaderForMobile, [18, 22]);
					};
					...
					template_effect(() => set_checked(input, $reactiveStore().checkedAllRowsOnPage));
					append($$anchor, th);
				};
...

			{
				var consequent_1 = ($$anchor) => {
					...
					span_1.__click = function (...$$args) {
						apply(() => $$props.toggleAllRowsOnPage, this, $$args, ListTableHeaderForMobile, [32, 23]);
					};
			...
			template_effect(($0) => set_text(text, $0), [
				() => window.trans("[_1] - [_2] of [_3]", store.getListStart().toString(), store.getListEnd().toString(), $reactiveStore().count.toString())
			]);
		...
		add_svelte_meta(
			() => if_block(node, ($$render) => {
				if ($reactiveStore().count) $$render(consequent_2);
			}),
			'if',
			ListTableHeaderForMobile,
			6,
...
var root_1$1 = add_locations(from_html(`<th class="mt-table__control"><div class="form-check"><input type="checkbox" class="form-check-input" id="select-all"/> <label class="form-check-label form-label" for="select-all"><span class="visually-hidden"></span></label></div></th>`), ListTableHeaderForPc[FILENAME], [[24, 4, [[25, 6, [[28, 8], [35, 8, [[36, 10]]]]]]]]);
var root_4 = add_locations(from_html(`<a><!></a>`), ListTableHeaderForPc[FILENAME], [[55, 10]]);
var root_3$1 = add_locations(from_html(`<th scope="col"><!></th>`), ListTableHeaderForPc[FILENAME], [[45, 6]]);
var root$3 = add_locations(from_html(`<tr class="d-none d-md-table-row"><!><!></tr>`), ListTableHeaderForPc[FILENAME], [[22, 0]]);
...
function ListTableHeaderForPc($$anchor, $$props) {
	...
	const classProps = (column) => {
		if (column.sortable && strict_equals($reactiveStore().sortBy, column.id)) {
			if (strict_equals($reactiveStore().sortOrder, "ascend")) {
				return { class: "mt-table__ascend" };
			} else if (strict_equals($reactiveStore().sortOrder, "descend")) {
...

	{
		var consequent = ($$anchor) => {
			...
			input.__change = function (...$$args) {
				apply(() => $$props.toggleAllRowsOnPage, this, $$args, ListTableHeaderForPc, [33, 20]);
			};
	...
	add_svelte_meta(
		() => each(node_1, 1, () => $reactiveStore().columns, index, ($$anchor, column) => {
			var fragment = comment();
				...
				var consequent_2 = ($$anchor) => {
					...
					template_effect(() => {
						...
						classes = set_class(th_1, 1, 'text-truncate', null, classes, {
							...
							sorted: strict_equals($reactiveStore().sortBy, get$1(column).id)
						});
					});
...
var root_1 = add_locations(from_html(`<tbody><tr><td></td></tr></tbody>`), ListTable[FILENAME], [[15, 2, [[16, 4, [[17, 6]]]]]]);
var root_3 = add_locations(from_html(`<tbody data-is="list-table-body"><!></tbody>`), ListTable[FILENAME], [[23, 2]]);
var root$1 = add_locations(from_html(`<thead data-is="list-table-header"><!></thead> <!>`, 1), ListTable[FILENAME], [[11, 0]]);
...
function ListTable($$anchor, $$props) {
	...
	const [$$stores, $$cleanup] = setup_stores();
	const { reactiveStore } = getContext("listStore");
	let isLoading = tag(user_derived(() => $reactiveStore().isLoading || false), 'isLoading');
	let hasObjects = tag(user_derived(() => $reactiveStore().objects && $reactiveStore().objects.length > 0), 'hasObjects');
	let columnsLength = tag(user_derived(() => $reactiveStore().columns.length || 0), 'columnsLength');
	var $$exports = { ...legacy_api() };
	var fragment = root$1();
...
function ListTop($$anchor, $$props) {
	...
	const reactiveStore = writable(createReactiveStoreData($$props.store));

	setContext("listStore", { store: $$props.store, reactiveStore });

	let hidden = tag(user_derived(() => strict_equals($reactiveStore().count, 0)), 'hidden');

	onMount(() => {
		$$props.store.trigger("load_list");
	});
	...
	$$props.store.on("refresh_view", (args) => {
		if (!args) args = {};
	...
	const changeLimit = (e) => {
		...
		$$props.store.trigger("update_limit", strict_equals(_a = e.target, null) || strict_equals(_a, void 0) ? void 0 : _a.value);
	};

	const update = () => {
		reactiveStore.set(createReactiveStoreData($$props.store));
	};

	const updateSubFields = () => {
		$$props.store.columns.forEach((column) => {
	...
	add_svelte_meta(() => ListCount(node_2, {}), 'component', ListTop, 82, 4, { componentTag: 'ListCount' });
	...
	add_svelte_meta(() => ListPagination(node_5, {}), 'component', ListTop, 109, 2, { componentTag: 'ListPagination' });

	var node_6 = sibling(div_8, 2);

	add_svelte_meta(() => DisplayOptionsForMobile(node_6, { changeLimit }), 'component', ListTop, 111, 0, { componentTag: 'DisplayOptionsForMobile' });
