...
var $iframe=getIframe();$iframe.attr('src',href);$modal.find('.modal-content').append($iframe);var $bsmodal=bootstrap.Modal.getOrCreateInstance($modal.get(0),getModalOptions(opts));if(!$bsmodal._element.classList.contains('show')){$bsmodal.show();}}
