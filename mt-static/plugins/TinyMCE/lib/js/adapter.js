...
$.extend(MT.Editor.TinyMCE, MT.Editor, {
    ...
    config: {
        ...
        convert_urls : false,
        media_strict: false,
        extended_valid_elements: 'form[*],html[manifest|title|style|dir|class|accesskey|id],head[title|style|dir|class|accesskey|id],title[title|style|dir|class|accesskey|id],base[title|style|dir|class|accesskey],link[sizes|type|media|rel|href|title|style|dir|class|accesskey|id],meta[charset|content|name|http-equiv|title|style|dir|class|accesskey|id],style[scoped|style|class|accesskey],script[async|title|style|dir|class|accesskey],noscript[accesskey],body[accesskey],section[title|style|dir|class|accesskey|id],nav[title|style|dir|class|accesskey|id],article[title|style|dir|class|accesskey|id],aside[title|style|dir|class|accesskey|id],h1[accesskey],h2[accesskey],h3[accesskey],h4[accesskey],h5[accesskey],h6[accesskey],hgroup[title|style|dir|class|accesskey|id],header[title|style|dir|class|accesskey|id],footer[title|style|dir|class|accesskey|id],address[accesskey],p[accesskey],br[dir|accesskey],pre[accesskey],dialog[title|style|dir|class|accesskey|id],blockquote[accesskey],ol[reversed|accesskey],ul[accesskey],li[accesskey],dl[accesskey],dt[accesskey],dd[accesskey],a[media|ping],em[accesskey],strong[accesskey],small[accesskey],cite[accesskey],q[accesskey],dfn[accesskey],abbr[accesskey],code[accesskey],var[accesskey],samp[accesskey],kbd[accesskey],sub[accesskey],sup[accesskey],i[accesskey],b[accesskey],mark[title|style|dir|class|accesskey|id],progress[max|value|title|style|dir|class|accesskey|id],meter[optimum|high|low|max|min|value|title|style|dir|class|accesskey|id],time[datetime|title|style|dir|class|accesskey|id],ruby[title|style|dir|class|accesskey|id],rt[title|style|dir|class|accesskey|id],rp[title|style|dir|class|accesskey|id],bdo[accesskey],span[accesskey],ins[accesskey],del[accesskey],figure[title|style|dir|class|accesskey|id],figcaption[title|style|dir|class|accesskey|id],img[accesskey],iframe[seamless|sandbox|dir|accesskey],embed[type|width|height|src|title|style|dir|class|accesskey|id],object[form|accesskey],param[title|style|dir|class|accesskey],details[open|title|style|dir|class|accesskey|id],command[radiogroup|checked|disabled|icon|label|type|title|style|dir|class|accesskey|id],menu[label|type|accesskey],legend[],div[accesskey],source[media|type|src|title|style|dir|class|accesskey|id],audio[controls|loop|autoplay|autobuffer|src|title|style|dir|class|accesskey|id],video[poster|height|width|controls|loop|autoplay|autobuffer|src|title|style|dir|class|accesskey|id],hr[accesskey],form[novalidate|autocomplete|accesskey],fieldset[name|form|disabled|accesskey],label[form],input[files|width|step|required|placeholder|pattern|multiple|min|max|list|height|formtarget|formnovalidate|formmethod|formenctype|formaction|form|autocomplete],button[formtarget|formnovalidate|formmethod|formenctype|formaction|form|autofocus],select[form|autofocus|accesskey],datalist[title|style|dir|class|accesskey|id],optgroup[accesskey],option[accesskey],textarea[wrap|required|placeholder|maxlength|form|autofocus],keygen[name|keytype|form|disabled|challenge|autofocus|title|style|dir|class|accesskey|id],output[name|form|for|title|style|dir|class|accesskey|id],canvas[height|width|title|style|dir|class|accesskey|id],map[accesskey],area[type|ping|rel|media],mathml[title|style|dir|class|accesskey|id],svg[title|style|dir|class|accesskey|id],table[accesskey],caption[accesskey],colgroup[accesskey],col[accesskey],thead[accesskey],tfoot[accesskey],tbody[accesskey],tr[accesskey],th[accesskey],td[accesskey],@[subject|spellcheck|role|itemprop|hidden|item|draggable]',
