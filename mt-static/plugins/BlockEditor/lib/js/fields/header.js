; (function ($) {
    ...
    $.extend(BEF.Header.prototype, BEF.prototype, {
        ...
        get_edit_field: function(){
            ...
            var elm_select = $('<div class="form-group"><label class="form-control-label" for="' + self.id + '-element">' + trans('Heading Level') + '</label><select class="custom-select form-control w-100" name="' + self.id + '-element"  data-mt-watch-change="1"></select></div>');
