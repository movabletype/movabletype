        ...
        change_mode: function(mode){
            ...
            Object.keys(self.field_instances).forEach(function(field_id){
                ...
                if(mode == 'sort'){
                    ...
                    sorter.append('<div class="col-auto mt-ic_move"><svg role="img" class="mt-icon"><title>' + trans('Move') + '</title><use xlink:href="' + StaticURI + 'images/sprite.svg#ic_move"></use></svg></div>');
