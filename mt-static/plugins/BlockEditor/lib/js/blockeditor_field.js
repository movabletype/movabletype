;(function($) {
    ...
    var BEF = MT.BlockEditorField = function(id, data) {
        ...
        this.create_button = function () {
          return $('<button type="button" class="btn btn-contentblock" data-is_options="1"><svg title="' + this.label + '" role="img" class="mt-icon"><use xlink:href="' + StaticURI + 'images/sprite.svg#ic_header"></use></svg>' + this.label + '</button>');
      };
    };
