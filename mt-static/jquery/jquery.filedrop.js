...
;(function($) {
  ...
  var opts = {},
      ...
      doc_leave_timer, doc_exists_timer, stop_loop = false,
      files_count = 0,
      files;
  ...
  $.fn.filedrop = function(options) {
    ...
    $('#container').bind('drop', docDrop).bind('dragenter', docEnter).bind('dragover', docOver).bind('dragleave dragexit', docLeave);
  ...
  function set_drag_exists() {
    clearTimeout(doc_exists_timer);
    clearTimeout(doc_leave_timer);   
    doc_exists_timer = setTimeout(function() {
      opts.docLeave();
    }, 500);
  }
