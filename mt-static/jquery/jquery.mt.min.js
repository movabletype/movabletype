...
$field.find('.'+opts.detail_class).hide();$field.find('.'+opts.click_class).click(function(event){$field.toggleClass('active').find('.'+opts.detail_class).toggle();event.preventDefault();});if(opts.hide_clicked){$(document).click(function(event){if($(event.target).parents('.active').length==0){$field.removeClass('active').find('.'+opts.detail_class).hide();}});}});};})(jQuery);