...
c);return this.each(function(){a(this).click(function(){a("form#"+b.id+" > input[name=__mode]").val("save_entries")})})};a.fn.mtDeleteItems=function(c){var b=a.extend({args:{}},c);return this.each(function(){a(this).click(function(){doRemoveItems(a("#"+b.id)[0],b.singular,b.plural,"",b.args);return false})})};a.fn.mtEnableUsers=function(c){var b=a.extend({},c);return this.each(function(){a(this).click(function(){setObjectStatus(a("#"+b.id)[0],b.plural,b.phrase,1);return false})})};a.fn.mtDisableUsers=
function(c){var b=a.extend({},c);return this.each(function(){a(this).click(function(){var d=a("#sysadmin")[0];if(d&&d.checked){alert(b.message);d.click();return false}setObjectStatus(a("#"+b.id)[0],b.plural,b.phrase,0);return false})})};a.fn.mtDoPluginAction=function(c){var b=a.extend({args:{}},c);return this.each(function(){a(this).click(function(){doPluginAction(a("#"+b.id)[0],b.plural,b.args,b.phrase);return false})})};a.fn.mtSetObjectStatus=function(c){var b=a.extend({args:{}},c);return this.each(function(){a(this).click(function(){setObjectStatus(a("#"+
b.id)[0],b.singular,b.plural,b.status,"",b.args);return false})})};a.fn.mtRebasename=function(c){var b=a.extend({text:"..."},c);return this.each(function(){var d=a("input#basename"),e=d.hide().val();d.hide().before('<span class="basename-text"></span>');d.parent("span.basename").after('<button id="mt-set-basename" class="mt-edit-field-button">'+b.edit+"</button>");b.basename?a("span.basename-text").text(b.basename):a("span.basename-text").text(e||b.text);a(this).keyup(function(){if(!b.basename){e=
