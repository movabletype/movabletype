...
define('VERSION', '9.001001');
define('PRODUCT_VERSION', '9.1.1');
...
#        }
    ...
    function error_handler($errno, $errstr, $errfile, $errline) {
        ...
        $do_exit = false;
        $do_exit = ($errno & (E_ALL ^ E_NOTICE ^ E_WARNING ^ E_DEPRECATED ^ E_USER_NOTICE ^ E_USER_WARNING ^ E_USER_DEPRECATED));
        $do_exit = $do_exit || ($errno & E_USER_WARNING) && $this->http_error >= 400;
