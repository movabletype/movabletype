...
subtest 'mode = complete_insert' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: complete_insert" );
    ok( $out =~ m!Permission Denied!i, "complete_insert by other blog (create_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: complete_insert" );
    ok( $out =~ m!Permission Denied!i, "complete_insert other blog (manage_pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: complete_insert" );
    ok( $out =~ m!Permission Denied!i, "complete_insert by other permission" );
};
...
subtest 'mode = complete_upload' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: complete_upload" );
    ok( $out =~ m!__mode=dashboard&permission=1!i, "complete_upload by other blog" ); #TODO: should be use 'Permission Denied' instead of
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: complete_upload" );
    ok( $out =~ m!__mode=dashboard&permission=1!i, "complete_upload by other permission" ); #TODO: should be use 'Permission Denied' instead of
};
...
subtest 'mode = asset_insert' => sub {
    ...
    ok( $out !~ m!Permission Denied!i, "asset_insert by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: asset_insert" );
    ok( $out !~ m!Permission Denied!i, "asset_insert by permitted user (create_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: asset_insert" );
    ok( $out !~ m!Permission Denied!i, "asset_insert by permitted user (manage_pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: asset_insert" );
    ok( $out =~ m!Permission Denied!i, "asset_insert by other blog (create_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: asset_insert" );
    ok( $out =~ m!Permission Denied!i, "asset_insert other blog (manage_pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: asset_insert" );
    ok( $out =~ m!Permission Denied!i, "asset_insert by other permission" );
};
...
subtest 'mode = start_upload' => sub {
    ...
    ok( $out !~ m!Permission Denied!i, "start_upload by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_upload" );
    ok( $out !~ m!Permission Denied!i, "start_upload by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_upload" );
    ok( $out =~ m!Permission Denied!i, "start_upload by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_upload" );
    ok( $out =~ m!Permission Denied!i, "start_upload by other permission" );
};
...
subtest 'mode = start_upload_entry' => sub {
    ...
    ok( $out !~ m!Permission Denied!i, "start_upload_entry by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_upload_entry" );
    ok( $out !~ m!Permission Denied!i, "start_upload_entry by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_upload_entry" );
    ok( $out =~ m!Permission Denied!i, "start_upload_entry by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_upload_entry" );
    ok( $out =~ m!Permission Denied!i, "start_upload_entry by other permission" );
};
