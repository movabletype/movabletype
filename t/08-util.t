...
is(is_valid_ip('255.255.255.244'), '255.255.255.244', 'is_valid_ip() valid ip');
is(is_valid_ip('123.123.123.123/1'), '123.123.123.123/1', 'is_valid_ip() valid ip');
is(is_valid_ip('123.123.123.123/32'), '123.123.123.123/32', 'is_valid_ip() valid ip');
