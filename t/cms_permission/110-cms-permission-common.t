...
subtest 'mode = list_revision' => sub {
    ...
    ok( $out !~ m!permission=1!i,
        "list_revision by permitted user (create post)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out !~ m!permission=1!i,
        "list_revision by permitted user (edit all posts)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out !~ m!permission=1!i,
        "list_revision by permitted user (manage_page)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out !~ m!permission=1!i,
        "list_revision by permitted user (edit_templates)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out !~ m!permission=1!i,
        "list_revision by permitted user ( system:edit_templates)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out !~ m!permission=1!i,
        "list_revision by permitted user ( system:edit_templates: system)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision by other blog (create post)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision by other blog (edit all posts)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision by other blog (manage_page)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision by other blog (edit_templates)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision on system template (edit_templates)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision by other user (create post)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision by class mismatch (create post)" );
    ...
    ok( $out, "Request: list_revision" );
    ok( $out =~ m!permission=1!i,
        "list_revision by class mismatch (manage_pages)" );
