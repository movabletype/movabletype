...
subtest 'mode = do_export_theme' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: do_export_theme" );
    ok( $out =~ m!__mode=export_theme!i,
        "do_export_theme by permitted user" );
...
subtest 'mode = theme_element_detail' => sub {
    ...
    ok( $out =~ m!permission=1!i,
        "theme_element_detail by other permission" );
...
subtest 'mode = uninstall_theme' => sub {
    ...
    ok( $out !~ m!permission=1!i, "uninstall_theme by admin" )
        ;    #TODO: should use 'Permission=1' instead
    ...
    $out = delete $app->{__test_output};
    ok( $out,                     "Request: uninstall_theme" );
    ok( $out =~ m!permission=1!i, "uninstall_theme by non permitted user" )
        ;    #TODO: should use 'Permission=1' instead
