...
my $map_monthly = MT::Test::Permission->make_templatemap(
...
subtest 'create entry' => sub {
    ...
    ok -e File::Spec->catfile( $blog->archive_path, '2018/08/index.html' );
...
subtest 'create other entry' => sub {
    ...
    ok -e File::Spec->catfile( $blog->archive_path, '2018/08/index.html' );
    ok -e File::Spec->catfile( $blog->archive_path, '2018/10/index.html' );
