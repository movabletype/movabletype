...
--- template
<mt:Contents content_type="test content data"><mt:ContentAuthorLink></mt:Contents>
--- expected
<a href="https://example.com/~abby">Abby</a>

=== MT::ContentAuthorLink with new_window="1"
--- template
<mt:Contents content_type="test content data"><mt:ContentAuthorLink new_window="1"></mt:Contents>
--- expected
