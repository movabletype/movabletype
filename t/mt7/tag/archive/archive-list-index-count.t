...
=== ArchiveCount inside categories
--- stash
{
    cd => 'cd_same_apple_orange',
    cat_field => 'cf_same_catset_fruit',
...
--- template
<mt:Categories lastn='1'><mt:ArchiveList archive_type="[% archive_type %]"><mt:ArchiveTitle>:<mt:ArchiveCount>
</mt:ArchiveList></mt:Categories>
--- expected_author
author1:1
author2:1
--- expected_author_daily
