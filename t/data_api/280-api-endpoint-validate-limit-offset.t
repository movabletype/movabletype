        ...
        {   path         => '/v1/users/me/permissions',
            ...
            result => +{
                ...
                'items'        => [
                    ...
                    {   'permissions' => [
                            'administer_blog',     'administer_website',
                            'comment',             'create_post',
                            'edit_all_posts',      'edit_assets',
                            'edit_categories',     'edit_config',
                            'edit_notifications',  'edit_tags',
                            'edit_templates',      'manage_feedback',
                            'manage_member_blogs', 'manage_pages',
                            'manage_themes',       'manage_users',
                            'publish_post',        'rebuild',
                            'save_image_defaults', 'send_notifications',
