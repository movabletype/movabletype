...
subtest 'mode = plugin_control' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "plugin_control by admin" );
...
subtest 'mode = reset_plugin_config' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "reset_plugin_config by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: reset_plugin_config" );
    ok( $out !~ m!Permission denied!i, "reset_plugin_config by permitted user on blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: reset_plugin_config" );
    ok( $out !~ m!Permission denied!i, "reset_plugin_config by permitted user on website" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: reset_plugin_config" );
    ok( $out !~ m!Permission denied!i, "reset_plugin_config by permitted user on system" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: reset_plugin_config" );
    ok( $out =~ m!Permission denied!i, "reset_plugin_config by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: reset_plugin_config" );
    ok( $out =~ m!Permission denied!i, "reset_plugin_config by other permission" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: reset_plugin_config" );
    ok( $out =~ m!Permission denied!i, "reset_plugin_config by non permitted user on website" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: reset_plugin_config" );
    ok( $out =~ m!Permission denied!i, "reset_plugin_config by non permitted user on blog" );
...
subtest 'mode = save_plugin_config' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "save_plugin_config by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_plugin_config" );
    ok( $out !~ m!Permission denied!i, "save_plugin_config by permitted user on blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_plugin_config" );
    ok( $out !~ m!Permission denied!i, "save_plugin_config by permitted user on website" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_plugin_config" );
    ok( $out !~ m!Permission denied!i, "save_plugin_config by permitted user on system" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_plugin_config" );
    ok( $out =~ m!Permission denied!i, "save_plugin_config by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_plugin_config" );
    ok( $out =~ m!Permission denied!i, "save_plugin_config by other permission" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_plugin_config" );
    ok( $out =~ m!Permission denied!i, "save_plugin_config by non permitted user on website" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_plugin_config" );
    ok( $out =~ m!Permission denied!i, "save_plugin_config by non permitted user on blog" );
