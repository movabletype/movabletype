...
ok( $out !~ /Publish selected templates/i,
    "Publish templates button isn't present for global template search" );
ok( $out =~ /Delete selected templates/i,
    "Delete templates button is present"
);
ok( $out =~ /Refresh template\(s\)/i,
    "Refresh templates dropdown is present"
);
...
ok( $out =~ /Publish selected templates/i,
    "Publish templates button is present"
);
ok( $out =~ /Delete selected templates/i,
    "Delete templates button is present"
);
...
ok( $out =~ /Republish selected entries/i,
    "Publish entries button is present"
);
