...
$removed_asset->file_path(File::Spec->catfile('%r', 'images', 'removed.jpg'));
...
$file_asset->file_path(File::Spec->catfile('%r', 'files', 'test.pdf'));
...
$text_asset->file_path(File::Spec->catfile('%r', 'files', 'test.txt'));
