...
SKIP: {
        skip "type $type test", 1 unless $arc;
        subtest "type $type test" => sub {
            ...
            ok( $arc->add_file( $path, 'mt-config.cgi-original' ),
                'Add file' );
            ...
            is( $files[0], 'mt-config.cgi-original',
                'The name of the file 0 is correct' );
            is( $files[1], 'november.txt',
