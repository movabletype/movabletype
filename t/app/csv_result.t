...
subtest 'CSVExportWithBOM' => sub {
    ...
    unlike $output, qr/^\x{EF}\x{BB}\x{BF}/, 'CSV output has no BOM when CSVExportWithBOM is 0';
...
subtest 'CSVExportEscapeFormula' => sub {
    ...
    like $output, qr/=formula/, 'Formula starting with = is not escaped when CSVExportEscapeFormula is 0';
    like $output, qr/\+plus/, 'Formula starting with + is not escaped when CSVExportEscapeFormula is 0';
    like $output, qr/-minus/, 'Formula starting with - is not escaped when CSVExportEscapeFormula is 0';
    like $output, qr/"text with space"/, 'Text with space is not escaped when CSVExportEscapeFormula is 0';
