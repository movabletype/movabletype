...
BEGIN {
    ...
    for my $version ('0.1', '1.0') {
        $test_env->save_file("plugins/MyPlugin/MyPlugin$version.pl", <<"PLUGIN" );
package MyPlugin;
our \$VERSION = '$version';
require MT;
require MT::Plugin;
...
ok !$switch->{'MyPlugin/MyPlugin0.1.pl'}, "older version is listed in PluginSwitch but is 0";
ok $switch->{'MyPlugin/MyPlugin1.0.pl'},  "newer version is listed in PluginSwitch";
