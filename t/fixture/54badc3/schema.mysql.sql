...
-- Created on Mon Jul 24 08:39:31 2023
--
...
DROP TABLE IF EXISTS `mt_sync_log`;

--
-- Table: `mt_sync_log`
--
CREATE TABLE `mt_sync_log` (
  `sync_log_author_id` integer(11) NOT NULL DEFAULT 0,
  `sync_log_blog_id` integer(11) NOT NULL DEFAULT 0,
  `sync_log_created_by` integer(11) NULL DEFAULT NULL,
  `sync_log_created_on` datetime NULL DEFAULT NULL,
  `sync_log_destination_name` varchar(255) NULL DEFAULT NULL,
  `sync_log_finished_on` datetime NULL DEFAULT NULL,
  `sync_log_id` integer(11) NOT NULL auto_increment,
  `sync_log_logdata` mediumtext NULL,
  `sync_log_message` mediumtext NULL,
  `sync_log_metadata` mediumtext NULL,
  `sync_log_modified_by` integer(11) NULL DEFAULT NULL,
  `sync_log_modified_on` datetime NULL DEFAULT NULL,
  `sync_log_setting` mediumblob NULL,
  `sync_log_started_on` datetime NULL DEFAULT NULL,
  `sync_log_sync_result` integer(11) NOT NULL DEFAULT 1,
  `sync_log_sync_setting_id` integer(11) NOT NULL DEFAULT 0,
  `sync_log_sync_trigger` integer(11) NOT NULL DEFAULT 1,
  `sync_log_sync_type` integer(11) NOT NULL DEFAULT 1,
  INDEX `mt_sync_log_blog_id` (`sync_log_blog_id`),
  INDEX `mt_sync_log_started_on` (`sync_log_started_on`),
  INDEX `mt_sync_log_sync_result` (`sync_log_sync_result`),
  INDEX `mt_sync_log_sync_setting_id` (`sync_log_sync_setting_id`),
  INDEX `mt_sync_log_sync_trigger` (`sync_log_sync_trigger`),
  INDEX `mt_sync_log_sync_type` (`sync_log_sync_type`),
  PRIMARY KEY (`sync_log_id`)
) ENGINE=InnoDB DEFAULT CHARACTER SET utf8mb3;

DROP TABLE IF EXISTS `mt_sync_queue`;

--
-- Table: `mt_sync_queue`
--
CREATE TABLE `mt_sync_queue` (
  `sync_queue_blog_id` integer(11) NOT NULL,
  `sync_queue_created_by` integer(11) NULL DEFAULT NULL,
  `sync_queue_created_on` datetime NULL DEFAULT NULL,
  `sync_queue_data` mediumtext NOT NULL,
  `sync_queue_destination_id` varchar(80) NOT NULL,
  `sync_queue_id` integer(11) NOT NULL auto_increment,
  `sync_queue_modified_by` integer(11) NULL DEFAULT NULL,
  `sync_queue_modified_on` datetime NULL DEFAULT NULL,
  `sync_queue_num_of_files` integer(11) NOT NULL,
  `sync_queue_priority` integer(11) NOT NULL,
  INDEX `mt_sync_queue_blog_id` (`sync_queue_blog_id`),
  INDEX `mt_sync_queue_dest_id` (`sync_queue_destination_id`),
...
CREATE TABLE `mt_sync_setting` (
  ...
  `sync_setting_force_sync` tinyint(4) NULL DEFAULT NULL,
  ...
  `sync_setting_notify_mail` varchar(1000) NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `mt_sync_status`;

--
-- Table: `mt_sync_status`
--
CREATE TABLE `mt_sync_status` (
  `sync_status_blog_id` integer(11) NOT NULL,
  `sync_status_created_by` integer(11) NULL DEFAULT NULL,
  `sync_status_created_on` datetime NULL DEFAULT NULL,
  `sync_status_data` mediumtext NULL,
  `sync_status_destination_id` varchar(80) NOT NULL,
  `sync_status_id` integer(11) NOT NULL auto_increment,
  `sync_status_modified_by` integer(11) NULL DEFAULT NULL,
  `sync_status_modified_on` datetime NULL DEFAULT NULL,
  INDEX `mt_sync_status_blog_id` (`sync_status_blog_id`),
  INDEX `mt_sync_status_dest_id` (`sync_status_destination_id`),
