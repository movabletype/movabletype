...
subtest 'mode = cc_return' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "cc_return by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: cc_return" );
    ok( $out !~ m!Permission denied!i, "cc_return by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: cc_return" );
    ok( $out =~ m!Permission denied!i, "cc_return by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: cc_return" );
    ok( $out =~ m!Permission denied!i, "cc_return by other permission" );
    done_testing();
};
...
subtest 'mode = cfg_feedback' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "cfg_feedback by admin" );
...
subtest 'mode = cfg_prefs' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "cfg_prefs by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: cfg_prefs" );
    ok( $out !~ m!Permission denied!i, "cfg_prefs by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: cfg_prefs" );
    ok( $out =~ m!Permission denied!i, "cfg_prefs by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: cfg_prefs" );
    ok( $out =~ m!Permission denied!i, "cfg_prefs by other permission" );
    done_testing();
};
...
subtest 'mode = dialog_clone_blog' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "dialog_clone_blog by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: dialog_clone_blog" );
    ok( $out =~ m!Permission denied!i, "dialog_clone_blog by blog admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: dialog_clone_blog" );
    ok( $out =~ m!Permission denied!i, "dialog_clone_blog by other blog" );
    done_testing();
};

subtest 'mode = dialog_select_weblog' => sub {
    $app = _run_app(
        'MT::App::CMS',
        {   __test_user      => $admin,
            __request_method => 'POST',
            __mode           => 'dialog_select_weblog',
            blog_id          => $blog->id,
        }
    );
    $out = delete $app->{__test_output};
    ok( $out, "Request: dialog_select_weblog" );
    ok( $out !~ m!Permission denied!i, "dialog_select_weblog by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: dialog_select_weblog" );
    ok( $out =~ m!Permission denied!i, "dialog_select_weblog by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: dialog_select_weblog" );
    ok( $out !~ m!Permission denied!i, "dialog_select_weblog by permitted user" );
    done_testing();
};

subtest 'mode = list_blogs' => sub {
    $app = _run_app(
        'MT::App::CMS',
        {   __test_user      => $admin,
            __request_method => 'POST',
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: list_blogs" );
    ok( $out !~ m!Permission denied!i, "list_blogs by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: list_blogs" );
    ok( $out =~ m!Permission denied!i, "list_blogs by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: list_blogs" );
    ok( $out !~ m!Permission denied!i, "list_blogs by permitted user" );
    done_testing();
};
...
subtest 'mode = rebuild_new_phase' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "rebuild_new_phase by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out !~ m!Permission denied!i, "rebuild_new_phase by permitted user (publish_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out =~ m!Permission denied!i, "rebuild_new_phase by other blog (publish_post)" );
...
subtest 'mode = rebuild' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "rebuild by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild" );
    ok( $out !~ m!Permission denied!i, "rebuild by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild" );
    ok( $out =~ m!Permission denied!i, "rebuild by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild" );
    ok( $out =~ m!Permission denied!i, "rebuild by other permission" );
    done_testing();
};
...
subtest 'mode = rebuild_phase' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "rebuild_phase by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_phase" );
    ok( $out !~ m!Permission denied!i, "rebuild_phase by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_phase" );
    ok( $out =~ m!Permission denied!i, "rebuild_phase by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_phase" );
    ok( $out =~ m!Permission denied!i, "rebuild_phase by other permission" );
    done_testing();
};

subtest 'mode = save_favorite_blogs' => sub {
    $app = _run_app(
        'MT::App::CMS',
        {   __test_user      => $admin,
            __request_method => 'POST',
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_favorite_blogs" );
    ok( $out !~ m!Permission denied!i, "save_favorite_blogs by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_favorite_blogs" );
    ok( $out =~ m!Permission denied!i, "save_favorite_blogs by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save_favorite_blogs" );
    ok( $out !~ m!Permission denied!i, "save_favorite_blogs by permitted user" );
    done_testing();
};
...
subtest 'mode = start_rebuild' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "start_rebuild by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!Permission denied!i, "start_rebuild by permitted user (rebuild)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!Permission denied!i, "start_rebuild by permitted user (edit_all_posts)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!Permission denied!i, "start_rebuild by permitted user (manage_pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!Permission denied!i, "start_rebuild by permitted user (publish_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!Permission denied!i, "start_rebuild by permitted user (manage_feedback)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!Permission denied!i, "start_rebuild by other blog (edit_all_posts)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!Permission denied!i, "start_rebuild by other blog (manage_pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!Permission denied!i, "start_rebuild by other blog (publish_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!Permission denied!i, "start_rebuild by other blog (manage_feedback)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!Permission denied!i, "start_rebuild by other permission" );
    done_testing();
};
...
subtest 'mode = update_welcome_message' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "update_welcome_message by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: update_welcome_message" );
    ok( $out !~ m!Permission denied!i, "update_welcome_message by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: update_welcome_message" );
    ok( $out =~ m!Permission denied!i, "update_welcome_message by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: update_welcome_message" );
    ok( $out =~ m!Permission denied!i, "update_welcome_message by other permission" );
    done_testing();
};
...
subtest 'mode = save (edit)' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save" );
    ok( $out =~ m!Invalid Request!i, "save (edit) by permitted user (blog admin)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save" );
    ok( $out =~ m!Invalid Request!i, "save (edit) by non permitted user (create blog)" );
...
subtest 'mode = edit (edit)' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: edit" );
    ok( $out =~ m!Invalid Request!i, "edit (edit) by permitted user (blog admin)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: edit" );
    ok( $out =~ m!Invalid Request!i, "edit (edit) by non permitted user (create blog)" );
...
subtest 'mode = delete' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: delete" );
    ok( $out !~ m!Permission denied!i, "delete by permitted user (blog admin)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: delete" );
    ok( $out =~ m!Permission denied!i, "delete by non permitted user (edit config)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: delete" );
    ok( $out =~ m!Permission denied!i, "delete by non permitted user (create blog)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: delete" );
    ok( $out =~ m!Permission denied!i, "delete by other blog (blog admin)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: delete" );
    ok( $out =~ m!Permission denied!i, "delete by other blog (edit config)" );
...
subtest 'action = refresh_blog_templates' => sub {
    ...
    ok( $out !~ m!Permission denied!i, "refresh_blog_templates by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: refresh_blog_templates" );
    ok( $out !~ m!Permission denied!i, "refresh_blog_templates by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: refresh_blog_templates" );
    ok( $out !~ m!Permission denied!i, "refresh_blog_templates by permitted user (system)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: refresh_blog_templates" );
    ok( $out =~ m!Permission denied!i, "refresh_blog_templates by other blog" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: refresh_blog_templates" );
    ok( $out =~ m!Permission denied!i, "refresh_blog_templates by other permission" );
};
...
subtest 'action = clone_blogs' => sub {
    $app = _run_app(
        'MT::App::CMS',
        {   __test_user      => $admin,
            __request_method => 'POST',
            __mode           => 'itemset_action',
            _type            => 'blog',
            action_name      => 'clone_blogs',
            itemset_action_input => '',
            return_args      => '__mode%3Dlist_blog%26blog_id%3D'.$website->id,
            plugin_action_selector => 'clone_blogs',
            id               => $blog->id,
            plugin_action_selector => 'clone_blogs',
        }
    );
    $out = delete $app->{__test_output};
    ok( $out, "Request: clone_blogs" );
    ok( $out !~ m!Permission denied!i, "clone_blogs by admin" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: clone_blogs" );
    ok( $out !~ m!Permission denied!i, "clone_blogs by non permitted user" );
