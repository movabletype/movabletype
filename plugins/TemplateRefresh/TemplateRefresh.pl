...
sub default_dictionary {
    ...
    # 3.3
    $dict->{'index'}{'Main Index'}{'083bbf066e3cd368cdb723fd652933a708f9f302'} = 1;
    $dict->{'index'}{'Main Index'}{'09f47f2478ddcb9421a06234f2a71dc84317c836'} = 1;
    $dict->{'index'}{'Main Index'}{'1da9698f26f899426e5cbf3ce76ee7d8c4fcb639'} = 1;
    $dict->{'index'}{'Main Index'}{'37e29d6354b74988552d6f160ae5fb3389bf74ac'} = 1;
    $dict->{'index'}{'Main Index'}{'deae683f63f3892cb83051bba9d43fa00dc479d9'} = 1;
    $dict->{'index'}{'Main Index'}{'fbb32de21530bda11c4d3ebbdd4c029adf03330d'} = 1;
    $dict->{'index'}{'Dynamic Site Bootstrapper'}{'e9b325331bd4fce9ca9b544b2a09fa9e01fbd541'} = 1;
    ...
    $dict->{'comment_preview'}{'Comment Preview Template'}{'c75ede071cf277c408b8edff992ddf1d89e24057'} = 1;
    $dict->{'comment_preview'}{'Comment Preview Template'}{'de1b72e1f90d18c8f4d53fc20b058a415229cb34'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'1c86f377f47e39ef7edee405b2e2fec975ac981e'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'54d85a9196ebe20b4651dfba00b8ef5d1f387abc'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'90315b61d5e6d0c721514e836b4a7bfb191038a6'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'ac9f6db8825e893c7551ff9bba7423f5e3ac8d84'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'fce323c889a8470f983cb72e0e8f9eee90ad0996'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'ffebdaa4f7d3f599c40254471e15bb03b0bb323a'} = 1;
    ...
    $dict->{'archive'}{'Date-Based Archive'}{'1add011801bc3eb4e459c134187a33b8fbc890a4'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'3a5ebf036aa3644030ebf9d1bd60c82b38f29577'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'439b8f617c0b76f153488762403b76a7b21b6b37'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'6f7b0e796774ec3ce3e1d54e16aba6c7d1e3bd3e'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'72e3aa323d7ffe23cabeb6dff8a157f21983eae8'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'8b5c948a4a850e4eec3a658138c6ed529651f388'} = 1;
    $dict->{'category'}{'Category Archive'}{'2532017adbc0270823950860f01427177d2fb63a'} = 1;
    $dict->{'category'}{'Category Archive'}{'31751ed750f32101a2ffbd59c2133c557b41072d'} = 1;
    $dict->{'category'}{'Category Archive'}{'73017ea2773d0506786941f0c2689e4b4a02fbc8'} = 1;
    $dict->{'category'}{'Category Archive'}{'b70d1a8f2c25d6d2a1f8cf5f83bb9b91885f4d13'} = 1;
    $dict->{'category'}{'Category Archive'}{'ddebef01dc27eb9d6f8f9e2576515f3ddb1093e9'} = 1;
    $dict->{'category'}{'Category Archive'}{'f7ded9a77b86959af1352979ac42b06f7423a96f'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'009c06f13f11a3d3d13b9b284bb88b34b1021f5c'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'1d57a2c73298ec4718e37029862041a92d11727f'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'29aa19c5d4a99e4a23bd46aa1953e5a3564f3c9e'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'57665e71916f4b608672a73552cd1128933ef51b'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'8a00f4dea381e41ea96254580712a7e76f4ab4fe'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'ccf8601aaf311dc037615869d1375583efc977f5'} = 1;
