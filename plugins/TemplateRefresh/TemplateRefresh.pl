...
sub default_dictionary {
    ...
    # 3.3
    $dict->{'index'}{'Main Index'}{'84ddf9f69bd69e6f61daa7df9ed0d7d23aac31fe'} = 1;
    $dict->{'index'}{'Main Index'}{'02b7cc3743141b9d576904ab20dee94dc3c45aa2'} = 1;
    $dict->{'index'}{'Main Index'}{'f6ca446f8f9b14df73ee8b8a3dbc84a9bb63be48'} = 1;
    $dict->{'index'}{'Main Index'}{'d32176f401b7c65a3add3a463010bc27e3e6e240'} = 1;
    $dict->{'index'}{'Main Index'}{'5ad4800484c3fb0248f6633737b5ae44282bb11a'} = 1;
    $dict->{'index'}{'Main Index'}{'c33405e7b201e61249abda5a8b11f4e4f46215fa'} = 1;
    $dict->{'index'}{'Dynamic Site Bootstrapper'}{'e9b325331bd4fce9ca9b544b2a09fa9e01fbd541'} = 1;
    ...
    $dict->{'index'}{'Master Archive Index'}{'4a5dee93e0d845eea1f184495318ec39b81abab7'} = 1;
    $dict->{'index'}{'Master Archive Index'}{'d0a1f28469f85ccdee959bf829e91a2538b45102'} = 1;
    $dict->{'index'}{'Master Archive Index'}{'7e8f30d7c6f620db98cec3b26ac16446fc0aa3fd'} = 1;
    $dict->{'index'}{'Master Archive Index'}{'16de7296c69e5aecac30a236651c6674bb1222f8'} = 1;
    $dict->{'index'}{'Master Archive Index'}{'d4666efa8f878e195918e1ec95a5a1a3ba4448e6'} = 1;
    $dict->{'index'}{'Master Archive Index'}{'40c053f388f34e2e5c65ba57666807a09b3b4304'} = 1;
    $dict->{'comment_preview'}{'Comment Preview Template'}{'02a7238b5cf47492a25346c12403bf4619dde421'} = 1;
    $dict->{'comment_preview'}{'Comment Preview Template'}{'f5be88e262f0ab7bfd4712b9bae89a0b6208749e'} = 1;
    $dict->{'comment_preview'}{'Comment Preview Template'}{'78ade98c2c2c1c302003b75704271edcd9a1a553'} = 1;
    $dict->{'comment_preview'}{'Comment Preview Template'}{'461d43b96971a027e1819249922c04cd9eeb84b1'} = 1;
    $dict->{'comment_preview'}{'Comment Preview Template'}{'0539f9295cda2af82ab4592c9109b83264666069'} = 1;
    $dict->{'comment_preview'}{'Comment Preview Template'}{'39b252fd0d7be06928c0c85f27db9d782a7ad8cc'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'81cd10ebf28f8aaf8cc1c65e5ff0ef2a4947524b'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'beed7e90049f9e078d8c137e346e7c404dc2ef24'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'42d10b5487492238c8f20e0e01c151f04a8c7a38'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'f2fc0334483e36f35ed3e60aec4b1718e2b0160d'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'6027dbdd9a9276e6ba28879bd48296a0017d1a39'} = 1;
    $dict->{'search_template'}{'Search Results Template'}{'2d530b260c458740ffeaeeef932a4a597e6edd00'} = 1;
    ...
    $dict->{'index'}{'Stylesheet'}{'e873f1e4dcddb4042f193b27b96da9cd45f2975d'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'a062a8ffd62321aef4ad3d146af12a90fbdeee6e'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'c5c68effc9d9e62a9455633c8943b368eec57adf'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'08d0fe61d00239dae3510c1ed68f573f13f6e402'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'b0f7d264362e1e13511f41f8b7f4c2c28afcf11e'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'1af97eaba9962a0d8578f5e021c4693f85431138'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'76b75d3e4162da7797a14395fecee9459512637c'} = 1;
    $dict->{'category'}{'Category Archive'}{'6b4e3c233996c9bcc6a49f7ecb268a1bbd463efd'} = 1;
    $dict->{'category'}{'Category Archive'}{'0192a299a10284ebd9aab300f12a6a683078a492'} = 1;
    $dict->{'category'}{'Category Archive'}{'ef60a782a3306e06f9a42123ac4396798930a0aa'} = 1;
    $dict->{'category'}{'Category Archive'}{'50421f1b28761a806ab70c8c01d77f1ff53d8b08'} = 1;
    $dict->{'category'}{'Category Archive'}{'4488105e1e27d724578c0ebf4ee9986e5fd6a174'} = 1;
    $dict->{'category'}{'Category Archive'}{'3f26ce172f87ef710688237ff34f8e3851626a45'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'def0ceca2f0059813519071d9b5c669c8272ea5b'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'01820cb5262e1cb06ff122898942be59da916e90'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'b2be84e81b08eb53f50ea29933d6f6f8af46392c'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'6e70eb424af4edf0622a38e4d0812a4bd2862d14'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'2f694a5e95efc64be4c3e758e33fe115d195d9e6'} = 1;
    $dict->{'individual'}{'Individual Entry Archive'}{'311a134b20a640e9044a57c04c2fabc81c13055c'} = 1;
