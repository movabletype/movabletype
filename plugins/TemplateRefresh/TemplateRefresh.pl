...
sub default_dictionary {
    ...
    $dict->{'search_template'}{'Search Results Template'}{'d693edb01b0ca7bfea9c0b7312c1cebec8de53df'} = 1;
    ...
    $dict->{'archive'}{'Date-Based Archive'}{'278542b093b976d13fa406c6892d97bcc13b5c70'} = 1;
    $dict->{'archive'}{'Date-Based Archive'}{'6e717d191650ec08b289d6cb8e39c6506f2836c8'} = 1;
    ...
    $dict->{'category'}{'Category Archive'}{'486eee184859d326397730d389392708ec7445b1'} = 1;
    $dict->{'category'}{'Category Archive'}{'1710b0fd5a62f9e499f06eb896eaf5785f85a482'} = 1;
    ...
    $dict->{'individual'}{'Individual Entry Archive'}{'dee1c75f5bd2b7ec292551027a2ee87d4df3932a'} = 1;
