...
%Lexicon = (
    ...
    'Calendar' => 'カレンダー',
    'Create Widget Manager' => 'Widget Managerの作成',
    'Creative Commons' => 'クリエイティブ・コモンズ',
    'Delete Selected' => '選択したものを削除',
    'Enter the name of your new Widget Manager:' => '新しいWidget Managerの名前を入力してください: ',
    "Failed to find WidgetManager::Plugin::[_1]" => 'WidgetManager::Plugin::[_1]が見つかりません。',
    'First Widget Manager' => 'First Widget Manager',
    "Maintain your weblog's widget content using a handy drag and drop interface." => 'ブログに表示されるWidgetの内容をドラッグアンドドロップで簡単に管理できるようにします。',
    'Installed Widgets' => 'インストールされたWidget',
    # 'Installed Widgets' => 'インストールされたWidget',
    'Manage my Widgets' => 'Widgetの管理',
    'Monthly Archive' => '月別アーカイブ',
    'Rearrange Items' => 'アイテムの再整理',
    # 'Rearrange Items' => 'アイテムの再整理',
    'Subscribe' => '購読',
    'Technorati' => 'テクノラティ',
    'Your changes to the Widget Manager have been saved.' => 'Widget Managerへの変更を保存しました。',
    # 'Your changes to the Widget Manager have been saved.' => '',
    # 'Your changes to the Widget Manager have been saved.' => '',
    'You have successfully deleted the selected Widget Manager(s) from your weblog.' => 'ブログから指定されたWidget Managerを削除しました。',
    'Widget Manager Name:' => 'Widget Manager名: ',
    'WidgetManager Name' => 'Widget Manager名',
