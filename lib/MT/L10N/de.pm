...
%Lexicon = (
    ...
    'This page provides you with information on your system\'s configuration and determines whether you have all of the components you need to run Movable Type.' => 'Auf dieser Seite finden Sie Informationen zu Ihrer Systemkonfiguration, damit festgestellt werden kann, ob Ihr Webserver über alle notwendigen Komponenten zur Ausführung von Movable Type verfügt.',  # Translate - Improved (1) #k
    ...
    'The DBD::mysql version you have installed is known to be incompatible with Movable Type. Please install the current release available from CPAN.' => 'Ihre DBD::mysql Version ist mit Movable Type nicht kompatibel. Bitte installieren Sie die aktuelle Version aus CPAN.', # Translate - Improved (2) #k
    'The $mod is installed properly, but requires an updated DBI module. Please see note above regarding the DBI module requirements.' => '$mod ist korrekt installiert, erfordert aber ein aktuelleres DBI-Modul. Bitte beachten Sie oben stehende Versionshinweise.', # Translate - Improved (1) #k
    ...
    'By default, this search engine looks for all words in any order. To search for an exact phrase, enclose the phrase in quotes:' => 'Die Suchfunktion sucht standardmäßig nach allen angebenen Begriffen in beliebiger Reihenfolge. Um nach einem exakten Ausdruck zu suchen, setzen Sie diesen bitte in Anführungszeichen.', # Translate - Improved (0) #k
    'The search engine also supports AND, OR, and NOT keywords to specify boolean expressions:' => 'Die boolschen Operatoren AND, OR und NOT werden unterstützt:', # Translate - Improved (14) #k
    'personal OR publishing' => 'Schrank OR Schublade',
    'publishing NOT personal' => 'Regal NOT Schrank',

    ## ./search_templates/comments.tmpl #c
    ...
    'Posted in [_1] on [_2]' => 'Veröffentlicht in [_1] am [_2]', # Translate - New (5) #k
    'No results found' => 'Keine Treffer', # Translate - Improved (3) #k
    ...
    ## ./search_templates/results_feed.tmpl #c
    'Search Results for [_1]' => 'Suchergebnisse für [_1]',

    ## ./search_templates/results_feed_rss2.tmpl

    ## ./default_templates/comment_error_template.tmpl #c
    ...
    ## ./default_templates/dynamic_pages_error_template.tmpl #c
    'Page Not Found' => 'Seite nicht gefunden',

    ## ./default_templates/trackback_listing_template.tmpl #c
    ...
    ## ./default_templates/individual_entry_archive.tmpl #c
    'Main' => 'Hauptseite',
    ...
    ## ./default_templates/datebased_archive.tmpl #c
    'About [_1]' => 'Über [_1]',
    '<a href=' => '<a href=', # Translate - Previous (3) #k

    ## ./default_templates/uploaded_image_popup_template.tmpl

    ## ./default_templates/category_archive.tmpl #c
    'Posted on [_1]' => 'Geschrieben am [_1]',

    ## ./default_templates/master_archive_index.tmpl #c
    ': Archives' => ': Archive',
    ...
    ## ./default_templates/site_javascript.tmpl #c
    'Thanks for signing in,' => 'Hallo ',
    '. Now you can comment. ' => '. Sie können jetzt kommentieren. ', # Translate - Improved (4) #k
    'sign out' => 'abmelden',
    ...
    ## ./default_templates/comment_preview_template.tmpl #c
    ...
    ## ./default_templates/comment_pending_template.tmpl #c
    ...
    ## ./default_templates/search_results_template.tmpl #c
    ...
    ## ./extras/examples/plugins/l10nsample/l10nsample.pl #c
    'l10nsample' => 'l10nsample', # Translate - Previous (2) #k
    ...
    'Fumiaki Yoshimatsu' => 'Fumiaki Yoshimatsu', # Translate - Previous (2) #k

    ## ./extras/examples/plugins/l10nsample/tmpl/view.tmpl #c
    'This phrase is processed in template.' => 'Dieser Ausdruck wird im Template verarbeitet.',

    ## ./plugins/nofollow/nofollow.pl #c
    ...
    ## ./plugins/TemplateRefresh/TemplateRefresh.pl #c
    ...
    ## ./plugins/spamlookup/spamlookup.pl #c
    ...
    ## ./plugins/spamlookup/spamlookup_urls.pl #c
    ...
    ## ./plugins/spamlookup/tmpl/url_config.tmpl #c
    ...
    ## ./plugins/spamlookup/tmpl/lookup_config.tmpl #c
    ...
    ## ./plugins/spamlookup/tmpl/word_config.tmpl #c
    ...
    ## ./plugins/StyleCatcher/tmpl/header.tmpl #c
    'Main Menu' => 'Hauptmenü',
    ...
    ## ./plugins/StyleCatcher/tmpl/view.tmpl #c
    ...
    'Loading...' => 'Lade...',
    ' To change the location of your local theme repository, ' => ' Um Ihren lokalen Themes-Speicher zu verschieben, ',
    ...
    'Find Styles' => 'Styles finden', # Translate - New (2) #k
    ...
    ## ./plugins/WidgetManager/tmpl/edit.tmpl #c
    'Widget Manager' => 'Widget Manager', # Translate - Previous (2) #k
    ...
    'Build WidgetManager:' => 'Widget Manager anlegen:', # Translate - Improved (1) #k
    'Installed Widgets' => 'Installierte Widgets',
    'Available Widgets' => 'Erhältliche Widgets',
    'Save Changes' => 'Änderungen speichern',

    ## ./plugins/WidgetManager/tmpl/header.tmpl #c
    ...
    ## ./plugins/WidgetManager/tmpl/list.tmpl #c
    'To add a Widget Manager to your templates, use the following syntax:' => 'Um einen Widget Manager in ein Template einzufügen, verwenden Sie folgende Syntax:', # Translate - New (12) #k
    'Widget Managers' => 'Widget Manager', # Translate - Previous (2) #k
    'Add Widget Manager' => 'Widget Manager hinzufügen',
    'Create Widget Manager' => 'Widget Manager anlegen',
    'You have successfully deleted the selected Widget Manager(s) from your weblog.' => 'Widget Manager erfolgreich gelöscht.', # Translate - Improved (1) #k
    'WidgetManager Name' => 'Name des Widget Managers',  # Translate - Improved (1) #k
    'Edit' => 'Bearbeiten',
    'Delete Selected' => 'Ausgewählte Elemente löschen',
    'Are you sure you wish to delete the selected Widget Manager(s)?' => 'Diese Widget Manager wirklich löschen?', # Translate - Improved (1) #k

    ## ./plugins/WidgetManager/tmpl/footer.tmpl

    ## ./plugins/WidgetManager/default_widgets/search.tmpl

    ## ./plugins/WidgetManager/default_widgets/technorati_search.tmpl #c
    'Technorati' => 'Technorati', # Translate - New (1) #k
    'search' => '-Suche', # Translate - New (1) #k
    'this blog' => 'in diesem Blog', # Translate - New (2) #k
    'all blogs' => 'in allen Blogs', # Translate - New (2) #k
    'Blogs that link here' => 'Blogs, die Links auf diese Seite enthalte', # Translate - New (4) #k
    ...
    ## ./plugins/WidgetManager/default_widgets/calendar.tmpl #c
    'Monthly calendar with links to each day\'s posts' => 'Monatskalender mit Links zu allen Einträgen', # Translate - New (9) #k
    'Sunday' => 'Sonntag', # Translate - New (1) #k
    'Sun' => 'So', # Translate - New (1) #k
    'Monday' => 'Montag', # Translate - New (1) #k
    'Mon' => 'Mo', # Translate - New (1) #k
    'Tuesday' => 'Dienstag', # Translate - New (1) #k
    'Tue' => 'Di', # Translate - New (1) #k
    'Wednesday' => 'Mittwoch', # Translate - New (1) #k
    'Wed' => 'Mi', # Translate - New (1) #k
    'Thursday' => 'Donnerstag', # Translate - New (1) #k
    'Thu' => 'Do', # Translate - New (1) #k
    'Friday' => 'Freitag', # Translate - New (1) #k
    'Fri' => 'Fr', # Translate - New (1) #k
    'Saturday' => 'Samstag', # Translate - New (1) #k
    'Sat' => 'Sa', # Translate - New (1) #k
    ...
    ## ./plugins/GoogleSearch/tmpl/config.tmpl #c
    ...
    'CGI Path Configuration Required' => 'CGI-Pfad muß eingestellt sein', # Translate - Improved (4) #k
    'An error occurred' => 'Es ist ein Fehler aufgetreten',

    ## ./tmpl/cms/edit_comment.tmpl #c
    ...
    'Next' => 'Nächster', # Translate - Improved (1) #k
    '_external_link_target' => '_top',
    'View Entry' => 'Eintrag ansehen',
    'Pending Approval' => 'Freischaltung ausstehend', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/notification_actions.tmpl #c
    ...
    'Select a password for the author.' => 'Geben Sie ein Passwort für den Autoren an.', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/list_commenters.tmpl #c
    ...
    '.' => '.', # Translate - Previous (0) #k
    'Filter' => 'Filter', # Translate - Previous (1) #k
    'No commenters could be found.' => 'Keine Kommentatoren gefunden.',

    ## ./tmpl/cms/comment_actions.tmpl #c
    'to publish' => 'zu Veröffentlichen', # Translate - Improved (1) #k
    ...
    'Blocked' => 'Gesperrt', # Translate - Improved (1) #k
    'Authenticated' => 'Authentifiziert',
    'Search for comments by this commenter' => 'Nach Kommentaren von diesem Kommentator suchen',
    'View this entry' => 'Eintrag ansehen', # Translate - New (3) #k
    ...
    ## ./tmpl/cms/commenter_actions.tmpl #c
    'Trust' => 'Vertrauen',
    'commenters' => 'Kommentatoren',
    ...
    'Junk selected TrackBacks (j)' => 'Ausgewählte TrackBacks als Junk markieren (j)', # Translate - Improved (1) #k
    ...
    'Deletes all junk TrackBacks' => 'Löscht alle Junk-Trackbacks',  # Translate - Improved (1) #k

    ## ./tmpl/cms/list_author.tmpl #c
    'Authors' => 'Autoren',
    ...
    'Multi-weblog tag listing.' => 'Multi-Weblog Tagliste.', # Translate - Improved (1) #k
    ...
    'Enable one-click publishing.' => 'One-Click-Publishing einrichten.', # Translate - Improved (1) #k
    ...
    'Expanded' => 'Erweitert',
    'Save' => 'Speichern',
    'You currently have no blogs.  Please see your system administrator for access.' => 'Sie haben derzeit keine Blogs. Bitte wenden Sie sich an Ihren Administrator.',

    ## ./tmpl/cms/import.tmpl #c
    ...
    'Password (required if creating new authors):' => 'Passwort (erforderlich zum möglichen Erstellen neuer Autoren):', # Translate - Improved (1) #k
    ...
    'File From Your Computer (optional):' => 'Lokale Datei (optional):',
    'Encoding (optional):' => 'Encoding (optional):', # Translate - Previous (2) #k
    'Export Entries From [_1]' => 'Einträge exportieren von [_1]',
    'Export Entries to Tangent' => 'Einträge nach Tangent exportieren',

    ## ./tmpl/cms/edit_template.tmpl #c
    ...
    'Search Results Template' => 'Template für Suchergebnisse', # Translate - New (3) #k
    ...
    'Uploaded Image Popup Template' => 'Popuptemplate für hochgeladenes Bilder', # Translate - Improved (4) #k
    ...
    ## ./tmpl/cms/author_actions.tmpl #c
    'author' => 'Autor',
    'authors' => 'Autoren',
    'Delete selected authors (x)' => 'Markierte Beutzer löschen (x)',

    ## ./tmpl/cms/bookmarklets.tmpl #c
    ...
    ## ./tmpl/cms/tag_table.tmpl #c
    'IP Address' => 'IP-Adresse',
    'Log Message' => 'Protokollnachricht',

    ## ./tmpl/cms/blog-left-nav.tmpl #c
    'Posting' => 'Einträge',
    ...
    'Commenters' => 'Kommentatoren', # Translate - Improved (1) #k
    'List TrackBacks' => 'TrackBacks auflisten',
    'Edit Notification List' => 'Benachrichtigungsliste bearbeiten', # Translate - Improved (1) #k
    'Notifications' => 'Benachrichtigungen', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/import_start.tmpl #c
    'Importing...' => 'Importieren...',
    'Importing entries into blog' => 'Importiere Einrtäge ins Weblog',
    'Importing entries as author \'[_1]\'' => 'Importiere als Autor \'[_1]\'',
    'Creating new authors for each author found in the blog' => 'Lege neue Autoren an für jeden Autor, der gefunden wird', # Translate - Improved (5) #k

    ## ./tmpl/cms/search_replace.tmpl #c
    ...
    'Source URL' => 'Quell-URL', # Translate - Improved (1) #k
    ...
    'No TrackBacks were found that match the given criteria.' => 'Keine TrackBacks gefunden, auf die der Suchfilter zutrifft.', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/log_table.tmpl #c
    'IP: [_1]' => 'IP: [_1]', # Translate - Previous (2) #k

    ## ./tmpl/cms/log_actions.tmpl #c
    'Reset Activity Log' => 'Aktivitätsprotokoll zurücksetzen',

    ## ./tmpl/cms/cfg_entries.tmpl #c
    'New Entry Default Settings' => 'Standardeinstellung für neue Einträge',
    'This screen allows you to control default settings for new entries as well as your publicity and remote interface settings.' => 'Hier legen Sie fest, welche Einstellungen für neue Einträge standardmässig übernommen werden. Zudem konfigurieren Sie die Öffentlichkeits- und Remote Interface-Funktionen.',  # Translate - Improved (20) #k
    'General' => 'Allgemein',
    ...
    'Basename Length:' => 'Basename-Länge:', # Translate - Improved (1) #k
    ...
    'Others:' => 'Andere:',
    '(Separate URLs with a carriage return.)' => '(Pro Zeile eine URL)', # Translate - Improved (6) #k
    'When this weblog is updated, Movable Type will automatically notify the selected sites.' => 'Wenn ein neuer Eintrag veröffentlicht wird, werden die folgenden Dienste automatisch benachrichtigt.', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/edit_blog.tmpl #c
    'You must set your Weblog Name.' => 'Sie müssen den Namen Ihres Weblogs festlegen.', # Translate - Improved (1) #k
    'You must set your Local Site Path.' => 'Sie müssen den Pfad Ihres lokalen Verzeichnis festlegen.', # Translate - Improved (2) #k
    ...
    'New Weblog Settings' => 'Einstellungen für neue Weblogs',  # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/template_actions.tmpl #c
    'template' => 'Template',
    'templates' => 'Templates',

    ## ./tmpl/cms/edit_ping.tmpl #c
    ...
    '[_1] has been successfully added to [_2].' => '[_1] wurde erfolgreich zu [_2] hinzugefügt.', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/edit_categories.tmpl #d
    'Your category changes and additions have been made.' => 'Kategorien geändert bzw. hinzugefügt.',  # Translate - Improved (8) #k
    'You have successfully deleted the selected categories.' => 'Ausgewählten Kategorien erfolgreich gelöscht.', # Translate - Improved (7) #k
    ...
    ## ./tmpl/cms/edit_commenter.tmpl #c
    ...
    ## ./tmpl/cms/pinging.tmpl #c
    'Pinging sites...' => 'Pings zu Sites senden...',

    ## ./tmpl/cms/commenter_table.tmpl #c
    'Identity' => 'ID',
    'Most Recent Comment' => 'Neuester Kommentar', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/notification_table.tmpl #c
    'Date Added' => 'Hinzugefügt am',

    ## ./tmpl/cms/edit_placements.tmpl #c
    ...
    'Categories in your weblog:' => 'Kategorien Ihres Weblogs:', # Translate - Improved (4) #k
    'Secondary categories:' => 'Sekundäre Kategorien:',
    'Assign &gt;&gt;' => 'Zuweisen &gt;&gt;',
    '&lt;&lt; Remove' => '&lt;&lt; Entfernen',
    'Close' => 'Schließen',

    ## ./tmpl/cms/feed_link.tmpl #c
    'Activity Feed' => 'Aktivitäts-Feed',
    'Activity Feed (Disabled)' => 'Aktivitäts-Feed (deaktiviert)',

    ## ./tmpl/cms/rebuild-stub.tmpl #c
    ...
    'Select whether you want your posts displayed in ascending (oldest at top) or descending (newest at top) order.' => 'Wählen Sie aus, ob Ihre Einträge in auf- (ältester zuerst) oder absteigender (neuester zuerst) Reihenfolge angezeigt werden sollen.', # Translate - Improved (2) #k
    'Comment Order:' => 'Kommentarsortierung:',
    'Select whether you want visitor comments displayed in ascending (oldest at top) or descending (newest at top) order.' => 'Wählen Sie aus, ob Kommentare von Besuchern in auf- (ältester zuerst oder absteigender (neuester zuerst) Reihenfolge angezeigt werden sollen.', # Translate - Improved (2) #k
    'Excerpt Length:' => 'Auszugslänge:', # Translate - Improved (1) #k
    ...
    'Date Language:' => 'Datumssprache:', # Translate - Improved (1) #k
    'Czech' => 'Tschechisch',
    'Danish' => 'Dänisch',
    'Dutch' => 'Holländisch',
    'English' => 'Englisch',
    ...
    'Suomi' => 'Finnisch',
    'Swedish' => 'Schwedisch',
    'Select the language in which you would like dates on your blog displayed.' => 'Wählen Sie die Sprache für Datumsanzeigen.', # Translate - Improved (0) #k
    ...
    'Specifies the list of HTML tags allowed by default when cleaning an HTML string (a comment, for example).' => 'Liste der HTML-Tags, die aus HTML-Kommentaren nicht ausgefiltert werden sollen.', # Translate - Improved (18) #k
    ...
    ## ./tmpl/cms/tag_actions.tmpl #c
    'Delete selected tags (x)' => 'Markierte Tags löschen (x)',

    ## ./tmpl/cms/ping_table.tmpl #c
    'From' => 'Von',
    'Target' => 'Auf',
    ...
    'Warning: If you set the basename manually, it may conflict with another entry.' => 'Warnung: Wenn Sie den Basenamen manuell einstellen, ist es nicht auszuschließen, daß der gewählte Name bereits existiert.', # Translate - Improved (1) #k
    ...
    'All times are displayed in GMT.' => 'Alle Zeiten in GMT.', # Translate - Improved (0) #k
    ...
    'Security' => 'Sicherheit',
    'Error' => 'Fehler',
    'Information' => 'Information', # Translate - Previous (1) #k
    'Debug' => 'Debug', # Translate - Previous (1) #k
    ...
    ## ./tmpl/cms/delete_confirm.tmpl #c
    ...
    'Are you sure you want to delete the [quant,_1,category,categories]? When you delete a category, all entries assigned to that category will be unassigned from that category.' => 'Sind Sie sicher, dass Sie diese [quant,_1,Kategorie,Kategorien] löschen möchten? Wenn Sie eine Kategorie löschen, werden alle dieser Kategorie zugewiesenen Einträge von der Kategorie getrennt (die Einträge werden aber nicht gelöscht).', # Translate - Improved (0) #k
    ...
    'Are you sure you want to delete the [quant,_1,IP address,IP addresses] from your Banned IP List?' => 'Sind Sie sicher, dass Sie diese [quant,_1,IP-Adresse,IP-Adressen] aus Ihrer Liste der gesperrten IP-Adressen löschen möchten?', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/cfg_feedback.tmpl #c
    'Feedback Settings' => 'Feedback-Einstellungen',
    'This screen allows you to control the feedback settings for this weblog, including comments and TrackBacks.' => 'Hier nehmen Sie alle Feedback-Einstellungen einschließlich der Kommentar- und TrackBack-Einstellungen vor.', # Translate - Improved (0) #k
    ...
    'E-mail Notification' => 'Email-Benachrichtigung', # Translate - Improved (1) #k
    'On' => 'Ein',
    ...
    'If enabled, users will be able to enter a limited set of HTML in their comments. If not, all HTML will be stripped out.' => 'Wenn Sie HTML zulassen, dürfen Kommentatoren HTML verwenden. Wenn Sie HTML nicht zulassen, wird HTML aus Kommentaren herausgefiltert.', # Translate - Improved (1) #k
    'Auto-Link URLs' => 'URLs automatisch verlinken', # Translate - Improved (3) #k
    'If enabled, all non-linked URLs will be transformed into links to that URL.' => 'Legt fest, ob alle URLs automatisch in HTML-Links umgewandelt werden sollen.', # Translate - Improved (14) #k
    ...
    ## ./tmpl/cms/list_notification.tmpl #c
    ...
    'You have added [_1] to your notification list.' => 'Sie haben [_1] zu Ihrer Benachrichtigungsliste hinzugefügt.', # Translate - Improved (1) #k
    ...
    'Optional.' => 'Optional.', # Translate - Previous (1) #k
    'Outbound TrackBacks' => 'TrackBacks (outbound)',
    'Enter the URL(s) of the websites that you would like to send a TrackBack to each time you post an entry in this category. (Separate URLs with a carriage return.)' => 'URL(s) der Websites, denen Sie ein TrackBack senden möchten, wenn Sie in dieser Kategorie einen Eintrag veröffentlichen. (Verwenden Sie für jede URL eine neue Zeile)', # Translate - Improved (0) #k

    ## ./tmpl/cms/menu.tmpl #c
    ...
    'http://www.sixapart.com/movabletype/support' => 'http://www.sixapart.com/movabletype/support', # Translate - Previous (6) #k
    'Movable Type Technical Support' => 'Movable Type Technischer Support',
    'Movable Type Community Forums' => 'Movable Type Community-Foren', # Translate - Previous (4) #k
    ...
    ## ./tmpl/cms/template_table.tmpl #c
    'Dynamic' => 'Dynamisch',
    'Linked' => 'Verlinkt',
    ...
    ## ./tmpl/cms/header.tmpl #c
    'Go to:' => 'Gehe zu:',
    'System-wide listing' => 'Systemweite Auflistung', # Translate - Improved (3) #k
    'Search (q)' => 'Suche (q)',

    ## ./tmpl/cms/admin.tmpl #c
    ...
    'https://secure.sixapart.com/t/account' => 'https://secure.sixapart.com/t/account', # Translate - Previous (6) #k
    'Your Account' => 'Ihr Account',
    'https://secure.sixapart.com/t/help?__mode=edit' => 'https://secure.sixapart.com/t/help?__mode=edit', # Translate - Previous (8) #k
    'Open a Help Ticket' => 'Hilfe-Ticket öffnen', # Translate - New (4) #k
    'Paid License Required' => 'Bezahlte MT-Version erforderlich', # Translate - New (3) #k
    'http://www.sixapart.com/movabletype/' => 'http://www.sixapart.com/movabletype/', # Translate - Previous (5) #k
    'http://www.sixapart.com/pronet/plugins/' => 'http://www.sixapart.com/pronet/plugins/', # Translate - Previous (6) #k
    'https://secure.sixapart.com/t/help?__mode=kb' => 'https://secure.sixapart.com/t/help?__mode=kb', # Translate - New (8) #k
    'Knowledge Base' => 'Wissensdatenbank', # Translate - Previous (2) #k
    'http://www.sixapart.com/pronet/' => 'http://www.sixapart.com/pronet/', # Translate - Previous (5) #k
    ...
    'Run' => 'Ausführen', # Translate - New (1) #k
    'Run [_1]' => '[_1] ausführen', # Translate - New (2) #k
    ...
    '[_1] Settings' => '[_1]-Einstellungen', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/error.tmpl #c
    'An error occurred:' => 'Es ist ein Fehler aufgetreten:',
    'Go Back' => 'Zurück',

    ## ./tmpl/cms/list_comment.tmpl #c
    ...
    ## ./tmpl/cms/upload_confirm.tmpl #c
    'A file named \'[_1]\' already exists. Do you want to overwrite this file?' => 'Eine Datei namens \'[_1]\' ist bereits vorhanden. Möchten Sie sie überschreiben?', # Translate - Improved (7) #k

    ## ./tmpl/cms/recover.tmpl #c
    ...
    ## ./tmpl/cms/show_upload_html.tmpl #c
    ...
    'System templates specify the layout and style of a small number of dynamic pages which perform specific system functions in Movable Type.' => 'System-Templates legen das Layout und den Stil von einigen dynamischen Seiten mit besonderen Funktionen fest.',  # Translate - Improved (6) #k
    ...
    'Create New Template Module' => 'Neues Template-Modul',
    'No index templates could be found.' => 'Keine Index-Templates gefunden.', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/itemset_action_widget.tmpl #c
    'More actions...' => 'Weitere Aktionen...',
    'No actions' => 'Keine Aktionen',

    ## ./tmpl/cms/cfg_system_feedback.tmpl #c
    'This screen allows you to configure feedback and outbound TrackBack settings for the entire installation.  These settings override any similar settings for individual weblogs.' => 'Hier konfigurieren Sie die Kommentar- und TrackBack-Einstellungen für das Gesamtsystem. Diese Einstellungen sind höherrangig als die entsprechenden Einstellungen der einzelnen Weblogs, d.h. sie setzen diese außer Kraft.',  # Translate - Improved (9) #k
    ...
    'This will override all individual weblog comment settings.' => 'Diese Einstellung setzt die entsprechenden Einstellungen der Einzelweblogs außer Kraft.', # Translate - Improved (8) #k
    ...
    'This will override all individual weblog TrackBack settings.' => 'Diese Einstellung setzt die entsprechenden Einstellungen der Einzelweblogs außer Kraft.', # Translate - Improved (8) #k
    ...
    ## ./tmpl/cms/bm_posted.tmpl #c
    'Your new entry has been saved to [_1]' => 'Ihr Eintrag wurde gespeichert unter [_1]',
    ', and it has been posted to your site' => 'und auf Ihrer Site veröffentlicht.', # Translate - Improved (8) #k
    '. ' => '. ', # Translate - Previous (0) #k
    'Edit this entry' => 'Eintrag bearbeiten',

    ## ./tmpl/cms/overview-left-nav.tmpl #c
    ...
    ## ./tmpl/cms/upload_complete.tmpl #c
    ...
    'Pixels' => 'Pixel',
    'Percent' => 'Prozent',
    'Height:' => 'Höhe:', # Translate - Improved (1) #k
    'Constrain proportions' => 'Proportionen erhalten', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/upgrade_runner.tmpl #c
    ...
    ## ./tmpl/cms/bm_entry.tmpl #c
    'Select' => 'Auswählen',
    'You must choose a weblog in which to post the new entry.' => 'Sie müssen einen Weblog auswählen, in dem der neue Eintrag veröffentlicht werden soll.', # Translate - Improved (7) #k
    'Select a weblog for this post:' => 'Wählen Sie einen Weblog für diesen Eintrag:', # Translate - Improved (1) #k
    ...
    ## ./tmpl/cms/system_list_blog.tmpl #c
    'Are you sure you want to delete this weblog?' => 'Möchten Sie dieses Weblog wirklich löschen?', # Translate - Improved (1) #k
    ...
    'You have successfully added a new archive-template association.' => 'Sie haben erfolgreich eine neue Verknüpfung zwischen Archiv und Template hinzugefügt.', # Translate - Improved (1) #k
    ...
    'Publishing Preferences' => 'Weitere Einstellungen', # Translate - Improved (1) #k
    ...
    'Weekly' => 'Wöchentlich',
    'Monthly' => 'Monatliche',
    'When linking to an archived entry&#8212;for a permalink, for example&#8212;you must link to a particular archive type, even if you have chosen multiple archive types.' => 'Wenn Sie Einzeleinträge verlinken möchten, z.B. über den Permalink, und mehrere Archivarten zur Verfügung stehen, müssen Sie sich entscheiden, auf welchen Archivtyp Sie den Link setzen möchten.', # Translate - Improved (29) #k
    'File Extension for Archive Files:' => 'Dateierweiterung für Archivdateien:', # Translate - Improved (1) #k
    'Enter the archive file extension. This can take the form of \'html\', \'shtml\', \'php\', etc. Note: Do not enter the leading period (\'.\').' => 'Geben Sie die gewünschte Erweiterung der Archivdateien an. Möglich sind \'html\', \'shtml\', \'php\' usw. Hinweis: Geben Sie nicht den führenden Punkt (\'.\') ein.', # Translate - Improved (5) #k
    ...
    'Archive Mapping' => 'Archiv-Verknüpfung', # Translate - Improved (1) #k
    'Create New Archive Mapping' => 'Neue Archiv-Verknüpfung einrichten', # Translate - Improved (2) #k
    ...
    'Preferred' => 'Bevorzugt',
    'Custom...' => 'Angepasst...',
    'archive map' => 'Archiv-Verknüpfung', # Translate - Improved (1) #k
    'archive maps' => 'Archiv-Verknüpfungen', # Translate - Improved (1) #k

    ## ./tmpl/cms/rebuilding.tmpl #c
    'Rebuilding [_1]' => 'Veröffentliche [_1]', # Translate - Improved (1) #k
    'Rebuilding [_1] pages [_2]' => 'Baue [_1]-Seiten neu auf [_2]', # Translate - Improved (2) #k
    'Rebuilding [_1] dynamic links' => 'Baue [_1] dynamische Links neu auf', # Translate - Improved (3) #k
    'Rebuilding [_1] pages' => 'Baue [_1]-Seiten neu auf', # Translate - Improved (2) #k

    ## ./tmpl/cms/upload.tmpl #c
    ...
    '(Optional)' => '(optional)',
    'Path:' => 'Ordner:',
    'Site Root' => 'Site-Root', # Translate - Improved (0) #k
    'Archive Root' => 'Archiv-Root', # Translate - Improved (0) #k
    'Upload' => 'Hochladen',

    ## ./tmpl/cms/cfg_entries_edit_page.tmpl #c
    'Default Entry Editor Display Options' => 'Standard-Anzeigeoptionen für Editor',

    ## ./tmpl/cms/recover_password_result.tmpl #c
    ...
    ## ./tmpl/email/verify-subscribe.tmpl #c
    ...
    ## ./tmpl/email/notify-entry.tmpl #c
    '[_1] Update: [_2]' => '[_1] Update: [_2]', # Translate - Previous (4) #k

    ## ./tmpl/email/footer-email.tmpl #c
    'Powered by Movable Type' => 'Powered by Movable Type', # Translate - Previous (4) #k
    'Version [_1]' => 'Version [_1]', # Translate - Previous (2) #k
    ...
    ## Other phrases, with English translations. #c
    'WEEKLY_ADV' => 'Wöchentlich',
    ...
    '_USAGE_BANLIST' => 'Hier können Sie IP-Adressen sperren, Kommentare abzugeben oder TrackBack-Pings an Ihr Weblog zu senden. Sie können der Sperrliste sowohl neue IP-Adressen hinzufügen oder gesperrte IP-Adressen wieder löschen.', # Translate - Improved (9) #k
    '_ERROR_DATABASE_CONNECTION' => 'Ihre Datenbankkonfiguration ist fehlerhaft. Bitte lesen Sie die Movable Type-Dokumention: <a href="#">Installation and Configuration</a>.', # Translate - Improved (1) #k
    ...
    '_USAGE_FORGOT_PASSWORD_1' => 'Sie haben ein neues Movable Type-Passwort angefordert. Es wurde automatisch ein neues Passwort erzeugt. Es lautet:', # Translate - Improved (5) #k
    ...
    'Individual Entry Archive' => 'Einzelarchive', # Translate - Improved (3) #k
    'Daily' => 'Täglich',
    ...
    '_USAGE_PROFILE' => 'Hier bearbeiten Sie Ihr Autorenprofil. Wenn Sie Ihren Benutzernamen und Ihr Passwort ändern, werden die Login-Informationen sofort aktualisiert und Sie müssen sich nicht erneut anmelden.', # Translate - Improved (1) #k
    'Category' => 'Kategorie',
    ...
    '_USAGE_ENTRYPREFS' => 'Die Feldkonfiguration legt fest, welche Felder in Ihrer Eingabemaske für neue Einträge erscheinen. Sie könnnen die vordefinierten Einstellungen verwenden (einfach oder erweitert) oder die Felder frei auswählen.', # Translate - Improved (2) #k
    ...
    'Stylesheet' => 'Stylesheet', # Translate - Previous (1) #k
    'RSD' => 'RSD', # Translate - Previous (1) #k
    'MONTHLY_ADV' => 'Monatlich',
    '_USAGE_ARCHIVE_MAPS' => 'Diese Funktion erlaubt es Ihnen, Archiv-Templates mit den verschiedene Archivtypen zu verknüpfen. So können Sie z.B. zwei unterschiedliche Ansichten Ihrer monatlichen Archive erzeugen, einen Listen- und eine Kalenderansicht.', # Translate - Improved (12) #k
    'Trust Commenter(s)' => 'Kommentatoren vertrauen',
    'Manage Tags' => 'Tags verwalten',
    '_THROTTLED_COMMENT' => 'Sie haben zu viele Kommentare in kurzer Folge abgegeben. Zum Schutz vor Spam steht Ihnen Kommentarfunktion daher erst wieder in einigen Augenblicken zur Verfügung. Vielen Dank für Ihr Verständnis.', # Translate - Improved (21) #k
    ...
    '_USAGE_BOOKMARKLET_3' => 'Um das QuickPost-Lesezeichen zu installieren, ziehen Sie den folgenden Link in die Lesezeichenleiste oder in das Lesezeichenmenü Ihres Browsers:', # Translate - Improved (11) #k
    ...
    '_AUTO' => '1',
    '_external_link_target' => '_top',
    '_USAGE_BOOKMARKLET_2' => 'Sie können die Bestandteile von QuickPost frei konfigurieren und die Schaltflächen aktivieren, die Sie häufig verwenden.', # Translate - Improved (3) #k
    ...
    'Ban Commenter(s)' => 'Kommentator(en) sperren', # Translate - Improved (2) #k
    ...
    '_ERROR_CGI_PATH' => 'Ihre CGIPath-Konfiguration fehlt oder ist fehlerhaft. Bitte lesen Sie die Movable Type-Dokumention: <a href="#">Installation and Configuration</a>.', # Translate - Improved (1) #k
    '_USAGE_IMPORT' => 'Mit dem Mechanismus zum Importieren von Einträgen können Sie Einträge aus einem anderen Weblog-System importieren. Das Handbuch enthält ausführliche Anweisungen zum Importieren.', # Translate - Improved (1) #k
    ...
    '_USAGE_EXPORT_3' => 'Durch Klicken auf den nachfolgenden Link werden alle aktuellen Weblog-Einträge exportiert. In der Regel ist das Übertragen der Einträge ein einmaliger Vorgang. Sie können den Vorgang aber jederzeit wiederholen.', # Translate - Improved (1) #k
    ...
    '_SYSTEM_TEMPLATE_COMMENT_ERROR' => 'Wird verwendet, wenn ein Kommentar nicht sofort validiert werden kann.', # Translate - Improved (1) #k
    ...
    'File::Temp is optional; It is needed if you would like to be able to overwrite existing files when you upload.' => 'File::Temp ist optional und nur erforderlich, wenn Sie vorhandene Dateien beim Hochladen überschreiben können möchten.', # Translate - Improved (1) #k
    'Image::Magick is optional; It is needed if you would like to be able to create thumbnails of uploaded images.' => 'Image::Magick ist optional und nur erforderlich, wenn Sie automatisch Miniaturansichten von hochgeladenen Bildern erzeugen möchten.', # Translate - Improved (1) #k
    ...
    'Task Update' => 'Task-Update', # Translate - Previous (2) #k

    ## ./lib/MT/Placement.pm

    ## ./lib/MT/Category.pm #c
    ...
    'You do not have a valid path to the NetPBM tools on your machine.' => 'Kein gültiger Pfad auf NetPBM-Tools eingestellt.', # Translate - Improved (14) #k
    ...
    'Creating template maps...' => 'Lege Template-Verknüpfung an...', # Translate - Improved (1) #k
    ...
    'Invalid login attempt from user \'[_1]\' (ID: [_2])' => 'Ungültiger Login-Versuch von Benutzer  \'[_1]\' (ID: [_2])', # Translate - New (8) #k
    'User \'[_1]\' (user #[_2]) logged in successfully' => 'Benutzer \'[_1]\' (ID: #[_2]) angemeldet',
    'Invalid login.' => 'Login ungültig.', # Translate - Improved (1) #k
    'User \'[_1]\' (user #[_2]) logged out' => 'Benutzer \'[_1]\' (ID: #[_2]) abgemeldet', # Translate - Improved (1) #k
    ...
    ## ./lib/MT/AtomServer.pm #c
    'User \'[_1]\' (user #[_2]) added entry #[_3]' => 'Benutzer \'[_1]\' (ID: #[_2]) hat Eintrag #[_3] hinzugefügt', # Translate - Improved (1) #k
    ...
    ## ./lib/MT/Template/ContextHandlers.pm #c
    ...
    '$short_name [_1]' => '$short_name [_1]', # Translate - New (3) #k
    ...
    '<$MTCategoryTrackbackLink$> must be used in the context of a category, or with the \'category\' attribute to the tag.' => '<$MTCategoryTrackbackLink$> muss im Kategoriekontext oder zusammen mit dem \'category\'-Attribut des Tags verwendet werden.', # Translate - New (19) #k
    ...
    'Invalid request' => 'Ungültige Anfrage', # Translate - New (2) #k
    ...
    'Rebuild failed: [_1]' => 'Neuaufbau fehlgeschlagen: [_1]', # Translate - Improved (1) #k
    ...
    'The e-mail address is required.' => 'Email-Adresse ist erforderlich.',
    ...
    'Invalid parameter' => 'Ungültiges Parameter', # Translate - New (2) #k
    ...
    'The category label \'[_1]\' conflicts with another category. Top-level categories and sub-categories with the same parent must have unique names.' => 'Konflikt um Kategoriename \'[_1]\': Kategorien und Unterkategorien mit der gleichen Wurzel müssen unterschiedliche Namen haben.', # Translate - New (20) #k
    ...
    'Tag' => 'Tag', # Translate - Previous (1) #k
    ...
    'Saving map failed: [_1]' => 'Speichern der Verknüpfung fehlgeschlagen: [_1]', # Translate - Improved (1) #k
    ...
    ## ./lib/MT/App/ActivityFeeds.pm #c
    'An error occurred while generating the activity feed: [_1].' => 'Fehler beim Erzeugen des Aktivitäts-Feeds aufgetreten: [_1].', # Translate - New (9) #k
    'No permissions.' => 'Keine Rechte.', # Translate - New (2) #k
    ...
    'Movable Type Debug Activity' => 'Movable Type Debug-Aktivität', # Translate - New (4) #k

    ## ./lib/MT/Module/Build.pm

    ## ./extras/examples/plugins/mirror/lib/Mirror.pm

    ## ./extras/examples/plugins/l10nsample/lib/l10nsample.pm #c
    ...
    ## ./plugins/spamlookup/lib/spamlookup.pm #c
    ...
    ## ./plugins/feeds-app-lite/lib/MT/Feeds/Lite.pm #c
    ...
    ## ./plugins/StyleCatcher/lib/StyleCatcher.pm #c
    'Before using StyleCatcher, you must specify the Theme Root URL and Path for the installation in the system-level plugin settings for StyleCatcher.' => 'Bevor Sie StyleCatcher verwenden können, legen Sie die Verzeichnisse in den systemweiten StyleCatcher-Einstellungen fest.', # Translate - New (22) #k
    'Configure plugin' => 'Plugin konfigurieren', # Translate - New (2) #k
    ...
    ## ./plugins/WidgetManager/lib/WidgetManager/App.pm #c
    'Moving $mid to list of installed modules' => '$mid auf Liste der installierten Module verschoben',
    'WidgetManager' => 'WidgetManager', # Translate - Previous (1) #k
    'Error opening file \'[_1]\': [_2]' => 'Fehler beim Öffnen der Datei \'[_1]\': [_2]', # Translate - New (5) #k
