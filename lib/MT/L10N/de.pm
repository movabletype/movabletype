...
## php/lib/block.mtassets.php
	'sort_by="score" must be used together with a namespace.' => 'sort_by="score" erfordert einen Namespace.', # Translate - New # OK
...
## php/lib/block.mtcalendar.php
	'You used an [_1] tag without establishing a date context.' => 'Befehl [_1] ohne Datums-Kontext verwendet.', # Translate - New # OK

## php/lib/block.mtentries.php
	'sort_by="score" must be used in combination with namespace.' => 'Sort_by="score" erfordert einen Namespace.',

## php/lib/block.mtif.php
	'You used an [_1] tag without a valid name attribute.' => 'Befehl [_1] ohne gültiges Namens-Attribut verwendet.', # Translate - New # OK
...
## php/lib/captcha_lib.php
	'Captcha' => 'Captcha',
	'Type the characters shown in the picture above.' => 'Geben Sie die Zeichen ein, die Sie in obigem Bild sehen.', # Translate - New # OK
...
## php/lib/function.mtcommenternamethunk.php
	'The \'[_1]\' tag has been deprecated. Please use the \'[_2]\' tag in its place.' => 'Der Befehl \'[_1]\' ist veraltet. Bitte verwenden Sie stattdessen \'[_2]\'', # Translate - New # OK
...
## php/lib/function.mtremotesigninlink.php
	'TypePad authentication is not enabled for this blog.  MTRemoteSignInLink cannot be used.' => 'TypePad-Authentifizierung ist in diesem Blog nicht aktiviert. MTRemoteSignInLink kann daher nicht verwendet werden.', # Translate - New # OK
...
## php/lib/function.mtwidgetmanager.php
	'Error compiling widget set [_1]' => 'Fehler bei Vearbeitung der Widget-Gruppe [_1]', # Translate - New # OK

## php/lib/mtdb.base.php
	'When the exclude_blogs and include_blogs attributes are used together, the same blog IDs should not be listed as parameters to both of them.' => 'Wenn die Attribute exclude_blogs und include_blogs gemeinsam verwendet werden, geben Sie die gleichen Blog-IDs nicht gleichzeitig für beide an. ', # Translate - New # OK
...
## mt-check.cgi
	...
	'The following modules are <strong>optional</strong>. If your server does not have these modules installed, you only need to install them if you require the functionality that they provide.' => 'Die folgenden Module sind <strong>optional</strong>. Sie brauchen zusätzlich nur dann installiert zu werden, wenn Sie die von ihnen bereitgestellten Funktionen nutzen möchten.', # Translate - New # OK
	'The following modules are required by databases that can be used with Movable Type. Your server must have DBI and at least one of these related modules installed for the application to work properly.' => 'Die folgenden Module sind zur Abindung der Datenbank an Movable Type erforderlich. Zur Nutzung des Systems müssen DBI und das Modul für den jeweiligen Datenbank-Typ installiert sein.', # Translate - New # OK
	...
	'The DBD::mysql version you have installed is known to be incompatible with Movable Type. Please install the most current release available.' => 'Die auf Ihrem Server installierte Version von DBD::mysql ist nicht mit Movable Type kompatibel. Bitte installieren Sie die aktuelle Version.', # Translate - New # OK
	'The $mod is installed properly, but requires an updated DBI module. Please see the note above regarding the DBI module requirements.' => '$mod ist korrekt installiert, benötigt aber ein aktuelleres DBI-Modul. Bitte beachten Sie die obigen Hinweise zu diesem Modul.', # Translate - New # OK
	...
	'LWP::UserAgent is required for proper functioning of the Configuration Wizard.' => 'LWP::UserAgent ist zur Nutzung des Konfigurationsassistenten erforderlich.', # Translate - New # OK
	...
	'Digest::SHA is required in order to advanced protection of user passwords.' => 'Digest::SHA ist für den verbesserten Schutz der Benutzerpasswörter erforderlich.', # Translate - New # OK
	'This module and its dependencies are required in order to operate Movable Type under psgi.' => 'Dieses Modul und seine Abhängigkeiten sind zum Betrieb von Movable Type unter psgi erforderlich.', # Translate - New # OK
	...
	'Image::Magick is optional; It is one of the image processors that you can use to create thumbnails of uploaded images.' => 'Die Installation von Image::Magick ist optional. Es ist eines der Module, das zur automatischen Erzeugung von Vorschaubildern verwendet werden kann. ', # Translate - New # OK
	'GD is optional; It is one of the image processors that you can use to create thumbnails of uploaded images.' => 'Die Installation von GD ist optional. Es ist eines der Module, das zur automatischen Erzeugung von Vorschaubildern verwendet werden kann. ', # Translate - New # OK
	'Imager is optional; It is one of the image processors that you can use to create thumbnails of uploaded images.' => 'Die Installation von Imager ist optional. Es ist eines der Module, das zur automatischen Erzeugung von Vorschaubildern verwendet werden kann. ', # Translate - New # OK
	'IPC::Run is optional; It is needed if you would like to use NetPBM as the image processor for Movable Type.' => 'Die Installation von IPC::Run ist optional. Es ist erforderlich, wenn Sie NetPBM zur Erzeugung von Vorschaubildern verwenden möchten.', # Translate - New # OK
	'Storable is optional; It is required by certain Movable Type plugins available from third-party developers.' => 'Die Installation von Storable ist optional. Es wird von einigen Movable-Type-Plugins von Drittanbietern benötigt.', # Translate - New # OK
	...
	'Cache::File is required if you would like to be able to allow commenters to authenticate via OpenID using Yahoo! Japan.' => 'Cache::File ist erforderlich, wenn sich Kommentarautoren über eine OpenID bei Yahoo! Japan authentifizieren können sollen.', # Translate - New # OK
	'MIME::Base64 is required in order to enable comment registration and in order to send mail via an SMTP Server.' => 'MIME::Base64 ist zur Registrierung von Kommentarautoren und zum Versenden von Mails über SMTP-Server erforderlich.', # Translate - New # OK
	'XML::Atom is required in order to use the Atom API.' => 'XML::Atom ist zur Nutzung der Atom-API erforderlich.',
	'Cache::Memcached and a memcached server are required to use in-memory object caching on the servers where Movable Type is deployed.' => 'Cache::Memcached und ein auf dem Movable-Type-Server laufender memcached-Server sind zur Zwischenspeicherung von Objekten im Arbeitsspeicher  erforderlich.', # Translate - New # OK
	'Archive::Tar is required in order to manipulate files during backup and restore operations.' => 'Archive::Tar ist für Dateioperationen beim Erstellen und Einspielen von Backups erforderlich.', # Translate - New # OK
	'IO::Compress::Gzip is required in order to compress files during backup operations.' => 'IO::Compress::Gzip ist zum Packen von Backup-Dateien erforderlich.', # Translate - New # OK
	'IO::Uncompress::Gunzip is required in order to decompress files during restore operation.' => 'IO::Uncompress::Gzip ist zum Entpacken von Backup-Dateien erforderlich.', # Translate - New # OK
	'Archive::Zip is required in order to manipulate files during backup and restore operations.' => 'Archive::Zip ist für Dateioperationen beim Erstellen und Einspielen von Backups erforderlich.', # Translate - New # OK
	'XML::SAX and its dependencies are required to restore a backup created in a backup/restore operation.' => 'XML::SAX und seine Abhängigkeiten sind zum Einspielen von Backups erforderlich.', # Translate - New # OK
	...
	'Net::SMTP is required in order to send mail via an SMTP Server.' => 'Net::SMTP ist für den Versand von E-Mails über SMTP-Server erforderlich.', # Translate - New # OK
	...
	'Net::SMTP::SSL is required to use SMTP Auth with an SSL connection.' => 'Net::SMTP::SSL ist zur Verwendung von SMTP Auth über SSL erforderlich.', # Translate - New # OK
	'Net::SMTP::TLS is required to use SMTP Auth with the STARTTLS communication protocol.' => 'Net::SMTP::SSL ist zur Verwendung von SMTP Auth über SSL erforderlich.', # Translate - New # OK
	'IO::Socket::SSL is required to use SMTP Auth with an SSL connection or the STARTTLS communication protocol.' => 'Net::SMTP::SSL ist zur Verwendung von SMTP Auth über SSL erforderlich.', # Translate - New # OK
	'Net::SSLeay is required to use SMTP Auth with an SSL connection or the STARTTLS communication protocol.' => 'Net::SSLeay ist zur Verwendung von SMTP Auth über SSL oder mit STARTSSL erforderlich.', # Translate - New # OK
	'This module is used to test attributes in the MTIf conditional tag.' => 'Dieses Modul ist zum Prüfen von Attributen des MTIf-Befehls erforderlich.', # Translate - New # OK
	'This module is used by the Markdown text filter.' => 'Dieses Modul ist für den Markdown-Textfilter erforderlich.',
	'This module is required by mt-search.cgi, if you are running Movable Type using a version of Perl older than Perl 5.8.' => 'Dieses Modul ist für mt-search.cgi erforderlich, wenn Sie Perl älter als 5.8 einsetzen.', # Translate - New # OK
...
## default_templates/about_this_page.mtml
	...
	'This page contains links to all of the archived content.' => 'Diese Seite enthält Links zu allen archivierten Inhalten.', # Translate - New # OK
...
## default_templates/archive_widgets_group.mtml
	'This is a custom set of widgets that serve different content depending on the type of archive in which it is included. More info: [_1]' => 'Diese Widgetgruppe zeigt auf die jeweilige Archivseite zugeschnittene Informationen an: [_1] ', # Translate - New # OK
...
## default_templates/banner_footer.mtml
	...
	'This blog is licensed under an <a href="[_1]">Creative Commons License</a>.' => 'Dieses Blog steht unter einer <a href="[_1]">Creative-Commons-Lizenz</a>.', # Translate - New # OK
...
## default_templates/commenter_confirm.mtml
	...
	'For your security and to prevent fraud, we ask you to confirm your account and email address before continuing. Once your account is confirmed, you will immediately be allowed to comment on [_1].' => 'Bitte bestätigen Sie Ihr Benutzerkonto und Ihre E-Mail-Adresse. Das ist nur ein Mal erforderlich. Anschließend können Sie direkt auf [_1] Kommentare schreiben.', # Translate - New # OK
	'To confirm your account, please click on the following URL, or cut and paste this URL into a web browser:' => 'Um Ihr Benutzerkonto zu bestätigen, klicken Sie auf folgende Web-Adresse oder kopieren Sie sie in die Adresszeile Ihres Browsers:', # Translate - New # OK
...
## default_templates/commenter_notify.mtml
	q{This email is to notify you that a new user has successfully registered on the blog '[_1]'. Here is some information about this new user.} => q{Ein neuer Benutzer hat sich erfolgreich auf '[_1]' registriert. Hier die Angaben dieses Benutzers.}, # Translate - New # OK
...
## default_templates/comment_throttle.mtml
	...
	'This was done to prevent a malicious script from overwhelming your weblog with comments. The banned IP address is' => 'Dadurch wird verhindert, daß Ihr Blog mit automatisch erzeugten Kommentaren überschwemmt wird. Die gesperrte Adresse lautet', # Translate - New # OK
...
## default_templates/javascript.mtml
	...
	'The sign-in attempt was not successful.  Please try again.' => 'Anmeldeversuch fehlgeschlagen. Bitte versuchen Sie es erneut.', # Translate - New # OK
...
## default_templates/lockout-user.mtml
	...
	'If you want to permit this user to participate again, click the link below.' => 'Um das Konto wieder freizuschalten, klicken Sie auf folgenden Link.', # Translate - New # OK

## default_templates/main_index.mtml

## default_templates/main_index_widgets_group.mtml
	'This is a custom set of widgets that only appear on the homepage (or "main_index"). More info: [_1]' => 'Diese Widgetgruppe erscheint ausschließlich auf der Startseite (bzw. auf der von der Vorlage "main_index" erzeugten Seite). Weitere Informationen: [_1]', # Translate - New # OK
...
## default_templates/new-comment.mtml
	...
	q{An unapproved comment has been posted on your blog '[_1]', on page #[_2] ([_3]). You need to approve this comment before it will appear on your site.} => q{Zu Seite  #[_2] ([_3]) Ihres Blogs '[_1]' ist ein noch nicht freigeschalteter Kommentar eingegangen. Schalten Sie ihn frei, um ihn auf Ihrer Website erscheinen zu lassen.}, # Translate - New # OK
	q{An unapproved comment has been posted on your website '[_1]', on page #[_2] ([_3]). You need to approve this comment before it will appear on your site.} => q{ Zu Seite #[_2] ([_3]) Ihrer Website '[_1]' ist ein noch nicht freigeschalteter Kommentar eingegangen. Schalten Sie ihn frei, um ihn auf Ihrer Website erscheinen zu lassen.}, # Translate - New # OK
	...
	'Report the comment as spam:' => 'Kommentar als Spam melden', # Translate - New # OK

## default_templates/new-ping.mtml
	q{An unapproved TrackBack has been posted on your blog '[_1]', on entry #[_2] ([_3]). You need to approve this TrackBack before it will appear on your site.} => q{Zu Eintrag #[_2] ([_3]) Ihres Blogs '[_1]' ist ein noch nicht freigeschaltetes TrackBack eingegangen. Schalten Sie es frei, um es auf Ihrer Website erscheinen zu lassen.}, # Translate - New # OK
	q{An unapproved TrackBack has been posted on your blog '[_1]', on page #[_2] ([_3]). You need to approve this TrackBack before it will appear on your site.} => q{Zu Seite #[_2] ([_3]) Ihres Blogs '[_1]' ist ein noch nicht freigeschaltetes TrackBack eingegangen. Schalten Sie es frei, um es auf Ihrer Website erscheinen zu lassen.}, # Translate - New # OK
...
## default_templates/recover-password.mtml
	'A request was made to change your Movable Type password. To complete this process click on the link below to select a new password.' => 'Um das Passwort Ihres Movable-Type-Benutzerkontos zu ändern, klicken Sie bitte auf folgenden Link.', # Translate - New # OK
...
## default_templates/search_results.mtml
	...
	'By default, this search engine looks for all words in any order. To search for an exact phrase, enclose the phrase in quotation marks:' => 'Es wird nach allen Elementen des Suchbegriff in beliebiger Reihenfolge gesucht. Um nach einem Begriff genau so wie er ist zu suchen, schreiben Sie ihn in Anführungszeichen.', # Translate - New # OK
...
## default_templates/verify-subscribe.mtml
	'Thank you for subscribing to notifications about updates to [_1]. Follow the link below to confirm your subscription:' => 'Danke, daß Sie Benachrichtigungen zu [_1] erhalten möchten. Zur Bestätigung klicken Sie bitte auf folgenden Link:', # Translate - New # OK
...
## lib/MT/App/Comments.pm
	...
	'Invalid login' => 'Login ungültig',
	'Successfully authenticated, but signing up is not allowed.  Please contact your Movable Type system administrator.' => 'Sie haben sich erfolgreich authentifiziert, dürfen sich aber nicht anmelden. Bitte wenden Sie sich an Ihren Movable-Type-Administrator.', # Translate - New # OK
	...
	'Your confirmation has expired. Please register again.' => 'Ihre Bestätigung ist nicht mehr gültig. Bitte registrieren Sie sich erneut.', # Translate - New # OK
	...
	'You are trying to redirect to external resources. If you trust the site, please click the link: [_1]' => 'Weiterleitung auf eine externe Site. Wenn Sie dieser Site vertrauen, klicken Sie bitte auf diesen Link: [_1]', # Translate - New # OK
	...
	'All required fields must be populated.' => 'Alle erforderlichen Felder müssen ausgefüllt sein.', # Translate - New # OK
...
## lib/MT/App.pm
	'Problem with this request: corrupt character data for character set [_1]' => 'Es ist ein Fehler aufgetreten: ungültige Zeichen für Zeichensatz [_1]', # Translate - New # OK
	...
	'This account has been deleted. Please see your Movable Type system administrator for access.' => 'Dieses Benutzerkonto wurde gelöscht. Bitte wenden Sie sich an Ihren Movable-Type-Administrator.', # Translate - New # OK
	...
	'An error occurred while trying to process signup: [_1]' => 'Bei der Bearbeitung Ihrer Anmeldung ist ein Fehler aufgetreten: [_1]', # Translate - New # OK
	'New Comment Added to \'[_1]\'' => 'Neuer Kommentar zu &#8222;[_1]&#8220; eingegangen',
	'Close' => 'Schließen',
	'Failed to open pid file [_1]: [_2]' => 'Konnte PID-Datei [_1] nicht öffnen: [_2]', # Translate - New # OK
	'Failed to send reboot signal: [_1]' => 'Konnte Reboot-Signal nicht senden: [_1]', # Translate - New # OK
...
## lib/MT/App/Search/Legacy.pm
	'A search is in progress. Please wait until it is completed and try again.' => 'Es läuft bereits eine Suche. Bitte versuchen Sie es danach erneut.', # Translate - New # OK
	...
	'No alternate template is specified for the template \'[_1]\'' => 'Für Vorlage \'[_1]\' ist keine Alternative angegeben.', # Translate - New # OK
	'Opening local file \'[_1]\' failed, [_2]' => 'Konnte lokale Datei \'[_1]\' nicht öffnen: [_2]', # Translate - New # OK
...
## lib/MT/App/Search.pm
	'Cannot load blog #[_1].' => 'Konnte Blog #[_1] nicht laden.', # Translate - New # OK
	'Invalid type: [_1]' => 'Ungültiger Typ: [_1]',
	'Failed to cache search results.  [_1] is not available: [_2]' => 'Konnte Suchergebnisse nicht zwischenspeichern. [_1] nicht verfügbar: [_2]', # Translate - New # OK
	...
	'No alternate template is specified for template \'[_1]\'' => 'Für Vorlage \'[_1]\' ist keine Alternative angegeben.', # Translate - New # OK
	'Opening local file \'[_1]\' failed: [_2]' => 'Konnte lokale Datei &#8222;[_1]&#8220; nicht öffnen: [_2]',
	'No such template' => 'Keine solche Vorlage',
	'template_id cannot refer to a global template' => 'template_id kann sich nicht auf eine globale Vorlage beziehen.', # Translate - New # OK
	'Output file cannot be of the type asp or php' => 'Die Ausgabedatei kann nicht im Format ASP oder PHP sein. ', # Translate - New # OK
	...
	'Template must be an entry_listing for non-Index archive types' => 'Verwenden Sie für Nicht-Index-Archivseiten eine entry_listing-Vorlage.', # Translate - New # OK
	'Filename extension cannot be asp or php for these archives' => 'Bei diesem Archivtyp kann die Dateierweiterung nicht ASP oder PHP lauten.', # Translate - New # OK
	'Template must be a main_index for Index archive type' => 'Verwenden Sie für Index-Archivseiten eine main_index-Vorlage.', # Translate - New # OK
...
## lib/MT/App/Trackback.pm
	...
	'TrackBack ID (tb_id) is required.' => 'TrackBack_ID (tb_id) erforderlich.', # Translate - New # OK
	...
	'You are sending TrackBack pings too quickly. Please try again later.' => 'Sie versenden TrackBacks-Pings zu schnell hintereinander. Bitte versuchen Sie es später erneut.', # Translate - New # OK
	'You need to provide a Source URL (url).' => 'Bitte geben Sie eine Quell-URL (url) an.', # Translate - New # OK
	...
	'Publishing failed. [_1]' => 'Veröffentlichung fehlgeschlagen: [_1]', # Translate - New # OK
	'Cannot create RSS feed \'[_1]\': ' => 'Kann RSS-Feed \'[_1]\' nicht anlegen: ', # Translate - New # OK
	'New TrackBack ping to \'[_1]\'' => 'Neuer TrackBack-Ping an \'[_1]\'', # Translate - New # OK
	'New TrackBack ping to category \'[_1]\'' => 'Neuer TrackBack-Ping an Kategorie \'[_1]\'', # Translate - New # OK

## lib/MT/App/Upgrader.pm
	'Could not authenticate using the credentials provided. [_1].' => 'Authentifizierung mit den angegeben Daten nicht möglich: [_1]', # Translate - New # OK
	...
	'The \'Website Root\' provided below is not allowed' => 'Das angegebene Wurzelverzeichnis der Website ist ungültig bzw. nicht zulässig.', # Translate - New # OK
	'The \'Website Root\' provided below is not writable by the web server.  Change the ownership or permissions on this directory, then click \'Finish Install\' again.' => 'Der Server kann das angegebene Wurzelverzeichnis der Website nicht beschreiben. Bitte ändern Sie die entsprechenden Zugriffs- und/oder Besitzer-Rechte  und klicken Sie dann erneut auf \'Installation abschließen\'.', # Translate - New # OK
	'Invalid session.' => 'Ungültige Session',
	'No permissions. Please contact your Movable Type administrator for assistance with upgrading Movable Type.' => 'Keine Berechtigung. Bitte wenden Sie sich zur Aktualisierung dieser Movable-Type-Installation an Ihren Administrator.', # Translate - New # OK
...
## lib/MT/App/Viewer.pm
	...
	'Template publishing failed. [_1]' => 'Veröffentlichung der Vorlage fehlgeschlagen: [_1]', # Translate - New # OK
	'Unknown archive type. [_1]' => 'Unbekannter Archiv-Typ', # Translate - New # OK
	'Cannot load template [_1]' => 'Konnte Vorlage [_1] nicht laden.', # Translate - New # OK
	...
	'Entry [_1] was not published.' => 'Eintrag [_1] nicht veröffentlicht.', # Translate - New # OK
	'Archive publishing failed. [_1]' => 'Veröffentlichung des Archivs fehlgeschlagen.', # Translate - New # OK
...
## lib/MT/App/Wizard.pm
	...
	'An error occurred while trying to connect to the database.  Check the settings and try again.' => 'Die Datenbankverbindung konnte nicht aufgebaut werden. Bitte überprüfen Sie die Einstellungen und versuchen Sie es erneut.', # Translate - New # OK
	'Please select a database from the list of available databases and try again.' => 'Bitte wählen Sie einen Datenbank-Typ aus der Liste der verfügbaren Typen und versuchen Sie es erneut.', # Translate - New # OK
	...
	'Digest::SHA is required in order to provide enhanced protection of user passwords.' => 'Digest::SHA ist für den verbesserten Schutz der verwendeten Passwörter erforderlich.', # Translate - New # OK
	'This module and its dependencies are required to run Movable Type under psgi.' => 'Dieses Modul und seine Abhängigkeiten sind zum Betrieb von Movable Type unter psgi erforderlich.', # Translate - New # OK
	'Net::SMTP is required in order to send mail using an SMTP server.' => 'Net::SMTP ist für den Versand von E-Mails über SMTP-Server erforderlich.', # Translate - New # OK
	'This module and its dependencies are required in order to support CRAM-MD5, DIGEST-MD5 or LOGIN SASL mechanisms.' => 'Dieses Modul und seine Abhängigkeiten sind zur Verwendung von CRAM-MD5, DIGEST-MD5 und LOGIN SASL erforderlich.', # Translate - New # OK
	'Net::SMTP::SSL is required to use SMTP Auth over an SSL connection.' => 'Net::SMTP::SSL ist zur Verwendung von SMTP Auth über SSL erforderlich.', # Translate - New # OK
	'Net::SMTP::TLS is required to use SMTP Auth with STARTTLS command.' => 'Net::SMTP::TSL ist zur Verwendung von SMTP Auth mit STARTSSL erforderlich.', # Translate - New # OK
	'IO::Socket::SSL is required to use SMTP Auth over an SSL connection, or to use it with a STARTTLS command.' => 'IO::Socket::SSL ist zur Verwendung von SMTP Auth über SSL oder mit STARTSSL erforderlich.', # Translate - New # OK
	'Net::SSLeay is required to use SMTP Auth over an SSL connection, or to use it with a STARTTLS command.' => 'Net::SSLeay ist zur Verwendung von SMTP Auth über SSL oder mit STARTSSL erforderlich.', # Translate - New # OK
	...
	'This module is needed to enable comment registration. Also, required in order to send mail via an SMTP Server.' => 'Dieses Modul ist zur Registrierung von Kommentarautoren und zum Versenden von Mails über SMTP-Server erforderlich.', # Translate - New # OK
	...
	'DBI is required to work with most supported databases.' => 'DBI ist für die meisten Datenbank-Typen erforderlich.', # Translate - New # OK
	'File::Spec is required to work with file system path information on all supported operating systems.' => 'File::Spec ist auf allen unterstützten Betriebssystem ', # Translate - New
	'LWP::UserAgent is required for creating Movable Type configuration files using the installation wizard.' => 'LWP::UserAgent ist zur Erzeugung von Movable Type-Konfigurationsdateien mit dem Konfigurationsassistenten erforderlich.', # Translate - New # OK
...
## lib/MT/Asset/Image.pm
	...
	'Cannot load image #[_1]' => 'Kann Bild #[_1] nicht laden', # Translate - New # OK
	...
	'Saving [_1] failed. [_2]' => 'Speichern von [_1] fehlgeschlagen: [_2]', # Translate - New # OK
	'Invalid basename \'[_1]\'' => 'Ungültiger Basisname &#8222;[_1]&#8220;',
	'Error writing to \'[_1]\'. [_2]' => 'Fehler beim Beschreiben von \'[_1]\': [_2] ', # Translate - New # OK
	'Popup page for [_1]' => 'Popup-Seite für [_1]', # Translate - Case # OK

## lib/MT/Asset.pm
	'Deleted' => 'Gelöscht',
	'Enabled' => 'Aktiviert',
	'Disabled' => 'Deaktiviert',
	'Could not remove asset file [_1] from the filesystem. [_2]' => 'Konnte Asset-Datei [_1] nicht aus Dateisystem löschen: [_2]', # Translate - New # OK
...
## lib/MT/AtomServer.pm
	...
	'The file ([_1]) you uploaded is not allowed.' => 'Die hochgeladene Datei ([_1]) ist nicht zulässig.', # Translate - New # OK
	'The file([_1]) you uploaded is not allowed.' => 'Die hochgeladene Datei ([_1]) ist nicht zulässig.',
	'Perl module Image::Size is required to determine the width and height of uploaded images.' => 'Zur Bestimmung der Höhe und Breite hochgeladener Bilder ist das Perl-Modul Image::Size erforderlich.', # Translate - New # OK

## lib/MT/Auth/MT.pm
	'Failed to verify the current password.' => 'Konnte das derzeitige Passwort nicht verifizieren.', # Translate - New # OK
	'Missing required module' => 'Ein erforderliches Modul fehlt', # Translate - New # OK

## lib/MT/Auth/OpenID.pm
	'Could not save the session' => 'Konnte Session nicht speichern.', # Translate - New # OK
	'Could not load Net::OpenID::Consumer.' => 'Konnte Net::OpenID::Consumer nicht laden.',
	'The address entered does not appear to be an OpenID endpoint.' => 'Die angebene Adresse ist kein OpenID-Endpunkt.', # Translate - New # OK
	'The text entered does not appear to be a valid web address.' => 'Der eingegebene Text ist keine gültige Webadresse.', # Translate - New # OK
	'Unable to connect to [_1]. [_2]' => 'Konnte keine Verbindung zu [_1] aufbauen: [_2]', # Translate - New # OK
	'Could not verify the OpenID provided. [_1]' => 'Die angegebene OpenID konnte nicht verifiziert werden.', # Translate - New # OK
...
## lib/MT/Author.pm
	...
	'The approval could not be committed.  [_1]' => 'Bestätigung konnte nicht übernommen werden: [_1]', # Translate - New # OK
...
## lib/MT/Auth/TypeKey.pm
	...
	'This weblog requires commenters to pass an email address. If you would like to do so you may log in again, and give the authentication service permission to pass your email address.' => 'Auf diesem Weblog müssen Kommentarautoren ihre E-Mail-Adresse angeben. Um das zu tun, melden Sie sich erneut an und erlauben Sie Ihrem Authentifizierungs-Dienst, Ihre E-Mail-Adresse zu übermitteln.', # Translate - New# OK
	'Could not get public key from the URL provided.' => 'Konnte keinen öffentlichen Schlüssel von der angegebenen Adresse beziehen.', # Translate - New # OK
	'Couldn\'t get public key from url provided' => 'Konnte keinen öffentlichen Schlüssel von der angegebenen Adresse beziehen.',
	'No public key could be found to validate registration.' => 'Kein Public Key zur Validierung gefunden.',
	'TypePad signature verification returned [_1] in [_2] seconds verifying [_3] with [_4]' => 'TypePad-Signaturbestätigung ergab nach [_2] Sekunden [_1], [_3] mit  [_4] geprüft.', # Translate - New# OK
	'The TypePad signature is out of date ([_1] seconds old). Ensure that your server\'s clock is correct.' => 'Die TypePad-Signatur ist veraltet ([_1] Sekunden alt). Ist die Uhr Ihres Servers richtig gestellt?', # Translate - New # OK

## lib/MT/BackupRestore/BackupFileHandler.pm
	'The uploaded file was not a valid Movable Type backup manifest file.' => 'Die hochgeladene Datei ist keine gültige Manifest-Datei eines Movable-Type-Backups.', # Translate - New # OK
	'The uploaded backup manifest file was created with Movable Type, but the schema version ([_1]) differs from the one used by this system ([_2]).  You should not restore this backup to this version of Movable Type.' => 'Die hochgeladene Manifest-Datei wurde zwar mit Movable Type erstellt, bezieht sich aber auf eine andere Schema-Version ([_1]) als dieses System ([_2]). Sie sollten daher dieses Backup nicht in diese Movable Type-Installation einspielen.', # Translate - New # OK
	...
	'A user with the same name as the current user ([_1]) was found in the backup.  Skipping this user record.' => 'Benutzerkonto mit gleichem Benutzeramen wie aktueller Nutzer in Backup gefunden ([_1]). Eintrag übersprungen.', # Translate - New# OK
	'A user with the same name \'[_1]\' was found in the backup (ID:[_2]).  Restore replaced this user with the data from the backup.' => 'Benutzerkonto mit gleichem Benutzernamen \'[_1]\' mit ID [_2] in Backup gefunden und mit Daten aus Backup ersetzt.', # Translate - New # OK
...
## lib/MT/BackupRestore/BackupFileScanner.pm
	'Can not restore this file because doing so requires the Digest::SHA Perl language module. Please contact your Movable Type system administrator.' => 'Diese Datei konnte nicht eingespielt werden, da dazu das Digest::SHA-Perl-Modul erforderlich ist. Wenden Sie sich bitte an Ihren Movable-Type-Administrator.', # Translate - New # OK

## lib/MT/BackupRestore/ManifestFileHandler.pm

## lib/MT/BackupRestore.pm
	"\nCannot write file. Disk full." => "Laufwerk voll. Datei kann nicht geschrieben werden.", # Translate - New# OK
	...
	'Path was not found for the file, [_1].' => 'Verzeichnis für Datei nicht gefunden, [_1]', # Translate - New # OK
...
## lib/MT/CMS/AddressBook.pm
	'No entry ID was provided' => 'Keine Eintrags-ID angegeben.', # Translate - New# OK
	'No such entry \'[_1]\'' => 'Kein Eintrag &#8222;[_1]&#8220;',
	'No entry ID provided' => 'Keine Eintrags-ID angegeben',
	'No valid recipients were found for the entry notification.' => 'Keine gültigen Empfänger-Adressen für Benachrichtigung gefunden.', # Translate - New # OK
	'[_1] Update: [_2]' => '[_1] Update: [_2]',
	'Error sending mail ([_1]). Try another MailTransfer setting?' => 'Mailversand fehlgeschlagen ([_1]). Überprüfen Sie die MailTransfer-Einstellungen. ', # Translate - New # OK
	...
	'The text you entered is not a valid email address.' => 'Der eingegebene Text ist keine gültige E-Mail-Adresse.', # Translate - New # OK
	'The text you entered is not a valid URL.' => 'Der eingegebene Text ist keine gültige Web-Adresse (URL).', # Translate - New # OK
...
## lib/MT/CMS/Asset.pm
	...
	'Cannot load file #[_1].' => 'Konnte Datei #[_1] nicht laden.', # Translate - New # OK
	'No permissions' => 'Keine Berechtigung',
	...
	'Movable Type was unable to write to the "Upload Destination". Please make sure that the webserver can write to this folder.' => 'Movable Type konnte nicht in das angegebene Verzeichnis schreiben. Bitte stellen Sie sicher, daß der Server Schreibzugriff auf dieses Verzeichnis hat.', # Translate - New # OK
	...
	'File with name \'[_1]\' already exists. (Install the File::Temp Perl module if you\'d like to be able to overwrite existing uploaded files.)' => 'Eine Datei  \'[_1]\'  existiert bereits. Installieren Sie das Perl-Modul File::Temp, um vorhandene Dateien überschreiben zu können.', # Translate - New # OK
	'unassigned' => 'nicht vergeben',
	'File with name \'[_1]\' already exists; Tried to write to a tempfile, but the webserver couldn\'t open it: [_2]' => 'Eine Datei  \'[_1]\'  existiert bereits und der Webserver konnte die temporäre Datei nicht öffnen: [_2]', # Translate - New # OK
	'Could not create upload path \'[_1]\': [_2]' => 'Konnte Pfad &#8222;[_1]&#8220; nicht anlegen: [_2]',
	'The file([_1]) that you uploaded is not allowed.' => 'Die hochgeladene Datei ([_1]) ist nicht zulässig.', # Translate - New # OK
	...
	'Cannot overwrite an existing file with a file of a different type. Original: [_1] Uploaded: [_2]' => 'Vorhandene Dateien können nicht mit Dateien anderen Typs überschrieben werden. Vorhandene Datei: [_1], neue Datei: [_2]', # Translate - New# OK
	'<' => '<',
	'/' => '/',
...
## lib/MT/CMS/Blog.pm
	...
	'New Blog' => 'Neues Blog',
	'Cannot load template #[_1].' => 'Kann Vorlage #[_1] nicht laden.', # Translate - New # OK
	'Can\'t load template #[_1].' => 'Kann Vorlage #[_1] nicht laden.',
	...
	'Please choose a preferred archive type.' => 'Bitte geben Sie eine bevorzugte Archiv-Art an.', # Translate - New# OK
...
## lib/MT/CMS/Common.pm
	...
	'Website root must be under [_1]' => 'Das Wurzelverzeichnis der Website muss unter [_1] liegen.', # Translate - New# OK
...
## lib/MT/CMS/Plugin.pm
	'Error saving plugin settings: [_1]' => 'Konnte Plugin-Einstellungen nicht speichern: [_1]', # Translate - New# OK
...
## lib/MT/CMS/Theme.pm
	...
	'All Themes Directories are not writable.' => 'Sämtliche Themen-Verzeichnisse können nicht beschrieben werden.', # Translate - New# OK
...
## lib/MT/CMS/Tools.pm
	...
	'Mail was not properly sent: [_1]' => 'Versand der Testmail fehlgeschlagen: [_1]', # Translate - New # OK
	...
	'Invalid SitePath: Should be valid and absolute' => 'SitePath ungültig. Die Pfadangabe muss sowohl absolut als auch gültig sein.', # Translate - New# OK
	'[_1] is [_2]' => '[_1] ist [_2]',
	'none' => 'Kein(e)',
...
## lib/MT/CMS/User.pm
	...
	'Minimum password length must be integer and greater than zero.' => 'Die Mindest-Passwortlänge muss eine ganze Zahl größer null sein.',
	...
	'[_1]\'s Assciations' => 'Verknüpfungen von [_1]',
...
## lib/MT/ListProperty.pm
	'Can\'t initialize list property [_1].[_2].' => 'Konnte Listeneigenschaft [_1] nicht initialisieren.[_2].',
...
## lib/MT/Mail.pm
	...
	'Username and password is required for SMTP Authentication.' => 'Zur SMTP-Authentifizierung sind Benutzername und Passwort erforderlich.', # Translate - New # OK
	'Error connecting to SMTP server [_1]:[_2]' => 'Zum SMTP-Server [_1] konnte keine Verbindung aufgebaut werden: [_2]', # Translate - New # OK
	'Authentication failure: [_1]' => 'Fehler bei der Authentifizierung: [_1]', # Translate - New # OK
	...
	'Following required module(s) were not found: ([_1])' => 'Diese erforderlichen Module fehlen: ([_1])', # Translate - New # OK
...
## lib/MT.pm
	...
	'http://www.movabletype.com/' => 'http://www.movabletype.com/', # Translate - New # OK
	'Hello, world' => 'Hallo Welt',
	'Hello, [_1]' => 'Hallo, [_1]',
	'Message: [_1]' => 'Nachricht: [_1]',
	'If it is present, the third argument to add_callback must be an object of type MT::Component or MT::Plugin' => 'Falls vorhanden, muss das dritte Argument von add_callback ein MT::Component- oder MT::Plugin-Objekt sein.', # Translate - New # OK
	'Fourth argument to add_callback must be a CODE reference.' => 'Das vierte Argument von add_callback muss eine CODE-Referenz sein.', # Translate - New # OK
	...
	'Error while creating email: [_1]' => 'Fehler beim Anlegen einer E-Mail: [_1]', # Translate - New # OK
...
## lib/MT/Template/ContextHandlers.pm
	...
	'File include is disabled by "AllowFileInclude" config directive.' => 'Das Einbinden von Dateien wurde über das Konfigurationsparameter AllowFileInclude deaktiviert.', # Translate - New # OK
...
## lib/MT/Template/Tags/Calendar.pm
	'Invalid weeks_start_with format: must be Sun|Mon|Tue|Wed|Thu|Fri|Sat' => 'week_starts_with in ungültigem Format angegeben. Verwenden Sie einen dieser Ausdrücke: Mon|Tue|Wed|Thu|Fri|Sat|Sun', # Translate - New # OK
...
## lib/MT/Theme/TemplateSet.pm
	'A template set containing [quant,_1,template,templates], [quant,_2,widget,widgets], and [quant,_3,widget set,widget sets].' => 'Vorlagengruppe mit [quant,_1,Vorlage,Vorlagen], [quant,_2,Widget,Widgets] und [quant,_3,Widget-Gruppe, Widget-Gruppen].', # Translate - New# OK
...
## lib/MT/Upgrade/v5.pm
	...
	'Migrating existing [quant,_1,blog,blogs] into websites and their children...' => 'Migriere vorhandene [quant,_1,Blog,Blogs] in Websites und Kinder...', # Translate - New # OK
...
## mt-static/addons/Cloud.pack/js/cfg_config_directives.js
	'Configuration directive is required.' => 'Konfigurationsanweisung erforderlich', # Translate - New# OK
	'[_1] is not updatable.' => '[_1] kann nicht aktualisiert werden.', # Translate - New# OK
	'Although [_1] is updatable by CMS is not updatable in this screen.' => '[_1] kann zwar vom System aktualisiert werden, aber nicht an dieser Stelle.', # Translate - New# OK
	'[_1] already exists.' => '[_1] ist bereits vorhanden.', # Translate - New# OK
	'Configuration value is required.' => 'Konfigurationswert benötigt.', # Translate - New # OK
	'The HASH type config directive should be in the format of "key=value"' => 'Geben Sie HASH-Konfigurationsanweisungen im Format "Schlüssel=Wert" an.', # Translate - New# OK
	'[_1] for [_2] is already exists.' => '[_1] ist für [_2] bereits vorhanden.', # Translate - New# OK
	...
	'configuration directive' => 'Konfigurationsanweisung', # Translate - New # OK
...
## mt-static/jquery/jquery.mt.js
	...
	'You have an error in your input.' => 'Eine Eingabe ist fehlerhaft.', # Translate - New # OK
...
## mt-static/plugins/TinyMCE/tiny_mce/plugins/mt_fullscreen/langs/plugin.js
	'Fullscreen' => 'Fullscreen', # Translate - New # OK

## mt-static/plugins/TinyMCE/tiny_mce/plugins/mt/langs/advanced.js
	'Bold (Ctrl+B)' => 'Fett (Strg+B)', # Translate - New # OK
	'Italic (Ctrl+I)' => 'Kursiv (Strg+I)', # Translate - New # OK
	'Underline (Ctrl+U)' => 'Unterstrichen (Strg+U)', # Translate - New # OK
	'Strikethrough' => 'Durchstreichen',
	'Block Quotation' => 'Zitat', # Translate - New # OK
	'Unordered List' => 'Unsortierte Liste', # Translate - New # OK
	'Ordered List' => 'Sortierte Liste', # Translate - New # OK
	'Horizontal Line' => 'Trennlinie', # Translate - New # OK
	'Insert/Edit Link' => 'Link einfügen/bearbeiten', # Translate - New # OK
	'Unlink' => 'Link entfernen', # Translate - New # OK
	'Undo (Ctrl+Z)' => 'Rückgängig (Strg+Z)', # Translate - New # OK
	'Redo (Ctrl+Y)' => 'Wiederholen (Strg+Y)', # Translate - New # OK
	'Select Text Color' => 'Schriftfarbe wählen', # Translate - New # OK
	'Select Background Color' => 'Hintergrundfarbe wählen', # Translate - New # OK
	'Remove Formatting' => 'Formatierung entfernen', # Translate - New # OK
	'Align Left' => 'Linsbündig', # Translate - New # OK
	'Align Center' => 'Zentriert', # Translate - New # OK
	'Align Right' => 'Rechtsbündig', # Translate - New # OK
	'Indent' => 'Einrücken', # Translate - New # OK
	'Outdent' => 'Ausrücken', # Translate - New # OK

## mt-static/plugins/TinyMCE/tiny_mce/plugins/mt/langs/insert_html.js
	'Insert HTML' => 'HTML einfügen', # Translate - New # OK
	'Source' => 'Quelle', # Translate - New # OK

## mt-static/plugins/TinyMCE/tiny_mce/plugins/mt/langs/plugin.js
	'Insert Link' => 'Link einfügen', # Translate - New # OK
	'Insert Image Asset' => 'Bild aus Assets einfügen', # Translate - New # OK
	'Insert Asset Link' => 'Link aus Assets einfügen', # Translate - New # OK
	'Toggle Fullscreen Mode' => 'Vollbildmodus aktivieren/deaktivieren', # Translate - New # OK
	'Toggle HTML Edit Mode' => 'HTML-Editor aktivieren/deaktivieren', # Translate - New # OK
	'Strong Emphasis' => 'Starke Betonung', # Translate - New # OK
	'Emphasis' => 'Betonung', # Translate - New # OK
	'List Item' => 'Listenelement', # Translate - New # OK

## mt-static/plugins/TinyMCE/tiny_mce/plugins/paste/editor_plugin.js
	'paste.plaintext_mode_sticky' => 'paste.plaintext_mode_sticky', # Translate - New # OK
	'paste.plaintext_mode' => 'paste.plaintext_mode', # Translate - New # OK
...
## mt-static/plugins/TinyMCE/tiny_mce/themes/advanced/editor_template.js
	'advanced.path' => 'advanced.path', # Translate - New # OK
...
## mt-static/plugins/TinyMCE/tiny_mce/themes/advanced/js/charmap.js
	'advanced_dlg.charmap_usage' => 'advanced_dlg.charmap_usage', # Translate - New # OK

## mt-static/plugins/TinyMCE/tiny_mce/utils/editable_selects.js
	'value' => 'Wert', # Translate - Case # OK
...
## tmpl/cms/cfg_entry.tmpl
	...
	'WYSIWYG Editor Setting' => 'Einstellungen des grafischen Editors', # Translate - New # OK
	'Content CSS' => 'CSS für Inhalte', # Translate - New # OK
	'Content CSS will be applied when WYSIWYG editor does support. You can specify CSS file by URL or {{theme_static}} placeholder. Example: {{theme_static}}path/to/cssfile.css' => 'Sie können eigenes CSS für Inhalte nutzen, sofern der verwendete grafische Editor diese Funktion unterstützt. Referenzieren Sie Ihre CSS-Datei über ihre URL oder mit {{theme_static}}. Beispiel: {{theme_static}}pfad/zur/css-datei.css', # Translate - New # OK
...
## tmpl/cms/cfg_prefs.tmpl
	...
	'Choose archive type' => 'Archivtyp wählen', # Translate - New # OK
...
## tmpl/cms/cfg_system_general.tmpl
	...
	'A test mail was sent.' => 'Testmail verschickt.', # Translate - New # OK
	'(None selected)' => '(Kein Blog gewählt)',
	'System Email Address' => 'System-E-Mail-Adresse', # Translate - New # OK
	'Send Test Mail' => 'Testmail verschicken', # Translate - New # OK
	q{This email address is used in the 'From:' header of each email sent by Movable Type.  Email may be sent for password recovery, commenter registration, comment and trackback notification, user or IP address lockout, and a few other minor events.} => q{Movable Type verwendet diese Adresse als Absenderadresse für vom System verschickte Mails, beispielsweise bei Passwort-Anforderungen, Kommentar-Benachrichtigungen usw.}, # Translate - New # OK
	...
	'Site Path Limitation' => 'Site Path-Begrenzung', # Translate - New # OK
	'Base Site Path' => 'Basis-Site Path', # Translate - New # OK
	'Allow sites to be placed only under this directory' => 'Sites nur unterhalb dieses Verzeichnisses zulassen', # Translate - New # OK
	...
	'Send Mail To' => 'Mail senden an', # Translate - New # OK
	...
	'Send' => 'Absenden',
	'You must set a valid absolute Path.' => 'Bitte geben Sie einen gültigen absoluten Pfad an.', # Translate - New # OK
...
## tmpl/cms/dialog/adjust_sitepath.tmpl
	...
	'You must set a valid local site path.' => 'Bitte geben Sie ein gültiges lokales Verzeichnis an', # Translate - Case # OK
...
## tmpl/cms/dialog/select_association_type.tmpl
	'Grant website permission to user' => 'Berechtigung für Website zuweisen an Benutzer', # Translate - New # OK
	'Grant blog permission to user' => 'Berechtigung für Blog zuweisen an Benutzer', # Translate - New # OK
	'Grant website permission to group' => 'Berechtigung für Website zuweisen an Gruppe', # Translate - New # OK
	'Grant blog permission to group' => 'Berechtigung für Blog zuweisen an Gruppe', # Translate - New # OK
...
## tmpl/cms/edit_entry.tmpl
	...
	'Converting to rich text may result in changes to your current document.' => 'Wandlung in Rich Text kann ihre bisherigen Formatierungen beeinträchtigen.', # Translate - New # OK
...
## tmpl/cms/include/revision_table.tmpl
	...
	'_REVISION_DATE_' => 'Datum', # Translate - New # OK
	'Note' => 'Hinweis',
...
## tmpl/cms/system_check.tmpl
	...
	'configured' => 'konfiguriert', # Translate - New # OK
	'disabled' => 'deaktiviert', # Translate - Case # OK
	'Memcache is [_1].' => 'Memcache ist [_1].',
	'available' => 'verfügbar', # Translate - New # OK
	'unavailable' => 'nicht verfügbar', # Translate - New # OK
...
## tmpl/wizard/optional.tmpl
	...
	'Send mail via:' => 'Mails versenden über:', # Translate - New # OK
	'Sendmail Path' => 'sendmail-Pfad', # Translate - Case # OK
	'The physical file path for your Sendmail binary.' => 'Pfad zu Sendmail', # Translate - Case # OK
	'Outbound Mail Server (SMTP)' => 'SMTP-Server',
	'Address of your SMTP Server.' => 'Adresse Ihres SMTP-Servers',
	'Port number for Outboud Mail Server' => 'Port-Nummer des Servers für ausgehende Mail', # Translate - New # OK
	'Port number of your SMTP Server.' => 'Port-Nummer Ihres SMTP-Servers', # Translate - New # OK
	'Use SMTP Auth' => 'SMTP Auth verwenden', # Translate - New # OK
	'SMTP Auth Username' => 'SMTP-Auth-Benutzername', # Translate - New # OK
	'Username for your SMTP Server.' => 'Benutzername Ihres SMTP-Servers', # Translate - New # OK
	'SMTP Auth Password' => 'SMTP-Auth-Passwort', # Translate - New # OK
	'Password for your SMTP Server.' => 'Passwort Ihres SMTP-Servers', # Translate - New # OK
	'SSL Connection' => 'SSL-Verbindung', # Translate - New # OK
	'Cannot use [_1].' => 'Kann [_1] nicht verwenden.', # Translate - New # OK
	'Not use SSL' => 'SSL nicht verwenden', # Translate - New # OK
	'Use SSL' => 'SSL verwenden', # Translate - New # OK
	'Use STARTTLS' => 'STARTTLS verwenden', # Translate - New # OK
	'Send Test Email' => 'Testmail verschicken',
	'Mail address to which test email should be sent' => 'Zieladresse der Testmail',
	'Skip' => 'Überspringen', # Translate - New # OK
	'You must set SMTP server port number.' => 'Bitte geben Sie die Port-Nummer Ihres SMTP-Servers an.', # Translate - New # OK
	'This field must be integer.' => 'Bitte geben Sie eine ganze Zahl ein.', # Translate - New # OK
	'You must set system email address.' => 'Bitte geben Sie die System-E-Mail-Adresse an.', # Translate - New # OK
	'You must set Sendmail path.' => 'Bitte geben Sie Ihren Pfad zu Sendmail an.', # Translate - New # OK
	'You must set SMTP server address.' => 'Bitte geben Sie die Adresse Ihres SMTP-Servers an.', # Translate - New # OK
	'You must set username for SMTP server.' => 'Bitte geben Sie den Benutzernamen Ihres SMTP-Servers an.', # Translate - New # OK
	'You must set password for SMTP server.' => 'Bitte geben Sie das Passwort Ihres SMTP-Servers an.', # Translate - New # OK
...
',
	...
	'Converting CustomField type...' => 'Wandle  Arten der eigenen Felder...', # Translate - New # OK
...
## plugins/FacebookCommenters/lib/FacebookCommenters/Auth.pm
	...
	'Authentication failure: [_1], reason:[_2]' => 'Authentifizierung fehlgeschlagen: [_1]. Grund: [_2]', # Translate - New # OK
	'Failed to created commenter.' => 'Konnte Kommentarautoren nicht anlegen.', # Translate - New # OK
	'Failed to create a session.' => 'Konnte Session nicht anlegen.', # Translate - New # OK
	'Could not verify this app with Facebook.' => 'Konnte diese App nicht bei Facebook verifizieren.', # Translate - New # OK
...
## plugins/StyleCatcher/lib/StyleCatcher/Library/Local.pm
	'Failed to load StyleCatcher Library: [_1]' => 'Konnte StyleCatcher-Bibliothek nicht laden: [_1]', # Translate - New # OK
...
## plugins/TinyMCE/config.yaml
	'Default WYSIWYG editor.' => 'Standard für grafischen Editor', # Translate - New # OK
	'TinyMCE' => 'TinyMCE', # Translate - New # OK
