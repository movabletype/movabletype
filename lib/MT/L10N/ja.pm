...
%Lexicon = (
    ...
    'You can configure the publishing model for this blog (static vs dynamic) on the <a href="<TMPL_VAR NAME=SCRIPT_URL>?__mode=cfg_archives&amp;blog_id=<TMPL_VAR NAME=BLOG_ID>#publ_prefs">Detailed Settings</a> page.' => '公開方法（スタティックまたはダイナミック）を設定する場合は、<a href="<TMPL_VAR NAME=SCRIPT_URL>?__mode=cfg_archives&amp;blog_id=<TMPL_VAR NAME=BLOG_ID>#publ_prefs">詳細設定ページ</a>に進んでください。',
