...
## mt-check.cgi
	...
	'Image::Info is required for file uploads (to determine the size of uploaded images in many different formats).' => 'Image::Infoはファイルのアップロードを行うために必要です。各種のファイル形式に対応して画像のサイズを取得します。',
...
## lib/MT/AtomServer.pm
	...
	'Perl module Image::Info is required to determine the width and height of uploaded images.' => 'Image::Infoをインストールしないと、画像の幅と高さを検出できません。',
...
## lib/MT/CMS/Asset.pm
	...
	'Cannot load asset #[_1].' => 'アイテム(ID:[_1])をロードできませんでした。',
...
## lib/MT/CMS/Tools.pm
	...
	'Error occurred during restore process.' => '復元中にエラーが発生しました。',
...
## lib/MT/XMLRPCServer.pm
	...
	'Perl module Image::Info is required to determine width and height of uploaded images.' => 'Image::Infoをインストールしないと、画像の幅と高さを検出できません。',
...
## tmpl/cms/dialog/asset_edit.tmpl
	...
	'You have unsaved changes to this asset that will be lost. Are you sure you want to edit image?' => '保存されていないアイテムへの変更は失われます。画像を編集しますか？',
	'You have unsaved changes to this asset that will be lost. Are you sure you want to close this dialog?' => '保存されていないアイテムへの変更は失われます。編集を終了しますか？',
