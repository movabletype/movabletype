...
## lib/MT/CMS/Tools.pm
	...
	'Cannot send signal to [_1].' => '[_1]にシグナルを送れません。',
...
## tmpl/cms/reboot.tmpl
	'Extra PID files' => '外部のPIDファイル',
	'One file per line.' => '1行に1ファイル',
	'Reboot (e)' => '再起動(e)',
	'Send HUP to MT and related applications to reboot.' => 'MT と関連アプリケーションに HUP を送信して再起動します。',
