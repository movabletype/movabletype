...
## addons/Enterprise.pack/app-wizard.yaml
	'This module is required in order to use the LDAP Authentication.' => 'LDAP認証を利用する場合に必要です。', # Translate - New
...
## addons/Enterprise.pack/tmpl/list_group.tmpl
	...
	'group' => 'グループ',
	'groups' => 'グループ',
	'Enable selected [_1] (e)' => '選択された[_1]を有効にする (e)',
	'Disable selected [_1] (d)' => '選択された[_1]を無効にする (d)',
	'Remove selected [_1] (d)' => '選択された[_1]を削除する (d)',
...
## addons/Enterprise.pack/tmpl/author_bulk.tmpl
	...
	'_USAGE_AUTHORS_2' => 'ユーザーの情報を一括で編集できます。CSV形式のコマンド・ファイルをアップロードしてください。',
...
## addons/Enterprise.pack/tmpl/list_group_member.tmpl
	...
	'member' => 'メンバー',
	'Show Enabled Members' => '有効なメンバーを表示',
	...
	'None.' => '(なし)',
	'(Showing all users.)' => '(すべて表示)',
	'Showing only users whose [_1] is [_2].' => '[_1]が[_2]のユーザーを表示',
	'Show' => '表示: ',
	'all' => 'すべての',
	'only' => '該当する',
...
## addons/Enterprise.pack/config.yaml
	...
	'Oracle Database' => 'Oracleデータベース', # Translate - New
	'Microsoft SQL Server Database' => 'Microsoft SQL Serverデータベース', # Translate - New
	'Microsoft SQL Server Database (UTF-8 support)' => 'Microsoft SQL Serverデータベース(UTF-8サポート)', # Translate - New
	'External Directory Synchronization' => '外部ディレクトリと同期', # Translate - New
	'Populating author\'s external ID to have lower case user name...' => '小文字のユーザー名を外部IDとして格納しています...', # Translate - New

## addons/Enterprise.pack/app-cms.yaml
	'Group' => 'グループ',
	'Bulk Author Export' => 'ユーザーの一括出力', # Translate - New
	'Synchronize Users' => 'ユーザーの同期', # Translate - New
...
## addons/Enterprise.pack/lib/MT/Enterprise/BulkCreation.pm
	...
	'Invalid password recovery phrase: [_1]' => 'パスワード再設定用のフレーズに誤りがあります。',
...
## addons/Enterprise.pack/lib/MT/Auth/LDAP.pm
	...
	"Failed login attempt by user \'[_1]\'. A user with that\nusername already exists in the system with a different UUID." => "[_1]がログインできませんでした。\n同名のユーザーが別の外部IDですでに存在します。", # Translate - New
	...
	"Filter used to search for groups: [_1]\nSearch base: [_2]" => "検索フィルタ: [_1]\n検索ベース: [_2]", # Translate - New
	'(none)' => '(なし)',
	'The following groups were deleted:' => '以下のグループが削除されました。',
	'Failed to create a new group: [_1]' => '新しいグループを作成できませんでした: [_1]',
	'[_1] directive must be set to synchronize members of LDAP groups to Movable Type Enterprise.' => 'Movable Type EnterpriseでLDAPグループのメンバーを同期するには、[_1]を設定する必要があります。',
