...
%Lexicon = (
    ...
    'Main Menu' => 'メイン・メニュー',
    'Main' => 'メイン',
    "Make sure that you remove the files that you imported from the 'import' folder, so that if/when you run the import process again, those files will not be re-imported." => '次に読み込みを行ったときに同じファイルが再度読み込まれることのないように、ファイルをimportフォルダから削除してください。',
