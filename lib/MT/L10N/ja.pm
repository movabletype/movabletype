...
## addons/Community.pack/lib/MT/App/Community.pm
	...
	q{New entry '[_1]' added to the blog '[_2]'} => q{ブログ「[_2]」に新しい記事「[_1]」が投稿されました。},
	q{User '[_1]' (ID:[_2]) has been successfully registered.} => q{ユーザー「[_1]」(ID: [_2])が登録されました。},
...
## addons/Community.pack/lib/MT/Community/Tags.pm
	...
	q{You used an '[_1]' tag outside of the block of MTIfEntryRecommended; perhaps you mistakenly placed it outside of an 'MTIfEntryRecommended' container?} => q{[_1]をコンテキスト外で利用しようとしています。MTIfEntryRecommendedコンテナタグの外部で使っていませんか?},
...
## addons/Enterprise.pack/config.yaml
	...
	q{Populating author's external ID to have lower case user name...} => q{小文字のユーザー名を外部IDに設定しています...},
...
## addons/Enterprise.pack/lib/MT/Auth/LDAP.pm
	...
	q{Cannot get group '[_1]' (#[_2]) entry and its all member attributes from external directory.} => q{外部ディレクトリから、グループ '[_1]' (#[_2]) の情報を取得できません。},
	q{Cannot get member entries of group '[_1]' (#[_2]) from external directory.} => q{外部ディレクトリから、グループ '[_1]' (#[_2])のメンバー情報を取得できません。},
	q{Failed login attempt by user '[_1]' who was deleted from LDAP.} => q{LDAPから削除されたユーザー [_1] がサインインしようとしました。},
	q{Failed login attempt by user '[_1]'. A user with that username already exists in the system with a different UUID.} => q{[_1]がサインインできませんでした。同名のユーザーが別の外部IDですでに存在します。},
	q{Memberships in the group '[_2]' (#[_3]) were changed as a result of synchronizing with the external directory.} => q{外部ディレクトリとの同期の結果グループ「[_2]」(ID: [_3])を更新しました。},
	q{The filter used to search for groups was: '[_1]'. Search base was: '[_2]'} => q{検索フィルタ: '[_1]' 検索ベース: '[_2]'},
	q{User '[_1]' account is disabled.} => q{ユーザー「[_1]」を無効化しました。},
	q{User '[_1]' cannot be updated.} => q{ユーザー「[_1]」を更新できませんでした。},
	q{User '[_1]' updated with LDAP login ID.} => q{ユーザー「[_1]」をLDAPのログインIDで更新しました。},
	q{User '[_1]' updated with LDAP login name '[_2]'.} => q{ユーザー「[_1]」のユーザー名をLDAP名「[_2]」に変更しました。},
...
## addons/Enterprise.pack/lib/MT/Enterprise/BulkCreation.pm
	...
	q{'Personal Blog Location' setting is required to create new user blogs.} => q{ユーザーのブログを作成する場合は、'個人用ブログの場所'を設定してください。},
	q{A theme '[_1]' was not found.} => q{'[_1]'というテーマが見つかりません。},
	q{Blog '[_1]' for user '[_2]' has been created.} => q{ユーザー[_2]のブログ「[_1]」を作成しました。},
	q{Blog for user '[_1]' can not be created.} => q{ブログ「[_1]」へユーザーを登録できませんでした。},
	q{Error assigning weblog administration rights to user '[_1] (ID: [_2])' for weblog '[_3] (ID: [_4])'. No suitable weblog administrator role was found.} => q{ユーザー「[_1]」(ID:[_2])にブログ「[_3]」(ID:[_4])への権限を付与できませんでした。利用できるブログの管理者ロールが見つかりませんでした。},
...
## addons/Sync.pack/lib/MT/FileSynchronizer/FTPBase.pm
	...
	q{Failed to update sync list. (ID:'[_1]')} => q{同期リスト (ID:[_1]) の更新に失敗しました。},
...
## lib/MT/App.pm
	...
	q{Blog '[_1]' (ID: [_2]) for user '[_3]' (ID: [_4]) has been created.} => q{'[_3]'(ID:[_4])のブログ'[_1]'(ID:[_2])を作成しました。},
	q{Error assigning blog administration rights to user '[_1]' (ID: [_2]) for blog '[_3]' (ID: [_4]). No suitable blog administrator role was found.} => q{'[_1]'(ID:[_2])をブログ'[_3]'(ID:[_4])の管理者にできませんでした。ブログの管理権限を持つロールが見つかりませんでした。},
	q{Error provisioning blog for new user '[_1]' (ID: [_2]).} => q{新規ユーザー'[_1]'用のブログを作成できませんでした。},
	q{Error provisioning blog for new user '[_1]' using template blog #[_2].} => q{新規ユーザー'[_1]'用のブログを複製元のブログ(ID:[_2])から作成できませんでした。},
...
## lib/MT/App/CMS.pm
	...
	'_WARNING_DELETE_USER' => 'ユーザーの削除操作は取り消せず、削除したユーザーは復元できません。また、このユーザーが作成した記事やウェブページは作成者不明となります。このユーザーを利用しなくなったり、システムへのアクセスを禁止したい場合は、ユーザーのアカウントを無効にすることをおすすめします。選択したユーザーを削除してよろしいですか?',
	'_WARNING_DELETE_USER_EUM' => 'ユーザーの削除操作は取り消せず、削除したユーザーは復元できません。また、このユーザーが作成した記事やウェブページは作成者不明となります。このユーザーを利用しなくなったり、システムへのアクセスを禁止したい場合は。ユーザーのアカウントを無効にすることをおすすめします。LDAPディレクトリ上に選択したユーザーが残っている場合はアカウントを再作成できますが、削除前の記事などとユーザーを紐づけることはできません。選択したユーザーを削除してよろしいですか?',
...
## lib/MT/App/Comments.pm
	...
	q{Invalid email address '[_1]'} => q{メールアドレス([_1])は不正です。},
...
## lib/MT/App/Trackback.pm
 ...
 一度送信してください。',
	...
	q{Invalid entry ID '[_1]'} => q{記事のIDが不正です: [_1]},
...
## lib/MT/Auth/TypeKey.pm
	...
	'VALID' => '有効',
	q{The TypePad signature is out of date ([_1] seconds old). Ensure that your server's clock is correct.} => q{TypePadの署名が古すぎます([_1]秒経過)。サーバーの時刻が正しいことを確認してください。},
...
## lib/MT/BackupRestore/BackupFileHandler.pm
	...
	'[_1] records restored...' => '[_1]件復元されました...',
	q{A user with the same name '[_1]' was found in the backup (ID:[_2]).  Restore replaced this user with the data from the backup.} => q{'[_1]': 同名のユーザーが見つかりました(ID: [_2])。バックアップ時のユーザーデータを既存ユーザーのデータで置き換えて、他のデータを復元します。},
...
## lib/MT/CMS/Entry.pm
	...
	q{Invalid date '[_1]'; 'Published on' dates should be real dates.} => q{公開日: '[_1]'は不正な日付です。正しい日付を入力してください。},
	...
	q{Invalid date '[_1]'; 'Unpublished on' dates should be real dates.} => q{公開終了日: '[_1]'は不正な日付です。正しい日付を入力してください。},
	q{Invalid date '[_1]'; [_2] dates must be in the format YYYY-MM-DD HH:MM:SS.} => q{'[_1]'は不正な日付です。YYYY-MM-DD HH:MM:SSの形式で入力してください。},
	q{Invalid date '[_1]'; [_2] dates should be real dates.} => q{'[_1]'は不正な日付です。正しい日付を入力してください。},
...
## lib/MT/CMS/Tools.pm
	...
	q{Blog(s) (ID:[_1]) was/were successfully backed up by user '[_2]'} => q{'[_2]'がブログ(ID:[_1])をバックアップしました。},
	q{Changing Archive Path for the blog '[_1]' (ID:[_2])...} => q{'[_1]'(ID:[_2])のアーカイブパスを変更しています...},
	q{Changing Site Path for the blog '[_1]' (ID:[_2])...} => q{'[_1]'(ID:[_2])のサイトパスを変更しています...},
	q{Changing file path for the asset '[_1]' (ID:[_2])...} => q{アイテム'[_1]'(ID:[_2])のパスを変更しています...},
	q{Could not remove backup file [_1] from the filesystem: [_2]} => q{バックアップファイル('[_1]')をファイルシステムから削除できませんでした: [_2]},
	q{Manifest file '[_1]' is too large. Please use import direcotry for restore.} => q{バックアップファイル'[_1]'が大きすぎます。インポートディレクトリを利用して復元してください。},
	q{Movable Type system was successfully backed up by user '[_1]'} => q{'[_1]'がMovable Typeのシステムをバックアップしました。},
	q{Removing Archive Path for the blog '[_1]' (ID:[_2])...} => q{'[_1]'(ID:[_2])のアーカイブパスを消去しています...},
	q{Removing Site Path for the blog '[_1]' (ID:[_2])...} => q{'[_1]'(ID:[_2])のサイトパスを消去しています...},
	q{Successfully restored objects to Movable Type system by user '[_1]'} => q{'[_1]'がMovable Typeシステムを復元しました。},
...
## lib/MT/CMS/TrackBack.pm
	...
	'category' => 'カテゴリ',
	q{Ping (ID:[_1]) from '[_2]' deleted by '[_3]' from category '[_4]'} => q{'[_3]'が'[_2]'のトラックバック(ID:[_1])をカテゴリ'[
_4]'から削除しました。},
...
## plugins/StyleCatcher/lib/StyleCatcher/CMS.pm
	...
	q{Your mt-static directory could not be found. Please configure 'StaticFilePath' to continue.} => q{mt-staticディレクトリが見つかりませんでした。StaticFilePathを設定してください。},

## plugins/StyleCatcher/lib/StyleCatcher/Library/Default.pm
	'Invalid URL: [_1]' => 'URLが不正です: [_1]',
	q{Could not create [_1] folder - Check that your 'themes' folder is webserver-writable.} => q{[_1] フォルダが作成できません。'themes' フォルダが書き込み可能か確認してください。},
...
## plugins/WXRImporter/lib/WXRImporter/WXRHandler.pm
	...
	q{ and asset will be tagged ('[_1]')...} => q{アイテムにタグ([_1])を付けています...},
	q{Creating new tag ('[_1]')...} => q{タグ('[_1]')を作成しています...},
	q{Duplicate asset ('[_1]') found.  Skipping.} => q{アイテム「[_1]」は既にインポートされているのでスキップします。},
	q{Duplicate entry ('[_1]') found.  Skipping.} => q{記事「[_1]」は既にインポートされているのでスキップします。},
	q{Saving asset ('[_1]')...} => q{アイテム('[_1]')を保存しています...},
...
## tmpl/cms/list_common.tmpl
	...
	'act upon' => '対象に',
	q{Are you sure you want to remove the filter '[_1]'?} => q{フィルタ'[_1]'を削除してよろしいですか?},
...
## tmpl/cms/widget/blog_stats.tmpl
	...
	q{You have <a href='[_3]'>[quant,_1,comment,comments] from [_2]</a>} => q{[_2]日に<a href='[_3]'>[quant,_1,件,件]のコメント</a>があります。},
	q{You have <a href='[_3]'>[quant,_1,entry,entries] from [_2]</a>} => q{[_2]日に<a href='[_3]'>[quant,_1,件,件]の記事</a>を作成しています。},
