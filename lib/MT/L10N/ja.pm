...
## lib/MT/Template/Tags/System.pm
...
LDAPディレクトリ上にユーザーがまだ残っている場合、いつでも再作成されてしまいます。',
	...
	'Comments on my entries of [_1]' => '[_1]記事のコメント',
...
## lib/MT/Upgrade/v5.pm
	...
	'Can edit, manage and publish blog templates and themes.' => 'ブログテンプレートとテーマの更新、管理、および公開ができます。',
...
## lib/MT/Role.pm
	...
	'Contributor' => 'ライター',
	'Can create entries, edit their own entries, and comment.' => '記事の作成、各自の記事の編集とコメントの編集ができます。',
	'Moderator' => 'モデレータ',
...
## tmpl/wizard/complete.tmpl
	...
	'To change the settings, click the \'Back\' button below.' => '設定を変更するために、以下の\'戻る\'ボタンをクリックしてください。',
...
## tmpl/cms/edit_comment.tmpl
	...
	'No url in profile' => 'プロフィールにはURLを含まない',
	'Link' => 'リンク',
...
## tmpl/cms/cfg_registration.tmpl
	...
	'on the Web Services Settings page.' => 'ウェブサービス設定ページ',
...
## tmpl/cms/cfg_feedback.tmpl
	...
	'Accept TrackBacks from any source.' => '全トラックバック許可',
	'TrackBack Policy' => 'トラックバックポリシー',
	'Moderation' => '事前確認',
	'Hold all TrackBacks for approval before they are published.' => '公開前に許可を必要とするように、トラックバックを保留します。',
...
## tmpl/cms/cfg_plugin.tmpl
	...
	'Enable or disable plugin functionality for the entire Movable Type installation.' => 'システム全体での、プラグインの有効・無効を設定する。',
...
## tmpl/cms/cfg_system_general.tmpl
	...
	'Log Path' => 'ログパス',
	'The filesystem directory where performance logs are written.  The web server must have write permission in this directory.' => 'パフォーマンスログを書き出すフォルダ。ウェブサーバーから書き込み可能な場所を指定してください。',
	...
	'Disable receipt of TrackBacks for all blogs.' => 'トラックバックを無効にします。',
	...
	'Disable notification pings for all blogs.' => '全ブログでping通知を無効にします。',
	'Send Outbound TrackBacks to' => '外部トラックバック送信',
	'Do not send outbound TrackBacks or use TrackBack auto-discovery if your installation is intended to be private.' => 'プライベート設定の場合、外部トラックバックや、トラックバック・オートディスカバリーを送信しません。',
	'Any site' => '任意のサイト',
...
## tmpl/cms/edit_entry.tmpl
	...
	'Use <a href="http://blogit.typepad.com/">TypePad Bookmarklet</a> to post to Movable Type from social networks like Facebook.' => 'Facebookなどのソーシャルネットワークから投稿するには<a href="http://blogit.typepad.com/">TypePadブックマークレット</a>を使ってください。',
...
## tmpl/cms/cfg_system_users.tmpl
	...
	'Automatically create a new blog for each new user.' => '新しいユーザー用のブログを自動作成します。',
...
## tmpl/cms/cfg_prefs.tmpl
	'Error: Movable Type was not able to create a directory for publishing your blog. If you create this directory yourself, grant write permission to the web server.' => 'エラー: ブログ公開用のディレクトリを作成できません。自分でディレクトリが作成できる場合は、ウェブサーバーに書きこみ権限を与えてください。',
	'[_1] Settings' => '[_1]設定',
	...
	'Allow properly configured template modules to be cached to enhance publishing performance.' => '再構築の速度向上のために、テンプレートモジュール毎のキャッシュ設定を有効にします。',
...
## tmpl/cms/cfg_entry.tmpl
	...
	'Compose Defaults' => '記事作成既定値',
	'Specifies the default Post Status when creating a new entry.' => '新しい記事が作成された時の公開状態の既定値を指定します。',
...
## tmpl/cms/cfg_web_services.tmpl
	...
	'Web Services from Six Apart' => 'シックス・アパート提供ウェブサービス',
...
## tmpl/cms/widget/this_is_you.tmpl
	...
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>, <a href="[_3]">[quant,_4,page,pages]</a> with <a href="[_5]">[quant,_6,comment,comments]</a>.' => '記事<a href="[_1]">[quant,_2,件,件]</a>, ページ<a href="[_3]">[quant,_4,件,件]</a> コメント<a href="[_5]">[quant,_6,件,件]</a>あります。',
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>, <a href="[_3]">[quant,_4,page,pages]</a> with [quant,_5,comment,comments].' => '記事<a href="[_1]">[quant,_2,件,件]</a>, <a href="[_3]">[quant,_4,件,件]</a> コメント[quant,_5,件,件]あります。',
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>, [quant,_3,page,pages] with <a href="[_4]">[quant,_5,comment,comments]</a>.' => '記事<a href="[_1]">[quant,_2,件,件]</a>, ページ[quant,_3,件,件] コメント<a href="[_4]">[quant,_5,件,件]</a>あります。',
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>, [quant,_3,page,pages] with [quant,_4,comment,comments].' => '記事<a href="[_1]">[quant,_2,件,件]</a>, ページ[quant,_3,件,件] コメント[quant,_4,件,件]あります。',
	'You\'ve written [quant,_1,entry,entries], <a href="[_2]">[quant,_3,page,pages]</a> with <a href="[_4]">[quant,_5,comment,comments]</a>.' => '記事[quant,_1,件,件], ページ<a href="[_2]">[quant,_3,件,件]</a> コメント<a href="[_4]">[quant,_5,件,件]</a>あります。',
	'You\'ve written [quant,_1,entry,entries], <a href="[_2]">[quant,_3,page,pages]</a> with [quant,_4,comment,comments].' => '記事[quant,_1,件,件], ページ<a href="[_2]">[quant,_3,件,件]</a> コメント[quant,_4,件,件]あります。',
	'You\'ve written [quant,_1,entry,entries], [quant,_2,page,pages] with <a href="[_3]">[quant,_4,comment,comments]</a>.' => '記事[quant,_1,件,件], ページ[quant,_2,件,件] コメント<a href="[_3]">[quant,_4,件,件]</a>あります。',
	...
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>, <a href="[_3]">[quant,_4,page,pages]</a>.' => '記事<a href="[_1]">[quant,_2,件,件]</a>, ページ<a href="[_3]">[quant,_4,件,件]</a>あります。',
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>, [quant,_3,page,pages].' => '記事<a href="[_1]">[quant,_2,件,件]</a>, ページ[quant,_3,件,件]あります。',
	'You\'ve written [quant,_1,entry,entries], <a href="[_2]">[quant,_3,page,pages]</a>.' => '記事[quant,_1,entry,entries], ページ<a href="[_2]">[quant,_3,件,件]</a>あります。',
	'You\'ve written [quant,_1,entry,entries], [quant,_2,page,pages].' => '記事[quant,_1,entry,entries], [quant,_2,page,pages].',
	'You\'ve written <a href="[_1]">[quant,_2,page,pages]</a> with <a href="[_3]">[quant,_4,comment,comments]</a>.' => 'ページ<a href="[_1]">[quant,_2,件,件]</a> コメント<a href="[_3]">[quant,_4,件,件]</a>あります。',
	'You\'ve written <a href="[_1]">[quant,_2,page,pages]</a> with [quant,_3,comment,comments].' => 'ページ<a href="[_1]">[quant,_2,件,件]</a> コメント[quant,_3,件,件]あります。',
	'You\'ve written [quant,_1,page,pages] with <a href="[_2]">[quant,_3,comment,comments]</a>.' => 'ページ[quant,_1,件,件] コメント<a href="[_2]">[quant,_3,件,件]</a>あります。',
	'You\'ve written [quant,_1,page,pages] with [quant,_2,comment,comments].' => 'ページ[quant,_1,件,件] コメント[quant,_2,件,件]あります。',
...
## plugins/MultiBlog/multiblog.pl
	...
	'When this' => 'トリガー:',
	'* All blogs in this website' => '* ウェブサイトのすべてのブログ',
	'Select to apply this trigger to all blogs in this website.' => 'ウェブサイトのすべてのブログにトリガーを適用する場合に選択します。',
	'* All blogs in this system' => '* システムのすべてのブログ',
	'Select to apply this trigger to all blogs in this system' => 'システムのすべてのブログにトリガーを適用する場合に選択します。',
