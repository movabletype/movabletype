...
%Lexicon = (
    ...
    'An error occurred while testing for the new tag name.' => '新しいタグ名を検査しているときにエラーが発生しました。',
    ...
    'Assigning category parent fields...' => 'カテゴリに親フィールドを適用しています...',
    ...
    'Click on a [_1] to edit it. To perform any other action, check the checkbox of one or more [_2] and click the appropriate button or select a choice of actions from the dropdown to the right.' => '[_1]をクリックして編集できます。その他の操作を行うには[_2]のチェックボックスをオンにしてボタンをクリックするか、右側のドロップダウンからアクションを選択します。',
    ...
    'Click to edit tag name' => 'クリックしてタグ名を編集します。',
    'Close' => '閉じる',
    'Collapse' => '折りたたむ',
    'Comma' => 'カンマ',
    ...
    'Decrease' => '増やす',
    'Default Entry Editor Display Options' => 'エントリーエディターの初期設定',
    ...
    '_WARNING_PASSWORD_RESET_SINGLE' => "[_1]のパスワードを再設定しようとしています。パスワードはランダムに生成され、直接メールアドレス（[_2]）に送られます。\n\n実行しますか？",
