...
## lib/MT/CMS/Blog.pm
	...
	'No child site was selected to clone.' => '複製する子サイトが選択されていません。',
...
## lib/MT/Util/Dependencies.pm
	...
	'File::Temp is optional; It is needed if you would like to be able to overwrite existing files when you upload.' => 'File::Tempのインストールはファイルのアップロードを行う際に上書きを行う場合に必要となります。',
	...
	'LWP::Protocol::https is optional. It provides https support for LWP::UserAgent.' => 'LWP::Protocol::httpsがインストールされていればLWP::UserAgentのhttps対応に使われます。',
	'LWP::UserAgent is optional. It is used to fetch information from local and external servers.' => 'LWP::UserAgentがインストールされていればローカルおよび外部のサーバーから情報を取得するのに使われます。',
	'List::Util is required to manipulate a list of numbers.' => 'List::Utilは数値のリストを操作するのに必要です。',
	'MIME::Base64 is required to send mail and handle blobs during import/export operations.' => 'MIME::Base64はメールの送信やインポート・エクスポートでバイナリオブジェクトを扱うときに必要です。',
	...
	'This module is optional. It is used to manipulate files during import/export operations.' => 'このモジュールがインストールされていればインポート・エクスポート中のファイル操作に使われます。',
	'This module is optional. It is used to manipulate files via FTP(S).' => 'このモジュールがインストールされていればFTP(S)でファイルを操作するのに使われます。',
	'This module is optional. It is used to manipulate files via FTPS.' => 'このモジュールがインストールされていればFTPSでファイルを操作するのに使われます。',
	'This module is optional. It is used to manipulate files via SFTP.' => 'このモジュールがインストールされていればSFTPでファイルを操作するのに使われます。',
	'This module is optional. It is used to manipulate files via WebDAV.' => 'このモジュールがインストールされていればWebDAVでファイルを操作するのに使われます。',
	'This module is optional. It is used to manipulate log files.' => 'このモジュールがインストールされていればログファイルを操作するのに使われます。',
	'This module is optional. It is used to parse date in log files.' => 'このモジュールがインストールされていればログファイルの日時を解釈するのに使われます。',
...
## tmpl/admin2023/cms/cfg_plugin.tmpl
	...
	'If an installed plugin is not listed here, visit the [_1] menu to reboot MT manually.' => 'インストールしたプラグインが見つからない場合は[_1]メニューからMTを再起動してください。',
	'Info' => '詳細',
...
## tmpl/admin2023/cms/dialog/adjust_sitepath.tmpl
	...
	q{Enter the new path where your archives section index files will be published. An absolute path (starting with '/' for Linux or 'C:\' for Windows) is preferred. Do not end with '/' or '\'. Example: /home/mt/public_html or C:\www\public_html} => q{新しくアーカイブのインデックスファイルを公開するパスを入力して下さい。絶対パス(Linuxの時は'/'、Windowsの時は'C:\'などで始まる)を推奨します。末尾には'/'や'\'を含めません。例: /home/mt/public_html/blog ないし C:\www\public_html\blog},
	q{Enter the new path where your archives section index files will be published. Do not end with '/' or '\'.  Example: /home/mt/public_html/blog or C:\www\public_html\blog} => q{新しくアーカイブのインデックスファイルを公開するパスを入力して下さい。末尾には'/'や'\'を含めません。例: /home/mt/public_html/blog ないし C:\www\public_html\blog},
	q{Enter the new path where your main index file will be located. Do not end with '/' or '\'.  Example: /home/mt/public_html/blog or C:\www\public_html\blog} => q{新しくインデックスファイルを公開するパスを入力して下さい。末尾には'/'や'\'を含めません。例: /home/mt/public_html/blog ないし C:\www\public_html\blog},
...
## tmpl/admin2023/cms/list_theme.tmpl
	...
	'Failed' => '失敗',
	'Find Themes' => 'テーマを探す',
	'If an installed theme is not listed here, visit the [_1] menu to reboot MT manually.' => 'インストールしたテーマが見つからない場合は[_1]メニューからMTを再起動してください。',
...
## tmpl/admin2023/cms/reboot.tmpl
	'If problems linger, set the WaitAfterReboot environmental variable to wait for the backend server to restart.' => '再起動しても問題が続く場合はバックエンドサーバーの再起動待ち時間を指定するWaitAfterReboot環境変数を設定してください。',
	'PIDFilePath is required to reboot.' => '再起動にはPIDFilePathの設定が必要です。',
	'Reboot (r)' => '再起動(r)',
	'Send HUP to MT to reboot.' => 'MTにHUPシグナルを送信して再起動します。',
