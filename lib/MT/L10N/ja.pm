...
## lib/MT/App.pm
	...
	'User requires password recovery word/phrase.' => '秘密の合言葉は必須です。',
...
## lib/MT/CMS/Tools.pm
	...
	'User name or password hint is incorrect.' => 'ユーザー名または秘密の合言葉が不正です。',
	'User has not set pasword hint; cannot recover password' => '秘密の合言葉が設定されていないため、再設定できません。',
	'Invalid attempt to recover password (used hint \'[_1]\')' => 'パスワードの再設定に失敗しました(秘密の合言葉: [_1])。',
...
## lib/MT/Auth/MT.pm
	...
	'Password hint is required.' => '秘密の合言葉を入力してください。',
...
## tmpl/comment/profile.tmpl
	...
	'This word or phrase will be required to recover the password if you forget it.' => '秘密の合言葉はパスワードを忘れて再設定するときに必要になります。',
...
## tmpl/comment/signup.tmpl
	...
	'Password recovery word/phrase' => '秘密の合言葉',
	'Register' => '登録する',
...
## tmpl/cms/edit_author.tmpl
	...
	'This word or phrase will be required to recover a forgotten password.' => '秘密の合言葉はパスワードを忘れて再設定するときに必要になります。',
	'Language' => '使用言語',
...
## tmpl/cms/cfg_entry.tmpl
	...
	'Replace Word Chars' => 'Word特有文字の置換',
	'Smart Replace' => '置換設定',
...
## tmpl/cms/install.tmpl
	...
	'Password recovery word/phrase is required.' => '秘密の合言葉は必須です。',
	...
	'This word or phrase will be required to recover your password if you forget it.' => '秘密の合言葉は、パスワードを忘れて再設定するときに必要になります。',
