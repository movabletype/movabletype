...
## plugins/Motion/lib/Motion/Search.pm
	'Error loading template: [_1]' => '', # Translate - New
	'Specify the blog_id of a blog that has Motion template set.' => '', # Translate - New
	'This module works with MT::App::Search.' => '', # Translate - New
