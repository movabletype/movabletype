...
The height of the image in pixels (available if I<Image::Info> module
is present).

=item * Width

The width of the image in pixels (available if I<Image::Info> module
is present).

=item * ImageType

The image identifier as reported by the I<Image::Info> module. Typically,
'GIF', 'JPG' or 'PNG'.
