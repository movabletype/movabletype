...
sub list_openapi_spec {
    +{
        ...
        parameters => [
            { '$ref' => '#/components/parameters/templatemap/search' },
            { '$ref' => '#/components/parameters/templatemap/searchFields' },
            { '$ref' => '#/components/parameters/templatemap/limit' },
            { '$ref' => '#/components/parameters/templatemap/offset' },
            { '$ref' => '#/components/parameters/templatemap/sortBy' },
            { '$ref' => '#/components/parameters/templatemap/sortOrder' },
            { '$ref' => '#/components/parameters/templatemap/fields' },
            { '$ref' => '#/components/parameters/templatemap/includeIds' },
            { '$ref' => '#/components/parameters/templatemap/excludeIds' },
        ],
        responses => {
            200 => {
