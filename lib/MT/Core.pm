...
#            },
            ...
            'UserPasswordCaseCombi' => { default => 0, },
            'UserPasswordAlfaNumericCombi' => { default => 0, },
            'UserPasswordSpecialChar' => { default => 0, },
            ...
            'DeniedAssetFileExtensions'   => { default => q{ascx,asis,asp,aspx,bat,cfc,cfm,cgi,cmd,com,cpl,dll,exe,htaccess,htm,html,inc,jhtml,js,jsb,jsp,mht,mhtml,msi,php\d?,phps,phtm,phtml,pif,pl,pwml,py,reg,scr,sh,shtm,shtml,vbs,vxd,pm,so,rb} },
