        ...
        entry => {
            ...
            _by_date => {
                label   => sub {
                    ...
                    my $label = _entry_label;
                    if ($from && $to) {
                        return $app->translate('[_1] posted between [_2] and [_3]', $from, $to, $label);
                    } elsif ($from) {
                        return $app->translate("[_1] posted since [_2]", $from, $label);
                    } elsif ($to) {
                        return $app->translate("[_1] posted on or before [_2]", $to, $label);
                    }
                },
                handler => sub {
                    my ( $terms, $args ) = @_;
