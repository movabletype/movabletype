...
sub _get_default_tmpl_params {
    ...
    my $cache_key = '_get_default_tmpl_params';
    my $request_cache = $app->{request}{__stash}{$cache_key};
    if ($request_cache) {
        require Storable;
        return Storable::dclone($request_cache);
    }
    ...
    return $app->{request}{__stash}{$cache_key} = $param;
}
...
sub set_default_tmpl_params {
    ...
    my $param = $app->_get_default_tmpl_params;
