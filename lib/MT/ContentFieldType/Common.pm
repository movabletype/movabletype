...
<select class="custom-select form-control <mt:var name="type">-option">
  <option value="is_selected"><__trans phrase="is selected" encode_js="1" encode_html="1"></option>
  <option value="is_not_selected"><__trans phrase="is not selected" encode_js="1" encode_html="1"></option>
</select>
</mt:setvarblock>
<__trans phrase="In [_1] column, [_2] [_3]"
         params="<mt:var name="label" encode_js="1" encode_html="1">%%
                 <select class="custom-select form-control <mt:var name="type">-value">
                 <mt:loop name="single_select_options">
                   <option value="<mt:var name="value" encode_js="1" encode_html="1">"><mt:var name="label" encode_js="1" encode_html="1" ></option>
                 </mt:loop>
